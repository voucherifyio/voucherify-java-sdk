...
import io.voucherify.client.model.VouchersCreateRequestBody;
...
public class VouchersApi {
     ...
     * @param code A **code** that identifies the voucher or a unique voucher ID assigned by Voucherify, i.e. v_TzD19aeNiqGc9LWciMWknyEZT8IW7u4u. (required)
     * @param vouchersTransactionsExportCreateRequestBody Specify the parameters for the camapign transaction export. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
     ...
     * @param vouchersCreateRequestBody Specify the details of the voucher that you would like to create. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call generateRandomCodeCall(VouchersCreateRequestBody vouchersCreateRequestBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = vouchersCreateRequestBody;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call generateRandomCodeValidateBeforeCall(VouchersCreateRequestBody vouchersCreateRequestBody, final ApiCallback _callback) throws ApiException {
        return generateRandomCodeCall(vouchersCreateRequestBody, _callback);
    ...
    public VouchersCreateResponseBody generateRandomCode(VouchersCreateRequestBody vouchersCreateRequestBody) throws ApiException {
        ApiResponse<VouchersCreateResponseBody> localVarResp = generateRandomCodeWithHttpInfo(vouchersCreateRequestBody);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<VouchersCreateResponseBody> generateRandomCodeWithHttpInfo(VouchersCreateRequestBody vouchersCreateRequestBody) throws ApiException {
        okhttp3.Call localVarCall = generateRandomCodeValidateBeforeCall(vouchersCreateRequestBody, null);
        Type localVarReturnType = new TypeToken<VouchersCreateResponseBody>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call generateRandomCodeAsync(VouchersCreateRequestBody vouchersCreateRequestBody, final ApiCallback<VouchersCreateResponseBody> _callback) throws ApiException {

        okhttp3.Call localVarCall = generateRandomCodeValidateBeforeCall(vouchersCreateRequestBody, _callback);
        Type localVarReturnType = new TypeToken<VouchersCreateResponseBody>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param webhooksEnable Triggers a webhook sendout for new and updated vouchers if the voucher created and voucher updated webhooks are configured in Project settings. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public okhttp3.Call importVouchersUsingCsvCall(File _file, Boolean webhooksEnable, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (webhooksEnable != null) {
            localVarFormParams.put("webhooks_enable", webhooksEnable);
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call importVouchersUsingCsvValidateBeforeCall(File _file, Boolean webhooksEnable, final ApiCallback _callback) throws ApiException {
        return importVouchersUsingCsvCall(_file, webhooksEnable, _callback);
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public VouchersImportCsvCreateResponseBody importVouchersUsingCsv(File _file, Boolean webhooksEnable) throws ApiException {
        ApiResponse<VouchersImportCsvCreateResponseBody> localVarResp = importVouchersUsingCsvWithHttpInfo(_file, webhooksEnable);
        return localVarResp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<VouchersImportCsvCreateResponseBody> importVouchersUsingCsvWithHttpInfo(File _file, Boolean webhooksEnable) throws ApiException {
        okhttp3.Call localVarCall = importVouchersUsingCsvValidateBeforeCall(_file, webhooksEnable, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call importVouchersUsingCsvAsync(File _file, Boolean webhooksEnable, final ApiCallback<VouchersImportCsvCreateResponseBody> _callback) throws ApiException {

        okhttp3.Call localVarCall = importVouchersUsingCsvValidateBeforeCall(_file, webhooksEnable, _callback);
        Type localVarReturnType = new TypeToken<VouchersImportCsvCreateResponseBody>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Adjust Voucher Balance (asynchronously)
     * Add balance to an existing gift card or loyalty card. For loyalty cards, it must be assigned to a holder.
     * @param code A **code** that identifies the voucher or a unique voucher ID assigned by Voucherify, i.e. v_TzD19aeNiqGc9LWciMWknyEZT8IW7u4u. (required)
     * @param vouchersBalanceUpdateRequestBody Provide the amount to be added to/subtracted from the voucher. (required)
     * @param _callback The callback to be executed when the API call finishes
