       ...
       return (TypeAdapter<T>) new TypeAdapter<LocationsGetResponseBodyShape>() {
           ...
           public void write(JsonWriter out, LocationsGetResponseBodyShape value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : LocationsGetResponseBodyShape.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = LocationsGetResponseBodyShape.class.getDeclaredField(fieldName + "IsSet");
