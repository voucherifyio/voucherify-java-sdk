    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductsSkusUpdateResponseBody>() {
           ...
           public void write(JsonWriter out, ProductsSkusUpdateResponseBody value) throws IOException {
            ...
            for (Field field : ProductsSkusUpdateResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ProductsSkusUpdateResponseBody.class.getDeclaredField(fieldName + "IsSet");
