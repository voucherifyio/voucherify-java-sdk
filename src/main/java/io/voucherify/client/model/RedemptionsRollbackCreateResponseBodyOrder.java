...
public class RedemptionsRollbackCreateResponseBodyOrder {
  ...
  public RedemptionsRollbackCreateResponseBodyOrder() {
  }

  public RedemptionsRollbackCreateResponseBodyOrder id(String id) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder status(StatusEnum status) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder amount(Integer amount) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder metadata(Object metadata) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder customerId(String customerId) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder customer(CustomerId customer) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder referrer(ReferrerId referrer) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public RedemptionsRollbackCreateResponseBodyOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public RedemptionsRollbackCreateResponseBodyOrder items(List<OrderCalculatedItem> items) {
    
    this.items = items;
    return this;
  }

  public RedemptionsRollbackCreateResponseBodyOrder addItemsItem(OrderCalculatedItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RedemptionsRollbackCreateResponseBodyOrder redemptionsRollbackCreateResponseBodyOrder = (RedemptionsRollbackCreateResponseBodyOrder) o;
    return Objects.equals(this.id, redemptionsRollbackCreateResponseBodyOrder.id) &&
        Objects.equals(this.sourceId, redemptionsRollbackCreateResponseBodyOrder.sourceId) &&
        Objects.equals(this.status, redemptionsRollbackCreateResponseBodyOrder.status) &&
        Objects.equals(this.amount, redemptionsRollbackCreateResponseBodyOrder.amount) &&
        Objects.equals(this.initialAmount, redemptionsRollbackCreateResponseBodyOrder.initialAmount) &&
        Objects.equals(this.discountAmount, redemptionsRollbackCreateResponseBodyOrder.discountAmount) &&
        Objects.equals(this.itemsDiscountAmount, redemptionsRollbackCreateResponseBodyOrder.itemsDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, redemptionsRollbackCreateResponseBodyOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAmount, redemptionsRollbackCreateResponseBodyOrder.totalAmount) &&
        Objects.equals(this.appliedDiscountAmount, redemptionsRollbackCreateResponseBodyOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, redemptionsRollbackCreateResponseBodyOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, redemptionsRollbackCreateResponseBodyOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.metadata, redemptionsRollbackCreateResponseBodyOrder.metadata) &&
        Objects.equals(this._object, redemptionsRollbackCreateResponseBodyOrder._object) &&
        Objects.equals(this.createdAt, redemptionsRollbackCreateResponseBodyOrder.createdAt) &&
        Objects.equals(this.updatedAt, redemptionsRollbackCreateResponseBodyOrder.updatedAt) &&
        Objects.equals(this.customerId, redemptionsRollbackCreateResponseBodyOrder.customerId) &&
        Objects.equals(this.referrerId, redemptionsRollbackCreateResponseBodyOrder.referrerId) &&
        Objects.equals(this.customer, redemptionsRollbackCreateResponseBodyOrder.customer) &&
        Objects.equals(this.referrer, redemptionsRollbackCreateResponseBodyOrder.referrer) &&
        Objects.equals(this.redemptions, redemptionsRollbackCreateResponseBodyOrder.redemptions) &&
        Objects.equals(this.items, redemptionsRollbackCreateResponseBodyOrder.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionsRollbackCreateResponseBodyOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionsRollbackCreateResponseBodyOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionsRollbackCreateResponseBodyOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionsRollbackCreateResponseBodyOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionsRollbackCreateResponseBodyOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionsRollbackCreateResponseBodyOrder>() {
           @Override
           public void write(JsonWriter out, RedemptionsRollbackCreateResponseBodyOrder value) throws IOException {
            ...
            for (Field field : RedemptionsRollbackCreateResponseBodyOrder.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionsRollbackCreateResponseBodyOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionsRollbackCreateResponseBodyOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedemptionsRollbackCreateResponseBodyOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionsRollbackCreateResponseBodyOrder
  * @throws IOException if the JSON string is invalid with respect to RedemptionsRollbackCreateResponseBodyOrder
  */
  public static RedemptionsRollbackCreateResponseBodyOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionsRollbackCreateResponseBodyOrder.class);
  }

 /**
  * Convert an instance of RedemptionsRollbackCreateResponseBodyOrder to an JSON string
  *
  * @return JSON string
  */
