    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductCollectionsItemProductsItem>() {
           ...
           public void write(JsonWriter out, ProductCollectionsItemProductsItem value) throws IOException {
            ...
            for (Field field : ProductCollectionsItemProductsItem.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ProductCollectionsItemProductsItem.class.getDeclaredField(fieldName + "IsSet");
