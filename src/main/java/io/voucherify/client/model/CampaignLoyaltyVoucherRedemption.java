    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignLoyaltyVoucherRedemption>() {
           ...
           public void write(JsonWriter out, CampaignLoyaltyVoucherRedemption value) throws IOException {
            ...
            for (Field field : CampaignLoyaltyVoucherRedemption.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = CampaignLoyaltyVoucherRedemption.class.getDeclaredField(fieldName + "IsSet");
