    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterUpdatedBeforeAfter>() {
           ...
           public void write(JsonWriter out, ParameterUpdatedBeforeAfter value) throws IOException {
            ...
            for (Field field : ParameterUpdatedBeforeAfter.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ParameterUpdatedBeforeAfter.class.getDeclaredField(fieldName + "IsSet");
