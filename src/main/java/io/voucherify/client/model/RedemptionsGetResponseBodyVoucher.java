       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionsGetResponseBodyVoucher>() {
           ...
           public void write(JsonWriter out, RedemptionsGetResponseBodyVoucher value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionsGetResponseBodyVoucher.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionsGetResponseBodyVoucher.class.getDeclaredField(fieldName + "IsSet");
