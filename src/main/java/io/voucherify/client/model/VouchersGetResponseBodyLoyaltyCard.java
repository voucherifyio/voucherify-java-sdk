...
public class VouchersGetResponseBodyLoyaltyCard {
  ...
  public VouchersGetResponseBodyLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public VouchersGetResponseBodyLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public VouchersGetResponseBodyLoyaltyCard nextExpirationDate(LocalDate nextExpirationDate) {
  ...
  **/
  ...
  public VouchersGetResponseBodyLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public VouchersGetResponseBodyLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public VouchersGetResponseBodyLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public VouchersGetResponseBodyLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VouchersGetResponseBodyLoyaltyCard vouchersGetResponseBodyLoyaltyCard = (VouchersGetResponseBodyLoyaltyCard) o;
    return Objects.equals(this.points, vouchersGetResponseBodyLoyaltyCard.points) &&
        Objects.equals(this.balance, vouchersGetResponseBodyLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, vouchersGetResponseBodyLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, vouchersGetResponseBodyLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, vouchersGetResponseBodyLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, vouchersGetResponseBodyLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, vouchersGetResponseBodyLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class VouchersGetResponseBodyLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VouchersGetResponseBodyLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VouchersGetResponseBodyLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VouchersGetResponseBodyLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VouchersGetResponseBodyLoyaltyCard.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<VouchersGetResponseBodyLoyaltyCard>() {
           ...
           @Override
           public VouchersGetResponseBodyLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VouchersGetResponseBodyLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VouchersGetResponseBodyLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to VouchersGetResponseBodyLoyaltyCard
  */
  public static VouchersGetResponseBodyLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VouchersGetResponseBodyLoyaltyCard.class);
  }

 /**
  * Convert an instance of VouchersGetResponseBodyLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
