    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VouchersGetResponseBodyRedemption>() {
           ...
           public void write(JsonWriter out, VouchersGetResponseBodyRedemption value) throws IOException {
            ...
            for (Field field : VouchersGetResponseBodyRedemption.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = VouchersGetResponseBodyRedemption.class.getDeclaredField(fieldName + "IsSet");
