...
public class VouchersGetResponseBodyRedemption {
  ...
  **/
   ...
   * @return the VouchersGetResponseBodyRedemption instance itself
   */
  public VouchersGetResponseBodyRedemption putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VouchersGetResponseBodyRedemption vouchersGetResponseBodyRedemption = (VouchersGetResponseBodyRedemption) o;
    return Objects.equals(this.quantity, vouchersGetResponseBodyRedemption.quantity) &&
        Objects.equals(this.redeemedQuantity, vouchersGetResponseBodyRedemption.redeemedQuantity) &&
        Objects.equals(this.redeemedPoints, vouchersGetResponseBodyRedemption.redeemedPoints) &&
        Objects.equals(this._object, vouchersGetResponseBodyRedemption._object) &&
        Objects.equals(this.url, vouchersGetResponseBodyRedemption.url)&&
        Objects.equals(this.additionalProperties, vouchersGetResponseBodyRedemption.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VouchersGetResponseBodyRedemption {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VouchersGetResponseBodyRedemption.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VouchersGetResponseBodyRedemption' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VouchersGetResponseBodyRedemption> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VouchersGetResponseBodyRedemption.class));

       return (TypeAdapter<T>) new TypeAdapter<VouchersGetResponseBodyRedemption>() {
           @Override
           public void write(JsonWriter out, VouchersGetResponseBodyRedemption value) throws IOException {
           ...
           @Override
           public VouchersGetResponseBodyRedemption read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             VouchersGetResponseBodyRedemption instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  * @return An instance of VouchersGetResponseBodyRedemption
  * @throws IOException if the JSON string is invalid with respect to VouchersGetResponseBodyRedemption
  */
  public static VouchersGetResponseBodyRedemption fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VouchersGetResponseBodyRedemption.class);
  }
