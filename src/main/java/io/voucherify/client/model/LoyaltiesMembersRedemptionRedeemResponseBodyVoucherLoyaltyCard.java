...
public class LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard {
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard loyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard = (LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard) o;
    return Objects.equals(this.points, loyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.points) &&
        Objects.equals(this.balance, loyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, loyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, loyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, loyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, loyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, loyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard value) throws IOException {
            ...
            for (Field field : LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard
  */
  public static LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.class);
  }

 /**
  * Convert an instance of LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
