...
public class ProductWithoutSkus {
  ...
  **/
   ...
   * @return the ProductWithoutSkus instance itself
   */
  public ProductWithoutSkus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, productWithoutSkus.id) &&
        ...
        Objects.equals(this.additionalProperties, productWithoutSkus.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, sourceId, name, price, attributes, metadata, imageUrl, createdAt, updatedAt, _object, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductWithoutSkus>() {
           ...
           public ProductWithoutSkus read(JsonReader in) throws IOException {
             ...
             ProductWithoutSkus instance = thisAdapter.fromJsonTree(jsonObj);
