       ...
       return (TypeAdapter<T>) new TypeAdapter<AccessSettingsCampaignAssignmentsList>() {
           ...
           public void write(JsonWriter out, AccessSettingsCampaignAssignmentsList value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : AccessSettingsCampaignAssignmentsList.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = AccessSettingsCampaignAssignmentsList.class.getDeclaredField(fieldName + "IsSet");
