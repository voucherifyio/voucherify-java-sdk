       ...
       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectApiUsageNotifications>() {
           ...
           public void write(JsonWriter out, ManagementProjectApiUsageNotifications value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ManagementProjectApiUsageNotifications.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ManagementProjectApiUsageNotifications.class.getDeclaredField(fieldName + "IsSet");
