...
public class RedemptionsRedeemResponseBodyOrderItemsItem {
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem() {
  }

  public RedemptionsRedeemResponseBodyOrderItemsItem id(String id) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem skuId(String skuId) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem productId(String productId) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem relatedObject(RelatedObjectEnum relatedObject) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem sourceId(String sourceId) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem quantity(Integer quantity) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem discountQuantity(Integer discountQuantity) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem initialQuantity(Integer initialQuantity) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem amount(Integer amount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem appliedDiscountQuantity(Integer appliedDiscountQuantity) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem appliedQuantity(Integer appliedQuantity) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem appliedQuantityAmount(Integer appliedQuantityAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem price(Integer price) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem subtotalAmount(Integer subtotalAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem product(OrderCalculatedItemProduct product) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem sku(OrderCalculatedItemSku sku) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem _object(ObjectEnum _object) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem metadata(Object metadata) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrderItemsItem applicationDetails(List<ApplicationDetailsItem> applicationDetails) {
    
    this.applicationDetails = applicationDetails;
    return this;
  }

  public RedemptionsRedeemResponseBodyOrderItemsItem addApplicationDetailsItem(ApplicationDetailsItem applicationDetailsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RedemptionsRedeemResponseBodyOrderItemsItem redemptionsRedeemResponseBodyOrderItemsItem = (RedemptionsRedeemResponseBodyOrderItemsItem) o;
    return Objects.equals(this.id, redemptionsRedeemResponseBodyOrderItemsItem.id) &&
        Objects.equals(this.skuId, redemptionsRedeemResponseBodyOrderItemsItem.skuId) &&
        Objects.equals(this.productId, redemptionsRedeemResponseBodyOrderItemsItem.productId) &&
        Objects.equals(this.relatedObject, redemptionsRedeemResponseBodyOrderItemsItem.relatedObject) &&
        Objects.equals(this.sourceId, redemptionsRedeemResponseBodyOrderItemsItem.sourceId) &&
        Objects.equals(this.quantity, redemptionsRedeemResponseBodyOrderItemsItem.quantity) &&
        Objects.equals(this.discountQuantity, redemptionsRedeemResponseBodyOrderItemsItem.discountQuantity) &&
        Objects.equals(this.initialQuantity, redemptionsRedeemResponseBodyOrderItemsItem.initialQuantity) &&
        Objects.equals(this.amount, redemptionsRedeemResponseBodyOrderItemsItem.amount) &&
        Objects.equals(this.discountAmount, redemptionsRedeemResponseBodyOrderItemsItem.discountAmount) &&
        Objects.equals(this.appliedDiscountAmount, redemptionsRedeemResponseBodyOrderItemsItem.appliedDiscountAmount) &&
        Objects.equals(this.appliedDiscountQuantity, redemptionsRedeemResponseBodyOrderItemsItem.appliedDiscountQuantity) &&
        Objects.equals(this.appliedQuantity, redemptionsRedeemResponseBodyOrderItemsItem.appliedQuantity) &&
        Objects.equals(this.appliedQuantityAmount, redemptionsRedeemResponseBodyOrderItemsItem.appliedQuantityAmount) &&
        Objects.equals(this.initialAmount, redemptionsRedeemResponseBodyOrderItemsItem.initialAmount) &&
        Objects.equals(this.price, redemptionsRedeemResponseBodyOrderItemsItem.price) &&
        Objects.equals(this.subtotalAmount, redemptionsRedeemResponseBodyOrderItemsItem.subtotalAmount) &&
        Objects.equals(this.product, redemptionsRedeemResponseBodyOrderItemsItem.product) &&
        Objects.equals(this.sku, redemptionsRedeemResponseBodyOrderItemsItem.sku) &&
        Objects.equals(this._object, redemptionsRedeemResponseBodyOrderItemsItem._object) &&
        Objects.equals(this.metadata, redemptionsRedeemResponseBodyOrderItemsItem.metadata) &&
        Objects.equals(this.applicationDetails, redemptionsRedeemResponseBodyOrderItemsItem.applicationDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionsRedeemResponseBodyOrderItemsItem {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionsRedeemResponseBodyOrderItemsItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionsRedeemResponseBodyOrderItemsItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionsRedeemResponseBodyOrderItemsItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionsRedeemResponseBodyOrderItemsItem.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionsRedeemResponseBodyOrderItemsItem>() {
           @Override
           public void write(JsonWriter out, RedemptionsRedeemResponseBodyOrderItemsItem value) throws IOException {
            ...
            for (Field field : RedemptionsRedeemResponseBodyOrderItemsItem.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionsRedeemResponseBodyOrderItemsItem.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionsRedeemResponseBodyOrderItemsItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedemptionsRedeemResponseBodyOrderItemsItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionsRedeemResponseBodyOrderItemsItem
  * @throws IOException if the JSON string is invalid with respect to RedemptionsRedeemResponseBodyOrderItemsItem
  */
  public static RedemptionsRedeemResponseBodyOrderItemsItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionsRedeemResponseBodyOrderItemsItem.class);
  }

 /**
  * Convert an instance of RedemptionsRedeemResponseBodyOrderItemsItem to an JSON string
  *
  * @return JSON string
  */
