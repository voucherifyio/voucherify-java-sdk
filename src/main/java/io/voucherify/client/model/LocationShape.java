...
import io.voucherify.client.model.LocationShapeDistance;
import io.voucherify.client.model.LocationShapeGeojson;
...
public class LocationShape {
  ...
  **/
  @javax.annotation.Nullable
  public LocationShapeDistance getDistance() {
    return distance;
  }
  ...
  **/
  @javax.annotation.Nullable
  public LocationShapeGeojson getGeojson() {
    return geojson;
  }
  ...
  public boolean equals(Object o) {
    ...
    LocationShape locationShape = (LocationShape) o;
    return Objects.equals(this.type, locationShape.type) &&
        Objects.equals(this.format, locationShape.format) &&
        Objects.equals(this.distance, locationShape.distance) &&
        Objects.equals(this.geojson, locationShape.geojson);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationShape.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationShape' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationShape> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationShape.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<LocationShape>() {
           ...
           @Override
           public LocationShape read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LocationShape given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LocationShape
  * @throws IOException if the JSON string is invalid with respect to LocationShape
  */
  public static LocationShape fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationShape.class);
  }

 /**
  * Convert an instance of LocationShape to an JSON string
  *
  * @return JSON string
  */
