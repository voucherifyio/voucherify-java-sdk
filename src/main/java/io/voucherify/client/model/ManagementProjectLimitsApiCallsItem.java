    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectLimitsApiCallsItem>() {
           ...
           public void write(JsonWriter out, ManagementProjectLimitsApiCallsItem value) throws IOException {
            ...
            for (Field field : ManagementProjectLimitsApiCallsItem.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectLimitsApiCallsItem.class.getDeclaredField(fieldName + "IsSet");
