...
public class RedemptionsGetResponseBodyVoucherLoyaltyCard {
  ...
  public RedemptionsGetResponseBodyVoucherLoyaltyCard() {
  }

  public RedemptionsGetResponseBodyVoucherLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucherLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucherLoyaltyCard nextExpirationDate(LocalDate nextExpirationDate) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucherLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucherLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucherLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucherLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RedemptionsGetResponseBodyVoucherLoyaltyCard redemptionsGetResponseBodyVoucherLoyaltyCard = (RedemptionsGetResponseBodyVoucherLoyaltyCard) o;
    return Objects.equals(this.points, redemptionsGetResponseBodyVoucherLoyaltyCard.points) &&
        Objects.equals(this.balance, redemptionsGetResponseBodyVoucherLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, redemptionsGetResponseBodyVoucherLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, redemptionsGetResponseBodyVoucherLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, redemptionsGetResponseBodyVoucherLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, redemptionsGetResponseBodyVoucherLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, redemptionsGetResponseBodyVoucherLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionsGetResponseBodyVoucherLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionsGetResponseBodyVoucherLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionsGetResponseBodyVoucherLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionsGetResponseBodyVoucherLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionsGetResponseBodyVoucherLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionsGetResponseBodyVoucherLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, RedemptionsGetResponseBodyVoucherLoyaltyCard value) throws IOException {
            ...
            for (Field field : RedemptionsGetResponseBodyVoucherLoyaltyCard.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionsGetResponseBodyVoucherLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionsGetResponseBodyVoucherLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedemptionsGetResponseBodyVoucherLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionsGetResponseBodyVoucherLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to RedemptionsGetResponseBodyVoucherLoyaltyCard
  */
  public static RedemptionsGetResponseBodyVoucherLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionsGetResponseBodyVoucherLoyaltyCard.class);
  }

 /**
  * Convert an instance of RedemptionsGetResponseBodyVoucherLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
