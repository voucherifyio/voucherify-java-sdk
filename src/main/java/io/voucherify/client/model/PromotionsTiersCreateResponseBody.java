       ...
       return (TypeAdapter<T>) new TypeAdapter<PromotionsTiersCreateResponseBody>() {
           ...
           public void write(JsonWriter out, PromotionsTiersCreateResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : PromotionsTiersCreateResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = PromotionsTiersCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
