...
public class MemberActivityDataRedemptionRewardVoucherLoyaltyCard {
  ...
  public MemberActivityDataRedemptionRewardVoucherLoyaltyCard() {
  }

  public MemberActivityDataRedemptionRewardVoucherLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionRewardVoucherLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionRewardVoucherLoyaltyCard nextExpirationDate(String nextExpirationDate) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionRewardVoucherLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionRewardVoucherLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionRewardVoucherLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionRewardVoucherLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MemberActivityDataRedemptionRewardVoucherLoyaltyCard memberActivityDataRedemptionRewardVoucherLoyaltyCard = (MemberActivityDataRedemptionRewardVoucherLoyaltyCard) o;
    return Objects.equals(this.points, memberActivityDataRedemptionRewardVoucherLoyaltyCard.points) &&
        Objects.equals(this.balance, memberActivityDataRedemptionRewardVoucherLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, memberActivityDataRedemptionRewardVoucherLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, memberActivityDataRedemptionRewardVoucherLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, memberActivityDataRedemptionRewardVoucherLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, memberActivityDataRedemptionRewardVoucherLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, memberActivityDataRedemptionRewardVoucherLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class MemberActivityDataRedemptionRewardVoucherLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberActivityDataRedemptionRewardVoucherLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberActivityDataRedemptionRewardVoucherLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberActivityDataRedemptionRewardVoucherLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberActivityDataRedemptionRewardVoucherLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberActivityDataRedemptionRewardVoucherLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, MemberActivityDataRedemptionRewardVoucherLoyaltyCard value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : MemberActivityDataRedemptionRewardVoucherLoyaltyCard.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = MemberActivityDataRedemptionRewardVoucherLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public MemberActivityDataRedemptionRewardVoucherLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MemberActivityDataRedemptionRewardVoucherLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberActivityDataRedemptionRewardVoucherLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to MemberActivityDataRedemptionRewardVoucherLoyaltyCard
  */
  public static MemberActivityDataRedemptionRewardVoucherLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberActivityDataRedemptionRewardVoucherLoyaltyCard.class);
  }

 /**
  * Convert an instance of MemberActivityDataRedemptionRewardVoucherLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
