       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesUpdateCampaignResponseBody>() {
           ...
           public void write(JsonWriter out, LoyaltiesUpdateCampaignResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : LoyaltiesUpdateCampaignResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = LoyaltiesUpdateCampaignResponseBody.class.getDeclaredField(fieldName + "IsSet");
