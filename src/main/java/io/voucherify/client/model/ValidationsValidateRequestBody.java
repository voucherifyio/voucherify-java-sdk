...
public class ValidationsValidateRequestBody {
  ...
  **/
  ...
  public ValidationsValidateRequestBody order(Order order) {
  ...
  **/
  ...
  public ValidationsValidateRequestBody customer(Customer customer) {
  ...
  **/
  ...
  public ValidationsValidateRequestBody session(Session session) {
  ...
  **/
  ...
  public ValidationsValidateRequestBody trackingId(String trackingId) {
  ...
  **/
  ...
  public ValidationsValidateRequestBody metadata(Object metadata) {
  ...
  **/
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidationsValidateRequestBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidationsValidateRequestBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidationsValidateRequestBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidationsValidateRequestBody.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidationsValidateRequestBody>() {
           @Override
           public void write(JsonWriter out, ValidationsValidateRequestBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ValidationsValidateRequestBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ValidationsValidateRequestBody.class.getDeclaredField(fieldName + "IsSet");
 ...
 /**
  * Create an instance of ValidationsValidateRequestBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ValidationsValidateRequestBody
  * @throws IOException if the JSON string is invalid with respect to ValidationsValidateRequestBody
  */
  public static ValidationsValidateRequestBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidationsValidateRequestBody.class);
  }

 /**
  * Convert an instance of ValidationsValidateRequestBody to an JSON string
  *
  * @return JSON string
  */
