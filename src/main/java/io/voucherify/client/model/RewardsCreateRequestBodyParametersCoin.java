...
public class RewardsCreateRequestBodyParametersCoin {
  ...
  public RewardsCreateRequestBodyParametersCoin exchangeRatio(BigDecimal exchangeRatio) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RewardsCreateRequestBodyParametersCoin>() {
           ...
           public void write(JsonWriter out, RewardsCreateRequestBodyParametersCoin value) throws IOException {
            ...
            for (Field field : RewardsCreateRequestBodyParametersCoin.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RewardsCreateRequestBodyParametersCoin.class.getDeclaredField(fieldName + "IsSet");
