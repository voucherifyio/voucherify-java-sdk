...
public class CampaignLoyaltyCard {
  ...
  private CampaignLoyaltyCardExpirationRules expirationRules;
    private boolean expirationRulesIsSet = false;
  ...
  **/
  ...
  public boolean isExpirationRulesSet() {
    return expirationRulesIsSet;
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignLoyaltyCard>() {
           ...
           public void write(JsonWriter out, CampaignLoyaltyCard value) throws IOException {
            ...
            for (Field field : CampaignLoyaltyCard.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = CampaignLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
