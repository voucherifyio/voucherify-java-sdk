    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrdersExportCreateResponseBody>() {
           ...
           public void write(JsonWriter out, OrdersExportCreateResponseBody value) throws IOException {
            ...
            for (Field field : OrdersExportCreateResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = OrdersExportCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
