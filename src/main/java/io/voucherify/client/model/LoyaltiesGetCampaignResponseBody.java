    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesGetCampaignResponseBody>() {
           ...
           public void write(JsonWriter out, LoyaltiesGetCampaignResponseBody value) throws IOException {
            ...
            for (Field field : LoyaltiesGetCampaignResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltiesGetCampaignResponseBody.class.getDeclaredField(fieldName + "IsSet");
