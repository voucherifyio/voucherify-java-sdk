...
public class Gift {
  ...
  **/
   ...
   * @return the Gift instance itself
   */
  public Gift putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, gift.amount) &&
        ...
        Objects.equals(this.additionalProperties, gift.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Gift>() {
           ...
           public Gift read(JsonReader in) throws IOException {
             ...
             Gift instance = thisAdapter.fromJsonTree(jsonObj);
