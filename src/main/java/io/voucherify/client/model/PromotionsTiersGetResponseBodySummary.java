       ...
       return (TypeAdapter<T>) new TypeAdapter<PromotionsTiersGetResponseBodySummary>() {
           ...
           public void write(JsonWriter out, PromotionsTiersGetResponseBodySummary value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : PromotionsTiersGetResponseBodySummary.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = PromotionsTiersGetResponseBodySummary.class.getDeclaredField(fieldName + "IsSet");
