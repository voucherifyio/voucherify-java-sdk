       ...
       return (TypeAdapter<T>) new TypeAdapter<InapplicableToOrderItemUnitsItem>() {
           ...
           public void write(JsonWriter out, InapplicableToOrderItemUnitsItem value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : InapplicableToOrderItemUnitsItem.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = InapplicableToOrderItemUnitsItem.class.getDeclaredField(fieldName + "IsSet");
