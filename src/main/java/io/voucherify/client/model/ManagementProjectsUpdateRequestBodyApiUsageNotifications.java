    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsUpdateRequestBodyApiUsageNotifications>() {
           ...
           public void write(JsonWriter out, ManagementProjectsUpdateRequestBodyApiUsageNotifications value) throws IOException {
            ...
            for (Field field : ManagementProjectsUpdateRequestBodyApiUsageNotifications.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectsUpdateRequestBodyApiUsageNotifications.class.getDeclaredField(fieldName + "IsSet");
