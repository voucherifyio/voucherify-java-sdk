       ...
       return (TypeAdapter<T>) new TypeAdapter<ClientRedemptionsRedeemRequestBodyRedeemablesItemGift>() {
           ...
           public void write(JsonWriter out, ClientRedemptionsRedeemRequestBodyRedeemablesItemGift value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ClientRedemptionsRedeemRequestBodyRedeemablesItemGift.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ClientRedemptionsRedeemRequestBodyRedeemablesItemGift.class.getDeclaredField(fieldName + "IsSet");
