...
public class CampaignsUpdateCouponCampaignBase {
  ...
  public CampaignsUpdateCouponCampaignBase() {
  }

  public CampaignsUpdateCouponCampaignBase startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase expirationDate(OffsetDateTime expirationDate) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase validityTimeframe(ValidityTimeframe validityTimeframe) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase validityDayOfWeek(List<ValidityDayOfWeekEnum> validityDayOfWeek) {
    
    this.validityDayOfWeek = validityDayOfWeek;
    return this;
  }

  public CampaignsUpdateCouponCampaignBase addValidityDayOfWeekItem(ValidityDayOfWeekEnum validityDayOfWeekItem) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase validityHours(ValidityHours validityHours) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase description(String description) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase category(String category) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase metadata(Object metadata) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase unsetMetadataFields(List<String> unsetMetadataFields) {
    
    this.unsetMetadataFields = unsetMetadataFields;
    return this;
  }

  public CampaignsUpdateCouponCampaignBase addUnsetMetadataFieldsItem(String unsetMetadataFieldsItem) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase categoryId(String categoryId) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase activityDurationAfterPublishing(String activityDurationAfterPublishing) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase joinOnce(Boolean joinOnce) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase autoJoin(Boolean autoJoin) {
  ...
  **/
  ...
  public CampaignsUpdateCouponCampaignBase type(TypeEnum type) {
  ...
  **/
   ...
   * @return the CampaignsUpdateCouponCampaignBase instance itself
   */
  public CampaignsUpdateCouponCampaignBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignsUpdateCouponCampaignBase campaignsUpdateCouponCampaignBase = (CampaignsUpdateCouponCampaignBase) o;
    return Objects.equals(this.startDate, campaignsUpdateCouponCampaignBase.startDate) &&
        Objects.equals(this.expirationDate, campaignsUpdateCouponCampaignBase.expirationDate) &&
        Objects.equals(this.validityTimeframe, campaignsUpdateCouponCampaignBase.validityTimeframe) &&
        Objects.equals(this.validityDayOfWeek, campaignsUpdateCouponCampaignBase.validityDayOfWeek) &&
        Objects.equals(this.validityHours, campaignsUpdateCouponCampaignBase.validityHours) &&
        Objects.equals(this.description, campaignsUpdateCouponCampaignBase.description) &&
        Objects.equals(this.category, campaignsUpdateCouponCampaignBase.category) &&
        Objects.equals(this.metadata, campaignsUpdateCouponCampaignBase.metadata) &&
        Objects.equals(this.unsetMetadataFields, campaignsUpdateCouponCampaignBase.unsetMetadataFields) &&
        Objects.equals(this.categoryId, campaignsUpdateCouponCampaignBase.categoryId) &&
        Objects.equals(this.activityDurationAfterPublishing, campaignsUpdateCouponCampaignBase.activityDurationAfterPublishing) &&
        Objects.equals(this.joinOnce, campaignsUpdateCouponCampaignBase.joinOnce) &&
        Objects.equals(this.autoJoin, campaignsUpdateCouponCampaignBase.autoJoin) &&
        Objects.equals(this.type, campaignsUpdateCouponCampaignBase.type)&&
        Objects.equals(this.additionalProperties, campaignsUpdateCouponCampaignBase.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(startDate, expirationDate, validityTimeframe, validityDayOfWeek, validityHours, description, category, metadata, unsetMetadataFields, categoryId, activityDurationAfterPublishing, joinOnce, autoJoin, type, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsUpdateCouponCampaignBase {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsUpdateCouponCampaignBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsUpdateCouponCampaignBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsUpdateCouponCampaignBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsUpdateCouponCampaignBase.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsUpdateCouponCampaignBase>() {
           @Override
           public void write(JsonWriter out, CampaignsUpdateCouponCampaignBase value) throws IOException {
           ...
           @Override
           public CampaignsUpdateCouponCampaignBase read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CampaignsUpdateCouponCampaignBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignsUpdateCouponCampaignBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsUpdateCouponCampaignBase
  * @throws IOException if the JSON string is invalid with respect to CampaignsUpdateCouponCampaignBase
  */
  public static CampaignsUpdateCouponCampaignBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsUpdateCouponCampaignBase.class);
  }

 /**
  * Convert an instance of CampaignsUpdateCouponCampaignBase to an JSON string
  *
  * @return JSON string
  */
