...
public class QualificationsRedeemableOrderItemsItem {
  ...
  public QualificationsRedeemableOrderItemsItem() {
  }

  public QualificationsRedeemableOrderItemsItem id(String id) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem skuId(String skuId) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem productId(String productId) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem relatedObject(RelatedObjectEnum relatedObject) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem sourceId(String sourceId) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem quantity(Integer quantity) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem discountQuantity(Integer discountQuantity) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem initialQuantity(Integer initialQuantity) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem amount(Integer amount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem appliedDiscountQuantity(Integer appliedDiscountQuantity) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem appliedQuantity(Integer appliedQuantity) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem appliedQuantityAmount(Integer appliedQuantityAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem price(Integer price) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem subtotalAmount(Integer subtotalAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem product(OrderCalculatedItemProduct product) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem sku(OrderCalculatedItemSku sku) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem _object(ObjectEnum _object) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem metadata(Object metadata) {
  ...
  **/
  ...
  public QualificationsRedeemableOrderItemsItem applicationDetails(List<ApplicationDetailsItem> applicationDetails) {
    
    this.applicationDetails = applicationDetails;
    return this;
  }

  public QualificationsRedeemableOrderItemsItem addApplicationDetailsItem(ApplicationDetailsItem applicationDetailsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    QualificationsRedeemableOrderItemsItem qualificationsRedeemableOrderItemsItem = (QualificationsRedeemableOrderItemsItem) o;
    return Objects.equals(this.id, qualificationsRedeemableOrderItemsItem.id) &&
        Objects.equals(this.skuId, qualificationsRedeemableOrderItemsItem.skuId) &&
        Objects.equals(this.productId, qualificationsRedeemableOrderItemsItem.productId) &&
        Objects.equals(this.relatedObject, qualificationsRedeemableOrderItemsItem.relatedObject) &&
        Objects.equals(this.sourceId, qualificationsRedeemableOrderItemsItem.sourceId) &&
        Objects.equals(this.quantity, qualificationsRedeemableOrderItemsItem.quantity) &&
        Objects.equals(this.discountQuantity, qualificationsRedeemableOrderItemsItem.discountQuantity) &&
        Objects.equals(this.initialQuantity, qualificationsRedeemableOrderItemsItem.initialQuantity) &&
        Objects.equals(this.amount, qualificationsRedeemableOrderItemsItem.amount) &&
        Objects.equals(this.discountAmount, qualificationsRedeemableOrderItemsItem.discountAmount) &&
        Objects.equals(this.appliedDiscountAmount, qualificationsRedeemableOrderItemsItem.appliedDiscountAmount) &&
        Objects.equals(this.appliedDiscountQuantity, qualificationsRedeemableOrderItemsItem.appliedDiscountQuantity) &&
        Objects.equals(this.appliedQuantity, qualificationsRedeemableOrderItemsItem.appliedQuantity) &&
        Objects.equals(this.appliedQuantityAmount, qualificationsRedeemableOrderItemsItem.appliedQuantityAmount) &&
        Objects.equals(this.initialAmount, qualificationsRedeemableOrderItemsItem.initialAmount) &&
        Objects.equals(this.price, qualificationsRedeemableOrderItemsItem.price) &&
        Objects.equals(this.subtotalAmount, qualificationsRedeemableOrderItemsItem.subtotalAmount) &&
        Objects.equals(this.product, qualificationsRedeemableOrderItemsItem.product) &&
        Objects.equals(this.sku, qualificationsRedeemableOrderItemsItem.sku) &&
        Objects.equals(this._object, qualificationsRedeemableOrderItemsItem._object) &&
        Objects.equals(this.metadata, qualificationsRedeemableOrderItemsItem.metadata) &&
        Objects.equals(this.applicationDetails, qualificationsRedeemableOrderItemsItem.applicationDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class QualificationsRedeemableOrderItemsItem {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QualificationsRedeemableOrderItemsItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QualificationsRedeemableOrderItemsItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QualificationsRedeemableOrderItemsItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QualificationsRedeemableOrderItemsItem.class));

       return (TypeAdapter<T>) new TypeAdapter<QualificationsRedeemableOrderItemsItem>() {
           @Override
           public void write(JsonWriter out, QualificationsRedeemableOrderItemsItem value) throws IOException {
            ...
            for (Field field : QualificationsRedeemableOrderItemsItem.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = QualificationsRedeemableOrderItemsItem.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public QualificationsRedeemableOrderItemsItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of QualificationsRedeemableOrderItemsItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of QualificationsRedeemableOrderItemsItem
  * @throws IOException if the JSON string is invalid with respect to QualificationsRedeemableOrderItemsItem
  */
  public static QualificationsRedeemableOrderItemsItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QualificationsRedeemableOrderItemsItem.class);
  }

 /**
  * Convert an instance of QualificationsRedeemableOrderItemsItem to an JSON string
  *
  * @return JSON string
  */
