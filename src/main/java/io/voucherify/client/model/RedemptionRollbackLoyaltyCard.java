       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionRollbackLoyaltyCard>() {
           ...
           public void write(JsonWriter out, RedemptionRollbackLoyaltyCard value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionRollbackLoyaltyCard.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionRollbackLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
