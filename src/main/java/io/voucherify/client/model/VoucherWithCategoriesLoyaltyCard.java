...
public class VoucherWithCategoriesLoyaltyCard {
  ...
  public VoucherWithCategoriesLoyaltyCard() {
  }

  public VoucherWithCategoriesLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public VoucherWithCategoriesLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public VoucherWithCategoriesLoyaltyCard nextExpirationDate(LocalDate nextExpirationDate) {
  ...
  **/
  ...
  public VoucherWithCategoriesLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public VoucherWithCategoriesLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public VoucherWithCategoriesLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public VoucherWithCategoriesLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VoucherWithCategoriesLoyaltyCard voucherWithCategoriesLoyaltyCard = (VoucherWithCategoriesLoyaltyCard) o;
    return Objects.equals(this.points, voucherWithCategoriesLoyaltyCard.points) &&
        Objects.equals(this.balance, voucherWithCategoriesLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, voucherWithCategoriesLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, voucherWithCategoriesLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, voucherWithCategoriesLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, voucherWithCategoriesLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, voucherWithCategoriesLoyaltyCard.subtractedPoints);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VoucherWithCategoriesLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VoucherWithCategoriesLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VoucherWithCategoriesLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VoucherWithCategoriesLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<VoucherWithCategoriesLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, VoucherWithCategoriesLoyaltyCard value) throws IOException {
            ...
            for (Field field : VoucherWithCategoriesLoyaltyCard.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = VoucherWithCategoriesLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public VoucherWithCategoriesLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VoucherWithCategoriesLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VoucherWithCategoriesLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to VoucherWithCategoriesLoyaltyCard
  */
  public static VoucherWithCategoriesLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VoucherWithCategoriesLoyaltyCard.class);
  }

 /**
  * Convert an instance of VoucherWithCategoriesLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
