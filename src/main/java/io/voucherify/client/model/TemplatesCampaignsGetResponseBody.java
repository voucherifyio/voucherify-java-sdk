       ...
       return (TypeAdapter<T>) new TypeAdapter<TemplatesCampaignsGetResponseBody>() {
           ...
           public void write(JsonWriter out, TemplatesCampaignsGetResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : TemplatesCampaignsGetResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = TemplatesCampaignsGetResponseBody.class.getDeclaredField(fieldName + "IsSet");
