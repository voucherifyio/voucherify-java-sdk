...
public class VouchersDisableResponseBodyLoyaltyCard {
  ...
  public VouchersDisableResponseBodyLoyaltyCard() {
  }

  public VouchersDisableResponseBodyLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public VouchersDisableResponseBodyLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public VouchersDisableResponseBodyLoyaltyCard nextExpirationDate(LocalDate nextExpirationDate) {
  ...
  **/
  ...
  public VouchersDisableResponseBodyLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public VouchersDisableResponseBodyLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public VouchersDisableResponseBodyLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public VouchersDisableResponseBodyLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VouchersDisableResponseBodyLoyaltyCard vouchersDisableResponseBodyLoyaltyCard = (VouchersDisableResponseBodyLoyaltyCard) o;
    return Objects.equals(this.points, vouchersDisableResponseBodyLoyaltyCard.points) &&
        Objects.equals(this.balance, vouchersDisableResponseBodyLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, vouchersDisableResponseBodyLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, vouchersDisableResponseBodyLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, vouchersDisableResponseBodyLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, vouchersDisableResponseBodyLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, vouchersDisableResponseBodyLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class VouchersDisableResponseBodyLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VouchersDisableResponseBodyLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VouchersDisableResponseBodyLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VouchersDisableResponseBodyLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VouchersDisableResponseBodyLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<VouchersDisableResponseBodyLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, VouchersDisableResponseBodyLoyaltyCard value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VouchersDisableResponseBodyLoyaltyCard.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VouchersDisableResponseBodyLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public VouchersDisableResponseBodyLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VouchersDisableResponseBodyLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VouchersDisableResponseBodyLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to VouchersDisableResponseBodyLoyaltyCard
  */
  public static VouchersDisableResponseBodyLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VouchersDisableResponseBodyLoyaltyCard.class);
  }

 /**
  * Convert an instance of VouchersDisableResponseBodyLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
