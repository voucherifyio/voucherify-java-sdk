...
import io.voucherify.client.model.MemberActivityDataRedemptionPromotionTierAction;
import io.voucherify.client.model.MemberActivityDataRedemptionPromotionTierCampaign;
import io.voucherify.client.model.MemberActivityDataRedemptionPromotionTierSummary;
...
public class MemberActivityDataRedemptionPromotionTier {
  ...
  private MemberActivityDataRedemptionPromotionTierCampaign campaign;
  ...
  private MemberActivityDataRedemptionPromotionTierAction action;
  ...
  private MemberActivityDataRedemptionPromotionTierSummary summary;
  ...
  public MemberActivityDataRedemptionPromotionTier() {
  }
  ...
  **/
  @javax.annotation.Nullable
  public MemberActivityDataRedemptionPromotionTierCampaign getCampaign() {
    return campaign;
  }


  public void setCampaign(MemberActivityDataRedemptionPromotionTierCampaign campaign) {
    this.campaign = campaign;
  ...
  **/
  @javax.annotation.Nullable
  public MemberActivityDataRedemptionPromotionTierAction getAction() {
    return action;
  }


  public void setAction(MemberActivityDataRedemptionPromotionTierAction action) {
    this.action = action;
  ...
  **/
  ...
  public MemberActivityDataRedemptionPromotionTier addValidityDayOfWeekItem(ValidityDayOfWeekEnum validityDayOfWeekItem) {
  ...
  **/
  @javax.annotation.Nullable
  public MemberActivityDataRedemptionPromotionTierSummary getSummary() {
    return summary;
  }


  public void setSummary(MemberActivityDataRedemptionPromotionTierSummary summary) {
    this.summary = summary;
  ...
  **/
  ...
  public MemberActivityDataRedemptionPromotionTier addCategoriesItem(Category categoriesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MemberActivityDataRedemptionPromotionTier memberActivityDataRedemptionPromotionTier = (MemberActivityDataRedemptionPromotionTier) o;
    return Objects.equals(this.id, memberActivityDataRedemptionPromotionTier.id) &&
        Objects.equals(this.name, memberActivityDataRedemptionPromotionTier.name) &&
        Objects.equals(this.banner, memberActivityDataRedemptionPromotionTier.banner) &&
        Objects.equals(this.campaign, memberActivityDataRedemptionPromotionTier.campaign) &&
        Objects.equals(this.metadata, memberActivityDataRedemptionPromotionTier.metadata) &&
        Objects.equals(this.createdAt, memberActivityDataRedemptionPromotionTier.createdAt) &&
        Objects.equals(this.updatedAt, memberActivityDataRedemptionPromotionTier.updatedAt) &&
        Objects.equals(this.action, memberActivityDataRedemptionPromotionTier.action) &&
        Objects.equals(this.hierarchy, memberActivityDataRedemptionPromotionTier.hierarchy) &&
        Objects.equals(this.promotionId, memberActivityDataRedemptionPromotionTier.promotionId) &&
        Objects.equals(this.campaignId, memberActivityDataRedemptionPromotionTier.campaignId) &&
        Objects.equals(this.active, memberActivityDataRedemptionPromotionTier.active) &&
        Objects.equals(this.startDate, memberActivityDataRedemptionPromotionTier.startDate) &&
        Objects.equals(this.expirationDate, memberActivityDataRedemptionPromotionTier.expirationDate) &&
        Objects.equals(this.validityTimeframe, memberActivityDataRedemptionPromotionTier.validityTimeframe) &&
        Objects.equals(this.validityDayOfWeek, memberActivityDataRedemptionPromotionTier.validityDayOfWeek) &&
        Objects.equals(this.validityHours, memberActivityDataRedemptionPromotionTier.validityHours) &&
        Objects.equals(this.summary, memberActivityDataRedemptionPromotionTier.summary) &&
        Objects.equals(this._object, memberActivityDataRedemptionPromotionTier._object) &&
        Objects.equals(this.validationRuleAssignments, memberActivityDataRedemptionPromotionTier.validationRuleAssignments) &&
        Objects.equals(this.categoryId, memberActivityDataRedemptionPromotionTier.categoryId) &&
        Objects.equals(this.categories, memberActivityDataRedemptionPromotionTier.categories);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, banner, campaign, metadata, createdAt, updatedAt, action, hierarchy, promotionId, campaignId, active, startDate, expirationDate, validityTimeframe, validityDayOfWeek, validityHours, summary, _object, validationRuleAssignments, categoryId, categories);
  }
  ...
  public String toString() {
    ...
    sb.append("class MemberActivityDataRedemptionPromotionTier {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberActivityDataRedemptionPromotionTier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberActivityDataRedemptionPromotionTier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberActivityDataRedemptionPromotionTier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberActivityDataRedemptionPromotionTier.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberActivityDataRedemptionPromotionTier>() {
           @Override
           public void write(JsonWriter out, MemberActivityDataRedemptionPromotionTier value) throws IOException {
            ...
            for (Field field : MemberActivityDataRedemptionPromotionTier.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = MemberActivityDataRedemptionPromotionTier.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public MemberActivityDataRedemptionPromotionTier read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MemberActivityDataRedemptionPromotionTier given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberActivityDataRedemptionPromotionTier
  * @throws IOException if the JSON string is invalid with respect to MemberActivityDataRedemptionPromotionTier
  */
  public static MemberActivityDataRedemptionPromotionTier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberActivityDataRedemptionPromotionTier.class);
  }

 /**
  * Convert an instance of MemberActivityDataRedemptionPromotionTier to an JSON string
  *
  * @return JSON string
  */
