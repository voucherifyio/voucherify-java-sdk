       ...
       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsUsersAssignResponseBody>() {
           ...
           public void write(JsonWriter out, ManagementProjectsUsersAssignResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ManagementProjectsUsersAssignResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ManagementProjectsUsersAssignResponseBody.class.getDeclaredField(fieldName + "IsSet");
