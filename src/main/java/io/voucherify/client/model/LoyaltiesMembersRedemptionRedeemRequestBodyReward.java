       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesMembersRedemptionRedeemRequestBodyReward>() {
           ...
           public void write(JsonWriter out, LoyaltiesMembersRedemptionRedeemRequestBodyReward value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : LoyaltiesMembersRedemptionRedeemRequestBodyReward.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = LoyaltiesMembersRedemptionRedeemRequestBodyReward.class.getDeclaredField(fieldName + "IsSet");
