...
public class TemplatesCampaignsListResponseBody {
  /**
  ...
  public TemplatesCampaignsListResponseBody() {
  }

  public TemplatesCampaignsListResponseBody _object(ObjectEnum _object) {
  ...
  **/
  ...
  public TemplatesCampaignsListResponseBody dataRef(DataRefEnum dataRef) {
  ...
  **/
  ...
  public TemplatesCampaignsListResponseBody data(List<CampaignTemplate> data) {
    
    this.data = data;
    return this;
  }

  public TemplatesCampaignsListResponseBody addDataItem(CampaignTemplate dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public TemplatesCampaignsListResponseBody total(Integer total) {
  ...
  **/
  ...
  public TemplatesCampaignsListResponseBody hasMore(Boolean hasMore) {
  ...
  **/
  ...
  public TemplatesCampaignsListResponseBody moreStartingAfter(String moreStartingAfter) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TemplatesCampaignsListResponseBody templatesCampaignsListResponseBody = (TemplatesCampaignsListResponseBody) o;
    return Objects.equals(this._object, templatesCampaignsListResponseBody._object) &&
        Objects.equals(this.dataRef, templatesCampaignsListResponseBody.dataRef) &&
        Objects.equals(this.data, templatesCampaignsListResponseBody.data) &&
        Objects.equals(this.total, templatesCampaignsListResponseBody.total) &&
        Objects.equals(this.hasMore, templatesCampaignsListResponseBody.hasMore) &&
        Objects.equals(this.moreStartingAfter, templatesCampaignsListResponseBody.moreStartingAfter);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplatesCampaignsListResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplatesCampaignsListResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplatesCampaignsListResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplatesCampaignsListResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplatesCampaignsListResponseBody>() {
           @Override
           public void write(JsonWriter out, TemplatesCampaignsListResponseBody value) throws IOException {
            ...
            for (Field field : TemplatesCampaignsListResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = TemplatesCampaignsListResponseBody.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public TemplatesCampaignsListResponseBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TemplatesCampaignsListResponseBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TemplatesCampaignsListResponseBody
  * @throws IOException if the JSON string is invalid with respect to TemplatesCampaignsListResponseBody
  */
  public static TemplatesCampaignsListResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplatesCampaignsListResponseBody.class);
  }

 /**
  * Convert an instance of TemplatesCampaignsListResponseBody to an JSON string
  *
  * @return JSON string
  */
