       ...
       return (TypeAdapter<T>) new TypeAdapter<EarningRuleLoyaltyOrderMetadata>() {
           ...
           public void write(JsonWriter out, EarningRuleLoyaltyOrderMetadata value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : EarningRuleLoyaltyOrderMetadata.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = EarningRuleLoyaltyOrderMetadata.class.getDeclaredField(fieldName + "IsSet");
