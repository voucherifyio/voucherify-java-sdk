...
public class EarningRuleLoyaltyOrderMetadata {
  ...
  **/
   ...
   * @return the EarningRuleLoyaltyOrderMetadata instance itself
   */
  public EarningRuleLoyaltyOrderMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.every, earningRuleLoyaltyOrderMetadata.every) &&
        ...
        Objects.equals(this.additionalProperties, earningRuleLoyaltyOrderMetadata.additionalProperties);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EarningRuleLoyaltyOrderMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EarningRuleLoyaltyOrderMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EarningRuleLoyaltyOrderMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EarningRuleLoyaltyOrderMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<EarningRuleLoyaltyOrderMetadata>() {
           @Override
           public void write(JsonWriter out, EarningRuleLoyaltyOrderMetadata value) throws IOException {
           ...
           @Override
           public EarningRuleLoyaltyOrderMetadata read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EarningRuleLoyaltyOrderMetadata instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  * @return An instance of EarningRuleLoyaltyOrderMetadata
  * @throws IOException if the JSON string is invalid with respect to EarningRuleLoyaltyOrderMetadata
  */
  public static EarningRuleLoyaltyOrderMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EarningRuleLoyaltyOrderMetadata.class);
  }
