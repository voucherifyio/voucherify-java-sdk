       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListRedemptionsCustomerId>() {
           ...
           public void write(JsonWriter out, ParameterFiltersListRedemptionsCustomerId value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ParameterFiltersListRedemptionsCustomerId.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ParameterFiltersListRedemptionsCustomerId.class.getDeclaredField(fieldName + "IsSet");
