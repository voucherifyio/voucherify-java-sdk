...
public class RewardAssignmentParametersParameters {
  ...
  **/
   ...
   * @return the RewardAssignmentParametersParameters instance itself
   */
  public RewardAssignmentParametersParameters putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RewardAssignmentParametersParameters>() {
           ...
           public RewardAssignmentParametersParameters read(JsonReader in) throws IOException {
             ...
             RewardAssignmentParametersParameters instance = thisAdapter.fromJsonTree(jsonObj);
