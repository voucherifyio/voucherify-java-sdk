...
import io.voucherify.client.model.MemberActivityDataRedemptionOrderCustomer;
import io.voucherify.client.model.MemberActivityDataRedemptionOrderItemsItem;
import io.voucherify.client.model.MemberActivityDataRedemptionOrderReferrer;
...
public class MemberActivityDataRedemptionOrder {
  ...
  private List<MemberActivityDataRedemptionOrderItemsItem> items;
  ...
  private MemberActivityDataRedemptionOrderCustomer customer;
  ...
  private MemberActivityDataRedemptionOrderReferrer referrer;
  ...
  public MemberActivityDataRedemptionOrder() {
  }

  public MemberActivityDataRedemptionOrder id(String id) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder status(StatusEnum status) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder customerId(String customerId) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder amount(Integer amount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder items(List<MemberActivityDataRedemptionOrderItemsItem> items) {
    
    this.items = items;
    return this;
  }

  public MemberActivityDataRedemptionOrder addItemsItem(MemberActivityDataRedemptionOrderItemsItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<MemberActivityDataRedemptionOrderItemsItem> getItems() {
    return items;
  }


  public void setItems(List<MemberActivityDataRedemptionOrderItemsItem> items) {
    this.items = items;
  ...
  public MemberActivityDataRedemptionOrder metadata(Object metadata) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrder customer(MemberActivityDataRedemptionOrderCustomer customer) {
  ...
  **/
  @javax.annotation.Nullable
  public MemberActivityDataRedemptionOrderCustomer getCustomer() {
    return customer;
  }


  public void setCustomer(MemberActivityDataRedemptionOrderCustomer customer) {
    this.customer = customer;
  ...
  public MemberActivityDataRedemptionOrder referrer(MemberActivityDataRedemptionOrderReferrer referrer) {
  ...
  **/
  @javax.annotation.Nullable
  public MemberActivityDataRedemptionOrderReferrer getReferrer() {
    return referrer;
  }


  public void setReferrer(MemberActivityDataRedemptionOrderReferrer referrer) {
    this.referrer = referrer;
  ...
  public MemberActivityDataRedemptionOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public MemberActivityDataRedemptionOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MemberActivityDataRedemptionOrder memberActivityDataRedemptionOrder = (MemberActivityDataRedemptionOrder) o;
    return Objects.equals(this.id, memberActivityDataRedemptionOrder.id) &&
        Objects.equals(this.sourceId, memberActivityDataRedemptionOrder.sourceId) &&
        Objects.equals(this.status, memberActivityDataRedemptionOrder.status) &&
        Objects.equals(this.customerId, memberActivityDataRedemptionOrder.customerId) &&
        Objects.equals(this.referrerId, memberActivityDataRedemptionOrder.referrerId) &&
        Objects.equals(this.amount, memberActivityDataRedemptionOrder.amount) &&
        Objects.equals(this.discountAmount, memberActivityDataRedemptionOrder.discountAmount) &&
        Objects.equals(this.appliedDiscountAmount, memberActivityDataRedemptionOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsDiscountAmount, memberActivityDataRedemptionOrder.itemsDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, memberActivityDataRedemptionOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, memberActivityDataRedemptionOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, memberActivityDataRedemptionOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.totalAmount, memberActivityDataRedemptionOrder.totalAmount) &&
        Objects.equals(this.items, memberActivityDataRedemptionOrder.items) &&
        Objects.equals(this.metadata, memberActivityDataRedemptionOrder.metadata) &&
        Objects.equals(this._object, memberActivityDataRedemptionOrder._object) &&
        Objects.equals(this.initialAmount, memberActivityDataRedemptionOrder.initialAmount) &&
        Objects.equals(this.createdAt, memberActivityDataRedemptionOrder.createdAt) &&
        Objects.equals(this.updatedAt, memberActivityDataRedemptionOrder.updatedAt) &&
        Objects.equals(this.customer, memberActivityDataRedemptionOrder.customer) &&
        Objects.equals(this.referrer, memberActivityDataRedemptionOrder.referrer) &&
        Objects.equals(this.redemptions, memberActivityDataRedemptionOrder.redemptions);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, sourceId, status, customerId, referrerId, amount, discountAmount, appliedDiscountAmount, itemsDiscountAmount, itemsAppliedDiscountAmount, totalDiscountAmount, totalAppliedDiscountAmount, totalAmount, items, metadata, _object, initialAmount, createdAt, updatedAt, customer, referrer, redemptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class MemberActivityDataRedemptionOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberActivityDataRedemptionOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberActivityDataRedemptionOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberActivityDataRedemptionOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberActivityDataRedemptionOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberActivityDataRedemptionOrder>() {
           @Override
           public void write(JsonWriter out, MemberActivityDataRedemptionOrder value) throws IOException {
            ...
            for (Field field : MemberActivityDataRedemptionOrder.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = MemberActivityDataRedemptionOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public MemberActivityDataRedemptionOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MemberActivityDataRedemptionOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberActivityDataRedemptionOrder
  * @throws IOException if the JSON string is invalid with respect to MemberActivityDataRedemptionOrder
  */
  public static MemberActivityDataRedemptionOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberActivityDataRedemptionOrder.class);
  }

 /**
  * Convert an instance of MemberActivityDataRedemptionOrder to an JSON string
  *
  * @return JSON string
  */
