...
public class ValidationsValidateResponseBodyOrderItemsItem {
  ...
  public ValidationsValidateResponseBodyOrderItemsItem() {
  }

  public ValidationsValidateResponseBodyOrderItemsItem id(String id) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem skuId(String skuId) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem productId(String productId) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem relatedObject(RelatedObjectEnum relatedObject) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem sourceId(String sourceId) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem quantity(Integer quantity) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem discountQuantity(Integer discountQuantity) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem initialQuantity(Integer initialQuantity) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem amount(Integer amount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem appliedDiscountQuantity(Integer appliedDiscountQuantity) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem appliedQuantity(Integer appliedQuantity) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem appliedQuantityAmount(Integer appliedQuantityAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem price(Integer price) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem subtotalAmount(Integer subtotalAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem product(OrderCalculatedItemProduct product) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem sku(OrderCalculatedItemSku sku) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem _object(ObjectEnum _object) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyOrderItemsItem applicationDetails(List<ApplicationDetailsItem> applicationDetails) {
    
    this.applicationDetails = applicationDetails;
    return this;
  }

  public ValidationsValidateResponseBodyOrderItemsItem addApplicationDetailsItem(ApplicationDetailsItem applicationDetailsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ValidationsValidateResponseBodyOrderItemsItem validationsValidateResponseBodyOrderItemsItem = (ValidationsValidateResponseBodyOrderItemsItem) o;
    return Objects.equals(this.id, validationsValidateResponseBodyOrderItemsItem.id) &&
        Objects.equals(this.skuId, validationsValidateResponseBodyOrderItemsItem.skuId) &&
        Objects.equals(this.productId, validationsValidateResponseBodyOrderItemsItem.productId) &&
        Objects.equals(this.relatedObject, validationsValidateResponseBodyOrderItemsItem.relatedObject) &&
        Objects.equals(this.sourceId, validationsValidateResponseBodyOrderItemsItem.sourceId) &&
        Objects.equals(this.quantity, validationsValidateResponseBodyOrderItemsItem.quantity) &&
        Objects.equals(this.discountQuantity, validationsValidateResponseBodyOrderItemsItem.discountQuantity) &&
        Objects.equals(this.initialQuantity, validationsValidateResponseBodyOrderItemsItem.initialQuantity) &&
        Objects.equals(this.amount, validationsValidateResponseBodyOrderItemsItem.amount) &&
        Objects.equals(this.discountAmount, validationsValidateResponseBodyOrderItemsItem.discountAmount) &&
        Objects.equals(this.appliedDiscountAmount, validationsValidateResponseBodyOrderItemsItem.appliedDiscountAmount) &&
        Objects.equals(this.appliedDiscountQuantity, validationsValidateResponseBodyOrderItemsItem.appliedDiscountQuantity) &&
        Objects.equals(this.appliedQuantity, validationsValidateResponseBodyOrderItemsItem.appliedQuantity) &&
        Objects.equals(this.appliedQuantityAmount, validationsValidateResponseBodyOrderItemsItem.appliedQuantityAmount) &&
        Objects.equals(this.initialAmount, validationsValidateResponseBodyOrderItemsItem.initialAmount) &&
        Objects.equals(this.price, validationsValidateResponseBodyOrderItemsItem.price) &&
        Objects.equals(this.subtotalAmount, validationsValidateResponseBodyOrderItemsItem.subtotalAmount) &&
        Objects.equals(this.product, validationsValidateResponseBodyOrderItemsItem.product) &&
        Objects.equals(this.sku, validationsValidateResponseBodyOrderItemsItem.sku) &&
        Objects.equals(this._object, validationsValidateResponseBodyOrderItemsItem._object) &&
        Objects.equals(this.metadata, validationsValidateResponseBodyOrderItemsItem.metadata) &&
        Objects.equals(this.applicationDetails, validationsValidateResponseBodyOrderItemsItem.applicationDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValidationsValidateResponseBodyOrderItemsItem {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidationsValidateResponseBodyOrderItemsItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidationsValidateResponseBodyOrderItemsItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidationsValidateResponseBodyOrderItemsItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidationsValidateResponseBodyOrderItemsItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidationsValidateResponseBodyOrderItemsItem>() {
           @Override
           public void write(JsonWriter out, ValidationsValidateResponseBodyOrderItemsItem value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ValidationsValidateResponseBodyOrderItemsItem.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ValidationsValidateResponseBodyOrderItemsItem.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ValidationsValidateResponseBodyOrderItemsItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ValidationsValidateResponseBodyOrderItemsItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ValidationsValidateResponseBodyOrderItemsItem
  * @throws IOException if the JSON string is invalid with respect to ValidationsValidateResponseBodyOrderItemsItem
  */
  public static ValidationsValidateResponseBodyOrderItemsItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidationsValidateResponseBodyOrderItemsItem.class);
  }

 /**
  * Convert an instance of ValidationsValidateResponseBodyOrderItemsItem to an JSON string
  *
  * @return JSON string
  */
