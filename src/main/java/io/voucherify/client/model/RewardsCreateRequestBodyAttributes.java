       ...
       return (TypeAdapter<T>) new TypeAdapter<RewardsCreateRequestBodyAttributes>() {
           ...
           public void write(JsonWriter out, RewardsCreateRequestBodyAttributes value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RewardsCreateRequestBodyAttributes.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RewardsCreateRequestBodyAttributes.class.getDeclaredField(fieldName + "IsSet");
