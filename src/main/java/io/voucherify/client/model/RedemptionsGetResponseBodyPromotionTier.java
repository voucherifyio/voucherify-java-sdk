    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionsGetResponseBodyPromotionTier>() {
           ...
           public void write(JsonWriter out, RedemptionsGetResponseBodyPromotionTier value) throws IOException {
            ...
            for (Field field : RedemptionsGetResponseBodyPromotionTier.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionsGetResponseBodyPromotionTier.class.getDeclaredField(fieldName + "IsSet");
