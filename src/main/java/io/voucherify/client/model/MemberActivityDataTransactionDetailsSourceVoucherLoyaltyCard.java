...
public class MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard {
  ...
  public MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard() {
  }

  public MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard nextExpirationDate(String nextExpirationDate) {
  ...
  **/
  ...
  public MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard memberActivityDataTransactionDetailsSourceVoucherLoyaltyCard = (MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard) o;
    return Objects.equals(this.points, memberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.points) &&
        Objects.equals(this.balance, memberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, memberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, memberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, memberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, memberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, memberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard value) throws IOException {
            ...
            for (Field field : MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard
  */
  public static MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard.class);
  }

 /**
  * Convert an instance of MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
