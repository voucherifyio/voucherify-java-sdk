       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidationsRedeemableInapplicableResult>() {
           ...
           public void write(JsonWriter out, ValidationsRedeemableInapplicableResult value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ValidationsRedeemableInapplicableResult.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ValidationsRedeemableInapplicableResult.class.getDeclaredField(fieldName + "IsSet");
