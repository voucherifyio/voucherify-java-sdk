...
public class LoyaltiesMembersGetResponseBodyLoyaltyCard {
  ...
  public LoyaltiesMembersGetResponseBodyLoyaltyCard() {
  }

  public LoyaltiesMembersGetResponseBodyLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public LoyaltiesMembersGetResponseBodyLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public LoyaltiesMembersGetResponseBodyLoyaltyCard nextExpirationDate(LocalDate nextExpirationDate) {
  ...
  **/
  ...
  public LoyaltiesMembersGetResponseBodyLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public LoyaltiesMembersGetResponseBodyLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public LoyaltiesMembersGetResponseBodyLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public LoyaltiesMembersGetResponseBodyLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LoyaltiesMembersGetResponseBodyLoyaltyCard loyaltiesMembersGetResponseBodyLoyaltyCard = (LoyaltiesMembersGetResponseBodyLoyaltyCard) o;
    return Objects.equals(this.points, loyaltiesMembersGetResponseBodyLoyaltyCard.points) &&
        Objects.equals(this.balance, loyaltiesMembersGetResponseBodyLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, loyaltiesMembersGetResponseBodyLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, loyaltiesMembersGetResponseBodyLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, loyaltiesMembersGetResponseBodyLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, loyaltiesMembersGetResponseBodyLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, loyaltiesMembersGetResponseBodyLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoyaltiesMembersGetResponseBodyLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoyaltiesMembersGetResponseBodyLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoyaltiesMembersGetResponseBodyLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoyaltiesMembersGetResponseBodyLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoyaltiesMembersGetResponseBodyLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesMembersGetResponseBodyLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, LoyaltiesMembersGetResponseBodyLoyaltyCard value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : LoyaltiesMembersGetResponseBodyLoyaltyCard.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = LoyaltiesMembersGetResponseBodyLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public LoyaltiesMembersGetResponseBodyLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LoyaltiesMembersGetResponseBodyLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoyaltiesMembersGetResponseBodyLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to LoyaltiesMembersGetResponseBodyLoyaltyCard
  */
  public static LoyaltiesMembersGetResponseBodyLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoyaltiesMembersGetResponseBodyLoyaltyCard.class);
  }

 /**
  * Convert an instance of LoyaltiesMembersGetResponseBodyLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
