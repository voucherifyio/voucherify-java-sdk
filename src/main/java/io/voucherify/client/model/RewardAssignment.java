...
public class RewardAssignment {
  ...
  private RewardAssignmentParameters parameters;
    private boolean parametersIsSet = false;

  public RewardAssignment() {
  }

  public RewardAssignment id(String id) {
  ...
  **/
  ...
  public RewardAssignment rewardId(String rewardId) {
  ...
  **/
  ...
  public RewardAssignment createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public RewardAssignment updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public RewardAssignment _object(ObjectEnum _object) {
  ...
  **/
  ...
  public RewardAssignment relatedObjectId(String relatedObjectId) {
  ...
  **/
  ...
  public RewardAssignment relatedObjectType(RelatedObjectTypeEnum relatedObjectType) {
  ...
  **/
  ...
  public RewardAssignment parameters(RewardAssignmentParameters parameters) {
  ...
  **/
  @javax.annotation.Nullable
  public RewardAssignmentParameters getParameters() {
    return parameters;
  }


  public void setParameters(RewardAssignmentParameters parameters) {
    this.parameters = parameters;
  ...
  public boolean equals(Object o) {
    ...
    RewardAssignment rewardAssignment = (RewardAssignment) o;
    return Objects.equals(this.id, rewardAssignment.id) &&
        Objects.equals(this.rewardId, rewardAssignment.rewardId) &&
        Objects.equals(this.createdAt, rewardAssignment.createdAt) &&
        Objects.equals(this.updatedAt, rewardAssignment.updatedAt) &&
        Objects.equals(this._object, rewardAssignment._object) &&
        Objects.equals(this.relatedObjectId, rewardAssignment.relatedObjectId) &&
        Objects.equals(this.relatedObjectType, rewardAssignment.relatedObjectType) &&
        Objects.equals(this.parameters, rewardAssignment.parameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class RewardAssignment {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RewardAssignment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RewardAssignment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RewardAssignment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RewardAssignment.class));

       return (TypeAdapter<T>) new TypeAdapter<RewardAssignment>() {
           @Override
           public void write(JsonWriter out, RewardAssignment value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RewardAssignment.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RewardAssignment.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RewardAssignment read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RewardAssignment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RewardAssignment
  * @throws IOException if the JSON string is invalid with respect to RewardAssignment
  */
  public static RewardAssignment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RewardAssignment.class);
  }

 /**
  * Convert an instance of RewardAssignment to an JSON string
  *
  * @return JSON string
  */
