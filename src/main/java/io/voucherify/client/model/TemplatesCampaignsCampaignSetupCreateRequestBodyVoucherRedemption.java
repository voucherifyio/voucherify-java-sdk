       ...
       return (TypeAdapter<T>) new TypeAdapter<TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption>() {
           ...
           public void write(JsonWriter out, TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption.class.getDeclaredField(fieldName + "IsSet");
