    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionsListResponseBodyRedemptionsItemVoucher>() {
           ...
           public void write(JsonWriter out, RedemptionsListResponseBodyRedemptionsItemVoucher value) throws IOException {
            ...
            for (Field field : RedemptionsListResponseBodyRedemptionsItemVoucher.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionsListResponseBodyRedemptionsItemVoucher.class.getDeclaredField(fieldName + "IsSet");
