...
public class VoucherGift {
  ...
  **/
  ...
  public VoucherGift subtractedAmount(Integer subtractedAmount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, voucherGift.amount) &&
        Objects.equals(this.subtractedAmount, voucherGift.subtractedAmount) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VoucherGift>() {
           ...
           public void write(JsonWriter out, VoucherGift value) throws IOException {
            ...
            for (Field field : VoucherGift.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = VoucherGift.class.getDeclaredField(fieldName + "IsSet");
