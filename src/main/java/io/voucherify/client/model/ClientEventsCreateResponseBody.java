...
public class ClientEventsCreateResponseBody {
  ...
  **/
  ...
  public ClientEventsCreateResponseBody metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._object, clientEventsCreateResponseBody._object) &&
        ...
        Objects.equals(this.metadata, clientEventsCreateResponseBody.metadata);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ClientEventsCreateResponseBody>() {
           ...
           public void write(JsonWriter out, ClientEventsCreateResponseBody value) throws IOException {
            ...
            for (Field field : ClientEventsCreateResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ClientEventsCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
