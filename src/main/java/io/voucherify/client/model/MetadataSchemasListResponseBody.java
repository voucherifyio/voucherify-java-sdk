...
public class MetadataSchemasListResponseBody {
  ...
  private List<MetadataSchemaDeprecated> schemas;
    private boolean schemasIsSet = false;
       ...
       return (TypeAdapter<T>) new TypeAdapter<MetadataSchemasListResponseBody>() {
           ...
           public void write(JsonWriter out, MetadataSchemasListResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : MetadataSchemasListResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = MetadataSchemasListResponseBody.class.getDeclaredField(fieldName + "IsSet");
