    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsBrandingUpdateRequestBodyCockpits>() {
           ...
           public void write(JsonWriter out, ManagementProjectsBrandingUpdateRequestBodyCockpits value) throws IOException {
            ...
            for (Field field : ManagementProjectsBrandingUpdateRequestBodyCockpits.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectsBrandingUpdateRequestBodyCockpits.class.getDeclaredField(fieldName + "IsSet");
