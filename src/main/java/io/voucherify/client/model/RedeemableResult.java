  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.discount, redeemableResult.discount) &&
        Objects.equals(this.bundle, redeemableResult.bundle) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(discount, bundle, gift, loyaltyCard, error);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RedeemableResult>() {
           ...
           public void write(JsonWriter out, RedeemableResult value) throws IOException {
            ...
            for (Field field : RedeemableResult.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedeemableResult.class.getDeclaredField(fieldName + "IsSet");
