...
public class ManagementProjectsStackingRulesCreateRequestBody {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateRequestBody redeemablesLimit(Integer redeemablesLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateRequestBody applicableRedeemablesCategoryLimits(Map<String, Integer> applicableRedeemablesCategoryLimits) {
  ...
  public ManagementProjectsStackingRulesCreateRequestBody putApplicableRedeemablesCategoryLimitsItem(String key, Integer applicableRedeemablesCategoryLimitsItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateRequestBody discountCalculationMode(DiscountCalculationModeEnum discountCalculationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateRequestBody redeemablesApplicationMode(RedeemablesApplicationModeEnum redeemablesApplicationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateRequestBody redeemablesSortingRule(RedeemablesSortingRuleEnum redeemablesSortingRule) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateRequestBody redeemablesProductsApplicationMode(RedeemablesProductsApplicationModeEnum redeemablesProductsApplicationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateRequestBody redeemablesNoEffectRule(RedeemablesNoEffectRuleEnum redeemablesNoEffectRule) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateRequestBody noEffectSkipCategories(List<String> noEffectSkipCategories) {
  ...
  public ManagementProjectsStackingRulesCreateRequestBody addNoEffectSkipCategoriesItem(String noEffectSkipCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateRequestBody noEffectRedeemAnywayCategories(List<String> noEffectRedeemAnywayCategories) {
  ...
  public ManagementProjectsStackingRulesCreateRequestBody addNoEffectRedeemAnywayCategoriesItem(String noEffectRedeemAnywayCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateRequestBody redeemablesRollbackOrderMode(RedeemablesRollbackOrderModeEnum redeemablesRollbackOrderMode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsStackingRulesCreateRequestBody managementProjectsStackingRulesCreateRequestBody = (ManagementProjectsStackingRulesCreateRequestBody) o;
    return Objects.equals(this.exclusiveCategories, managementProjectsStackingRulesCreateRequestBody.exclusiveCategories) &&
        Objects.equals(this.jointCategories, managementProjectsStackingRulesCreateRequestBody.jointCategories) &&
        Objects.equals(this.redeemablesLimit, managementProjectsStackingRulesCreateRequestBody.redeemablesLimit) &&
        Objects.equals(this.applicableRedeemablesLimit, managementProjectsStackingRulesCreateRequestBody.applicableRedeemablesLimit) &&
        Objects.equals(this.applicableRedeemablesPerCategoryLimit, managementProjectsStackingRulesCreateRequestBody.applicableRedeemablesPerCategoryLimit) &&
        Objects.equals(this.applicableRedeemablesCategoryLimits, managementProjectsStackingRulesCreateRequestBody.applicableRedeemablesCategoryLimits) &&
        Objects.equals(this.applicableExclusiveRedeemablesLimit, managementProjectsStackingRulesCreateRequestBody.applicableExclusiveRedeemablesLimit) &&
        Objects.equals(this.applicableExclusiveRedeemablesPerCategoryLimit, managementProjectsStackingRulesCreateRequestBody.applicableExclusiveRedeemablesPerCategoryLimit) &&
        Objects.equals(this.discountCalculationMode, managementProjectsStackingRulesCreateRequestBody.discountCalculationMode) &&
        Objects.equals(this.initialAmountModeCategories, managementProjectsStackingRulesCreateRequestBody.initialAmountModeCategories) &&
        Objects.equals(this.discountedAmountModeCategories, managementProjectsStackingRulesCreateRequestBody.discountedAmountModeCategories) &&
        Objects.equals(this.redeemablesApplicationMode, managementProjectsStackingRulesCreateRequestBody.redeemablesApplicationMode) &&
        Objects.equals(this.redeemablesSortingRule, managementProjectsStackingRulesCreateRequestBody.redeemablesSortingRule) &&
        Objects.equals(this.redeemablesProductsApplicationMode, managementProjectsStackingRulesCreateRequestBody.redeemablesProductsApplicationMode) &&
        Objects.equals(this.redeemablesNoEffectRule, managementProjectsStackingRulesCreateRequestBody.redeemablesNoEffectRule) &&
        Objects.equals(this.noEffectSkipCategories, managementProjectsStackingRulesCreateRequestBody.noEffectSkipCategories) &&
        Objects.equals(this.noEffectRedeemAnywayCategories, managementProjectsStackingRulesCreateRequestBody.noEffectRedeemAnywayCategories) &&
        Objects.equals(this.redeemablesRollbackOrderMode, managementProjectsStackingRulesCreateRequestBody.redeemablesRollbackOrderMode);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsStackingRulesCreateRequestBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsStackingRulesCreateRequestBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsStackingRulesCreateRequestBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsStackingRulesCreateRequestBody.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsStackingRulesCreateRequestBody>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsStackingRulesCreateRequestBody value) throws IOException {
            ...
            for (Field field : ManagementProjectsStackingRulesCreateRequestBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectsStackingRulesCreateRequestBody.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ManagementProjectsStackingRulesCreateRequestBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagementProjectsStackingRulesCreateRequestBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagementProjectsStackingRulesCreateRequestBody
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsStackingRulesCreateRequestBody
  */
  public static ManagementProjectsStackingRulesCreateRequestBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsStackingRulesCreateRequestBody.class);
  }

 /**
  * Convert an instance of ManagementProjectsStackingRulesCreateRequestBody to an JSON string
  *
  * @return JSON string
  */
