...
public class ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions {
  /**
   * Gets or Sets $in
   */
  ...
  private IsEnum $is = IsEnum.VOUCHER;
  ...
  private IsNotEnum $isNot = IsNotEnum.VOUCHER;
  ...
  public ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions add$InItem(InEnum $inItem) {
    if (this.$in == null) {
  ...
  **/
  ...
  public ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions add$NotInItem(NotInEnum $notInItem) {
    if (this.$notIn == null) {
  ...
  **/
   ...
   * @return the ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions instance itself
   */
  public ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions parameterFiltersListCustomerRedeemablesRedeemableObjectConditions = (ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions) o;
    return Objects.equals(this.$in, parameterFiltersListCustomerRedeemablesRedeemableObjectConditions.$in) &&
        Objects.equals(this.$notIn, parameterFiltersListCustomerRedeemablesRedeemableObjectConditions.$notIn) &&
        Objects.equals(this.$is, parameterFiltersListCustomerRedeemablesRedeemableObjectConditions.$is) &&
        Objects.equals(this.$isNot, parameterFiltersListCustomerRedeemablesRedeemableObjectConditions.$isNot) &&
        Objects.equals(this.$hasValue, parameterFiltersListCustomerRedeemablesRedeemableObjectConditions.$hasValue) &&
        Objects.equals(this.$isUnknown, parameterFiltersListCustomerRedeemablesRedeemableObjectConditions.$isUnknown) &&
        Objects.equals(this.$startsWith, parameterFiltersListCustomerRedeemablesRedeemableObjectConditions.$startsWith) &&
        Objects.equals(this.$endsWith, parameterFiltersListCustomerRedeemablesRedeemableObjectConditions.$endsWith)&&
        Objects.equals(this.additionalProperties, parameterFiltersListCustomerRedeemablesRedeemableObjectConditions.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions.class));

       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions>() {
           @Override
           public void write(JsonWriter out, ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions value) throws IOException {
           ...
           @Override
           public ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions
  * @throws IOException if the JSON string is invalid with respect to ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions
  */
  public static ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions.class);
  }

 /**
  * Convert an instance of ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions to an JSON string
  *
  * @return JSON string
  */
