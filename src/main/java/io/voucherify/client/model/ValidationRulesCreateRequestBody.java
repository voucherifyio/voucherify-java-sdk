...
public class ValidationRulesCreateRequestBody {
  ...
  **/
  ...
  public ValidationRulesCreateRequestBody error(ValidationRuleError error) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidationRulesCreateRequestBody>() {
           ...
           public void write(JsonWriter out, ValidationRulesCreateRequestBody value) throws IOException {
            ...
            for (Field field : ValidationRulesCreateRequestBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ValidationRulesCreateRequestBody.class.getDeclaredField(fieldName + "IsSet");
