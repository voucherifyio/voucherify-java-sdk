    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<QualificationsOptionFiltersCampaignTypeConditions>() {
           ...
           public void write(JsonWriter out, QualificationsOptionFiltersCampaignTypeConditions value) throws IOException {
            ...
            for (Field field : QualificationsOptionFiltersCampaignTypeConditions.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = QualificationsOptionFiltersCampaignTypeConditions.class.getDeclaredField(fieldName + "IsSet");
