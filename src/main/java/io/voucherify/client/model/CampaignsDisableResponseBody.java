...
public class CampaignsDisableResponseBody {
   ...
   * @return the CampaignsDisableResponseBody instance itself
   */
  public CampaignsDisableResponseBody putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignsDisableResponseBody>() {
           ...
           public CampaignsDisableResponseBody read(JsonReader in) throws IOException {
             ...
             CampaignsDisableResponseBody instance = thisAdapter.fromJsonTree(jsonObj);
