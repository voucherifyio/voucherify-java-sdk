    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionEntryVoucherRedemption>() {
           ...
           public void write(JsonWriter out, RedemptionEntryVoucherRedemption value) throws IOException {
            ...
            for (Field field : RedemptionEntryVoucherRedemption.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionEntryVoucherRedemption.class.getDeclaredField(fieldName + "IsSet");
