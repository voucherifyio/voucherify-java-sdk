...
import io.voucherify.client.model.QualificationsRedeemableBaseOrderItemsItem;
...
public class QualificationsRedeemableBaseOrder {
  ...
  private List<QualificationsRedeemableBaseOrderItemsItem> items;
    private boolean itemsIsSet = false;

  public QualificationsRedeemableBaseOrder() {
  }

  public QualificationsRedeemableBaseOrder id(String id) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder status(StatusEnum status) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder amount(Integer amount) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder metadata(Object metadata) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder customerId(String customerId) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder customer(CustomerId customer) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder referrer(ReferrerId referrer) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public QualificationsRedeemableBaseOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public QualificationsRedeemableBaseOrder items(List<QualificationsRedeemableBaseOrderItemsItem> items) {
    
    this.items = items;
    return this;
  }

  public QualificationsRedeemableBaseOrder addItemsItem(QualificationsRedeemableBaseOrderItemsItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<QualificationsRedeemableBaseOrderItemsItem> getItems() {
    return items;
  }


  public void setItems(List<QualificationsRedeemableBaseOrderItemsItem> items) {
    this.items = items;
  ...
  public boolean equals(Object o) {
    ...
    QualificationsRedeemableBaseOrder qualificationsRedeemableBaseOrder = (QualificationsRedeemableBaseOrder) o;
    return Objects.equals(this.id, qualificationsRedeemableBaseOrder.id) &&
        Objects.equals(this.sourceId, qualificationsRedeemableBaseOrder.sourceId) &&
        Objects.equals(this.status, qualificationsRedeemableBaseOrder.status) &&
        Objects.equals(this.amount, qualificationsRedeemableBaseOrder.amount) &&
        Objects.equals(this.initialAmount, qualificationsRedeemableBaseOrder.initialAmount) &&
        Objects.equals(this.discountAmount, qualificationsRedeemableBaseOrder.discountAmount) &&
        Objects.equals(this.itemsDiscountAmount, qualificationsRedeemableBaseOrder.itemsDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, qualificationsRedeemableBaseOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAmount, qualificationsRedeemableBaseOrder.totalAmount) &&
        Objects.equals(this.appliedDiscountAmount, qualificationsRedeemableBaseOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, qualificationsRedeemableBaseOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, qualificationsRedeemableBaseOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.metadata, qualificationsRedeemableBaseOrder.metadata) &&
        Objects.equals(this._object, qualificationsRedeemableBaseOrder._object) &&
        Objects.equals(this.createdAt, qualificationsRedeemableBaseOrder.createdAt) &&
        Objects.equals(this.updatedAt, qualificationsRedeemableBaseOrder.updatedAt) &&
        Objects.equals(this.customerId, qualificationsRedeemableBaseOrder.customerId) &&
        Objects.equals(this.referrerId, qualificationsRedeemableBaseOrder.referrerId) &&
        Objects.equals(this.customer, qualificationsRedeemableBaseOrder.customer) &&
        Objects.equals(this.referrer, qualificationsRedeemableBaseOrder.referrer) &&
        Objects.equals(this.redemptions, qualificationsRedeemableBaseOrder.redemptions) &&
        Objects.equals(this.items, qualificationsRedeemableBaseOrder.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class QualificationsRedeemableBaseOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QualificationsRedeemableBaseOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QualificationsRedeemableBaseOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QualificationsRedeemableBaseOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QualificationsRedeemableBaseOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<QualificationsRedeemableBaseOrder>() {
           @Override
           public void write(JsonWriter out, QualificationsRedeemableBaseOrder value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : QualificationsRedeemableBaseOrder.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = QualificationsRedeemableBaseOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public QualificationsRedeemableBaseOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of QualificationsRedeemableBaseOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of QualificationsRedeemableBaseOrder
  * @throws IOException if the JSON string is invalid with respect to QualificationsRedeemableBaseOrder
  */
  public static QualificationsRedeemableBaseOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QualificationsRedeemableBaseOrder.class);
  }

 /**
  * Convert an instance of QualificationsRedeemableBaseOrder to an JSON string
  *
  * @return JSON string
  */
