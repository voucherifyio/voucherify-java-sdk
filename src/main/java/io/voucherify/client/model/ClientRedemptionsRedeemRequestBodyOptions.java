...
public class ClientRedemptionsRedeemRequestBodyOptions {
  /**
   * Gets or Sets expand
   */
  ...
  public ClientRedemptionsRedeemRequestBodyOptions expand(List<ExpandEnum> expand) {
    
    this.expand = expand;
    return this;
  }

  public ClientRedemptionsRedeemRequestBodyOptions addExpandItem(ExpandEnum expandItem) {
    if (this.expand == null) {
  ...
  **/
   ...
   * @return the ClientRedemptionsRedeemRequestBodyOptions instance itself
   */
  public ClientRedemptionsRedeemRequestBodyOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ClientRedemptionsRedeemRequestBodyOptions clientRedemptionsRedeemRequestBodyOptions = (ClientRedemptionsRedeemRequestBodyOptions) o;
    return Objects.equals(this.expand, clientRedemptionsRedeemRequestBodyOptions.expand)&&
        Objects.equals(this.additionalProperties, clientRedemptionsRedeemRequestBodyOptions.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClientRedemptionsRedeemRequestBodyOptions {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClientRedemptionsRedeemRequestBodyOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClientRedemptionsRedeemRequestBodyOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClientRedemptionsRedeemRequestBodyOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClientRedemptionsRedeemRequestBodyOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<ClientRedemptionsRedeemRequestBodyOptions>() {
           @Override
           public void write(JsonWriter out, ClientRedemptionsRedeemRequestBodyOptions value) throws IOException {
           ...
           @Override
           public ClientRedemptionsRedeemRequestBodyOptions read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ClientRedemptionsRedeemRequestBodyOptions instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  * @return An instance of ClientRedemptionsRedeemRequestBodyOptions
  * @throws IOException if the JSON string is invalid with respect to ClientRedemptionsRedeemRequestBodyOptions
  */
  public static ClientRedemptionsRedeemRequestBodyOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClientRedemptionsRedeemRequestBodyOptions.class);
  }
