    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ClientRedemptionsRedeemRequestBodyOptions>() {
           ...
           public void write(JsonWriter out, ClientRedemptionsRedeemRequestBodyOptions value) throws IOException {
            ...
            for (Field field : ClientRedemptionsRedeemRequestBodyOptions.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ClientRedemptionsRedeemRequestBodyOptions.class.getDeclaredField(fieldName + "IsSet");
