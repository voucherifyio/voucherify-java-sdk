...
public class RewardsAssignmentsCreateResponseBody {
  ...
  public RewardsAssignmentsCreateResponseBody id(String id) {
  ...
  **/
  ...
  public RewardsAssignmentsCreateResponseBody rewardId(String rewardId) {
  ...
  **/
  ...
  public RewardsAssignmentsCreateResponseBody createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public RewardsAssignmentsCreateResponseBody updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public RewardsAssignmentsCreateResponseBody _object(ObjectEnum _object) {
  ...
  **/
  ...
  public RewardsAssignmentsCreateResponseBody relatedObjectId(String relatedObjectId) {
  ...
  **/
  ...
  public RewardsAssignmentsCreateResponseBody relatedObjectType(RelatedObjectTypeEnum relatedObjectType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RewardsAssignmentsCreateResponseBody rewardsAssignmentsCreateResponseBody = (RewardsAssignmentsCreateResponseBody) o;
    return Objects.equals(this.id, rewardsAssignmentsCreateResponseBody.id) &&
        Objects.equals(this.rewardId, rewardsAssignmentsCreateResponseBody.rewardId) &&
        Objects.equals(this.createdAt, rewardsAssignmentsCreateResponseBody.createdAt) &&
        Objects.equals(this.updatedAt, rewardsAssignmentsCreateResponseBody.updatedAt) &&
        Objects.equals(this._object, rewardsAssignmentsCreateResponseBody._object) &&
        Objects.equals(this.relatedObjectId, rewardsAssignmentsCreateResponseBody.relatedObjectId) &&
        Objects.equals(this.relatedObjectType, rewardsAssignmentsCreateResponseBody.relatedObjectType) &&
        Objects.equals(this.parameters, rewardsAssignmentsCreateResponseBody.parameters);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RewardsAssignmentsCreateResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RewardsAssignmentsCreateResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RewardsAssignmentsCreateResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RewardsAssignmentsCreateResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<RewardsAssignmentsCreateResponseBody>() {
           @Override
           public void write(JsonWriter out, RewardsAssignmentsCreateResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RewardsAssignmentsCreateResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RewardsAssignmentsCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RewardsAssignmentsCreateResponseBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RewardsAssignmentsCreateResponseBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RewardsAssignmentsCreateResponseBody
  * @throws IOException if the JSON string is invalid with respect to RewardsAssignmentsCreateResponseBody
  */
  public static RewardsAssignmentsCreateResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RewardsAssignmentsCreateResponseBody.class);
  }

 /**
  * Convert an instance of RewardsAssignmentsCreateResponseBody to an JSON string
  *
  * @return JSON string
  */
