...
import io.voucherify.client.model.ClientValidationsValidateResponseBodyOrderItemsItem;
...
public class ClientValidationsValidateResponseBodyOrder {
  ...
  private List<ClientValidationsValidateResponseBodyOrderItemsItem> items;
    private boolean itemsIsSet = false;

  public ClientValidationsValidateResponseBodyOrder() {
  }

  public ClientValidationsValidateResponseBodyOrder id(String id) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder status(StatusEnum status) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder amount(Integer amount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder metadata(Object metadata) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder customerId(String customerId) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder customer(CustomerId customer) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder referrer(ReferrerId referrer) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public ClientValidationsValidateResponseBodyOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrder items(List<ClientValidationsValidateResponseBodyOrderItemsItem> items) {
    
    this.items = items;
    return this;
  }

  public ClientValidationsValidateResponseBodyOrder addItemsItem(ClientValidationsValidateResponseBodyOrderItemsItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<ClientValidationsValidateResponseBodyOrderItemsItem> getItems() {
    return items;
  }


  public void setItems(List<ClientValidationsValidateResponseBodyOrderItemsItem> items) {
    this.items = items;
  ...
  public boolean equals(Object o) {
    ...
    ClientValidationsValidateResponseBodyOrder clientValidationsValidateResponseBodyOrder = (ClientValidationsValidateResponseBodyOrder) o;
    return Objects.equals(this.id, clientValidationsValidateResponseBodyOrder.id) &&
        Objects.equals(this.sourceId, clientValidationsValidateResponseBodyOrder.sourceId) &&
        Objects.equals(this.status, clientValidationsValidateResponseBodyOrder.status) &&
        Objects.equals(this.amount, clientValidationsValidateResponseBodyOrder.amount) &&
        Objects.equals(this.initialAmount, clientValidationsValidateResponseBodyOrder.initialAmount) &&
        Objects.equals(this.discountAmount, clientValidationsValidateResponseBodyOrder.discountAmount) &&
        Objects.equals(this.itemsDiscountAmount, clientValidationsValidateResponseBodyOrder.itemsDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, clientValidationsValidateResponseBodyOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAmount, clientValidationsValidateResponseBodyOrder.totalAmount) &&
        Objects.equals(this.appliedDiscountAmount, clientValidationsValidateResponseBodyOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, clientValidationsValidateResponseBodyOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, clientValidationsValidateResponseBodyOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.metadata, clientValidationsValidateResponseBodyOrder.metadata) &&
        Objects.equals(this._object, clientValidationsValidateResponseBodyOrder._object) &&
        Objects.equals(this.createdAt, clientValidationsValidateResponseBodyOrder.createdAt) &&
        Objects.equals(this.updatedAt, clientValidationsValidateResponseBodyOrder.updatedAt) &&
        Objects.equals(this.customerId, clientValidationsValidateResponseBodyOrder.customerId) &&
        Objects.equals(this.referrerId, clientValidationsValidateResponseBodyOrder.referrerId) &&
        Objects.equals(this.customer, clientValidationsValidateResponseBodyOrder.customer) &&
        Objects.equals(this.referrer, clientValidationsValidateResponseBodyOrder.referrer) &&
        Objects.equals(this.redemptions, clientValidationsValidateResponseBodyOrder.redemptions) &&
        Objects.equals(this.items, clientValidationsValidateResponseBodyOrder.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClientValidationsValidateResponseBodyOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClientValidationsValidateResponseBodyOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClientValidationsValidateResponseBodyOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClientValidationsValidateResponseBodyOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClientValidationsValidateResponseBodyOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<ClientValidationsValidateResponseBodyOrder>() {
           @Override
           public void write(JsonWriter out, ClientValidationsValidateResponseBodyOrder value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ClientValidationsValidateResponseBodyOrder.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ClientValidationsValidateResponseBodyOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ClientValidationsValidateResponseBodyOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ClientValidationsValidateResponseBodyOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ClientValidationsValidateResponseBodyOrder
  * @throws IOException if the JSON string is invalid with respect to ClientValidationsValidateResponseBodyOrder
  */
  public static ClientValidationsValidateResponseBodyOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClientValidationsValidateResponseBodyOrder.class);
  }

 /**
  * Convert an instance of ClientValidationsValidateResponseBodyOrder to an JSON string
  *
  * @return JSON string
  */
