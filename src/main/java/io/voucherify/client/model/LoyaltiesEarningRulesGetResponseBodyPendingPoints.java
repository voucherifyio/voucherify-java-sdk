       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesEarningRulesGetResponseBodyPendingPoints>() {
           ...
           public void write(JsonWriter out, LoyaltiesEarningRulesGetResponseBodyPendingPoints value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : LoyaltiesEarningRulesGetResponseBodyPendingPoints.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = LoyaltiesEarningRulesGetResponseBodyPendingPoints.class.getDeclaredField(fieldName + "IsSet");
