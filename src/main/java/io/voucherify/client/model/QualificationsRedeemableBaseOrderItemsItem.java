       ...
       return (TypeAdapter<T>) new TypeAdapter<QualificationsRedeemableBaseOrderItemsItem>() {
           ...
           public void write(JsonWriter out, QualificationsRedeemableBaseOrderItemsItem value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : QualificationsRedeemableBaseOrderItemsItem.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = QualificationsRedeemableBaseOrderItemsItem.class.getDeclaredField(fieldName + "IsSet");
