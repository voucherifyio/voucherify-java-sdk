...
public class MemberActivityDataRedemptionVoucherLoyaltyCard {
  ...
  public MemberActivityDataRedemptionVoucherLoyaltyCard() {
  }

  public MemberActivityDataRedemptionVoucherLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionVoucherLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionVoucherLoyaltyCard nextExpirationDate(String nextExpirationDate) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionVoucherLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionVoucherLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionVoucherLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionVoucherLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MemberActivityDataRedemptionVoucherLoyaltyCard memberActivityDataRedemptionVoucherLoyaltyCard = (MemberActivityDataRedemptionVoucherLoyaltyCard) o;
    return Objects.equals(this.points, memberActivityDataRedemptionVoucherLoyaltyCard.points) &&
        Objects.equals(this.balance, memberActivityDataRedemptionVoucherLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, memberActivityDataRedemptionVoucherLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, memberActivityDataRedemptionVoucherLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, memberActivityDataRedemptionVoucherLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, memberActivityDataRedemptionVoucherLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, memberActivityDataRedemptionVoucherLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class MemberActivityDataRedemptionVoucherLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberActivityDataRedemptionVoucherLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberActivityDataRedemptionVoucherLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberActivityDataRedemptionVoucherLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberActivityDataRedemptionVoucherLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberActivityDataRedemptionVoucherLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, MemberActivityDataRedemptionVoucherLoyaltyCard value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : MemberActivityDataRedemptionVoucherLoyaltyCard.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = MemberActivityDataRedemptionVoucherLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public MemberActivityDataRedemptionVoucherLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MemberActivityDataRedemptionVoucherLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberActivityDataRedemptionVoucherLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to MemberActivityDataRedemptionVoucherLoyaltyCard
  */
  public static MemberActivityDataRedemptionVoucherLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberActivityDataRedemptionVoucherLoyaltyCard.class);
  }

 /**
  * Convert an instance of MemberActivityDataRedemptionVoucherLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
