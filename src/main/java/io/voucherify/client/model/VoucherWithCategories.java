...
public class VoucherWithCategories {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, code, campaign, campaignId, category, categoryId, type, discount, gift, loyaltyCard, startDate, expirationDate, validityTimeframe, validityDayOfWeek, validityHours, active, additionalInfo, metadata, assets, isReferralCode, createdAt, updatedAt, holderId, referrerId, _object, publish, redemption, categories);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VoucherWithCategories>() {
           ...
           public void write(JsonWriter out, VoucherWithCategories value) throws IOException {
            ...
            for (Field field : VoucherWithCategories.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = VoucherWithCategories.class.getDeclaredField(fieldName + "IsSet");
