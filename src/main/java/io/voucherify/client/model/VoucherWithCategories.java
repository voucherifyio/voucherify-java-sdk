...
import io.voucherify.client.model.VoucherWithCategoriesGift;
import io.voucherify.client.model.VoucherWithCategoriesLoyaltyCard;
import io.voucherify.client.model.VoucherWithCategoriesPublish;
import io.voucherify.client.model.VoucherWithCategoriesRedemption;
...
public class VoucherWithCategories {
  ...
  private VoucherWithCategoriesPublish publish;

  public static final String SERIALIZED_NAME_REDEMPTION = "redemption";
  @SerializedName(SERIALIZED_NAME_REDEMPTION)
  private VoucherWithCategoriesRedemption redemption;

  public static final String SERIALIZED_NAME_CATEGORIES = "categories";
  @SerializedName(SERIALIZED_NAME_CATEGORIES)
  private List<Category> categories;

  public VoucherWithCategories() {
  }
  ...
  **/
  @javax.annotation.Nullable
  public VoucherWithCategoriesGift getGift() {
    return gift;
  }


  public void setGift(VoucherWithCategoriesGift gift) {
    this.gift = gift;
  }
  ...
  **/
  @javax.annotation.Nullable
  public VoucherWithCategoriesLoyaltyCard getLoyaltyCard() {
    return loyaltyCard;
  }


  public void setLoyaltyCard(VoucherWithCategoriesLoyaltyCard loyaltyCard) {
    this.loyaltyCard = loyaltyCard;
  }
  ...
  **/
  ...
  public VoucherWithCategories addValidityDayOfWeekItem(ValidityDayOfWeekEnum validityDayOfWeekItem) {
  ...
  **/
  @javax.annotation.Nullable
  public VoucherWithCategoriesPublish getPublish() {
    return publish;
  }


  public void setPublish(VoucherWithCategoriesPublish publish) {
    this.publish = publish;
  }
  ...
  **/
  @javax.annotation.Nullable
  public VoucherWithCategoriesRedemption getRedemption() {
    return redemption;
  }


  public void setRedemption(VoucherWithCategoriesRedemption redemption) {
    this.redemption = redemption;
  }
  ...
  public VoucherWithCategories addCategoriesItem(Category categoriesItem) {
  ...
  **/
   ...
   * @return the VoucherWithCategories instance itself
   */
  public VoucherWithCategories putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VoucherWithCategories voucherWithCategories = (VoucherWithCategories) o;
    return Objects.equals(this.id, voucherWithCategories.id) &&
        Objects.equals(this.code, voucherWithCategories.code) &&
        Objects.equals(this.campaign, voucherWithCategories.campaign) &&
        Objects.equals(this.campaignId, voucherWithCategories.campaignId) &&
        Objects.equals(this.category, voucherWithCategories.category) &&
        Objects.equals(this.categoryId, voucherWithCategories.categoryId) &&
        Objects.equals(this.type, voucherWithCategories.type) &&
        Objects.equals(this.discount, voucherWithCategories.discount) &&
        Objects.equals(this.gift, voucherWithCategories.gift) &&
        Objects.equals(this.loyaltyCard, voucherWithCategories.loyaltyCard) &&
        Objects.equals(this.startDate, voucherWithCategories.startDate) &&
        Objects.equals(this.expirationDate, voucherWithCategories.expirationDate) &&
        Objects.equals(this.validityTimeframe, voucherWithCategories.validityTimeframe) &&
        Objects.equals(this.validityDayOfWeek, voucherWithCategories.validityDayOfWeek) &&
        Objects.equals(this.validityHours, voucherWithCategories.validityHours) &&
        Objects.equals(this.active, voucherWithCategories.active) &&
        Objects.equals(this.additionalInfo, voucherWithCategories.additionalInfo) &&
        Objects.equals(this.metadata, voucherWithCategories.metadata) &&
        Objects.equals(this.assets, voucherWithCategories.assets) &&
        Objects.equals(this.isReferralCode, voucherWithCategories.isReferralCode) &&
        Objects.equals(this.createdAt, voucherWithCategories.createdAt) &&
        Objects.equals(this.updatedAt, voucherWithCategories.updatedAt) &&
        Objects.equals(this.holderId, voucherWithCategories.holderId) &&
        Objects.equals(this.referrerId, voucherWithCategories.referrerId) &&
        Objects.equals(this._object, voucherWithCategories._object) &&
        Objects.equals(this.publish, voucherWithCategories.publish) &&
        Objects.equals(this.redemption, voucherWithCategories.redemption) &&
        Objects.equals(this.categories, voucherWithCategories.categories)&&
        Objects.equals(this.additionalProperties, voucherWithCategories.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, code, campaign, campaignId, category, categoryId, type, discount, gift, loyaltyCard, startDate, expirationDate, validityTimeframe, validityDayOfWeek, validityHours, active, additionalInfo, metadata, assets, isReferralCode, createdAt, updatedAt, holderId, referrerId, _object, publish, redemption, categories, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VoucherWithCategories {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VoucherWithCategories.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VoucherWithCategories' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VoucherWithCategories> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VoucherWithCategories.class));

       return (TypeAdapter<T>) new TypeAdapter<VoucherWithCategories>() {
           @Override
           public void write(JsonWriter out, VoucherWithCategories value) throws IOException {
           ...
           @Override
           public VoucherWithCategories read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             VoucherWithCategories instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VoucherWithCategories given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VoucherWithCategories
  * @throws IOException if the JSON string is invalid with respect to VoucherWithCategories
  */
  public static VoucherWithCategories fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VoucherWithCategories.class);
  }

 /**
  * Convert an instance of VoucherWithCategories to an JSON string
  *
  * @return JSON string
  */
