       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesMembersBalanceUpdateResponseBodyRelatedObject>() {
           ...
           public void write(JsonWriter out, LoyaltiesMembersBalanceUpdateResponseBodyRelatedObject value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : LoyaltiesMembersBalanceUpdateResponseBodyRelatedObject.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = LoyaltiesMembersBalanceUpdateResponseBodyRelatedObject.class.getDeclaredField(fieldName + "IsSet");
