    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignsVouchersCreateResponseBody>() {
           ...
           public void write(JsonWriter out, CampaignsVouchersCreateResponseBody value) throws IOException {
            ...
            for (Field field : CampaignsVouchersCreateResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = CampaignsVouchersCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
