...
public class CustomersCreateResponseBodyAssets {
  ...
  **/
  ...
  public CustomersCreateResponseBodyAssets cockpitPreferenceCenterUrl(String cockpitPreferenceCenterUrl) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomersCreateResponseBodyAssets customersCreateResponseBodyAssets = (CustomersCreateResponseBodyAssets) o;
    return Objects.equals(this.cockpitUrl, customersCreateResponseBodyAssets.cockpitUrl) &&
        Objects.equals(this.cockpitPreferenceCenterUrl, customersCreateResponseBodyAssets.cockpitPreferenceCenterUrl);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomersCreateResponseBodyAssets.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomersCreateResponseBodyAssets' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomersCreateResponseBodyAssets> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomersCreateResponseBodyAssets.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomersCreateResponseBodyAssets>() {
           @Override
           public void write(JsonWriter out, CustomersCreateResponseBodyAssets value) throws IOException {
            ...
            for (Field field : CustomersCreateResponseBodyAssets.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = CustomersCreateResponseBodyAssets.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public CustomersCreateResponseBodyAssets read(JsonReader in) throws IOException {
  ...
  * @return An instance of CustomersCreateResponseBodyAssets
  * @throws IOException if the JSON string is invalid with respect to CustomersCreateResponseBodyAssets
  */
  public static CustomersCreateResponseBodyAssets fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomersCreateResponseBodyAssets.class);
  }
