       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionEntryPromotionTierSummary>() {
           ...
           public void write(JsonWriter out, RedemptionEntryPromotionTierSummary value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionEntryPromotionTierSummary.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionEntryPromotionTierSummary.class.getDeclaredField(fieldName + "IsSet");
