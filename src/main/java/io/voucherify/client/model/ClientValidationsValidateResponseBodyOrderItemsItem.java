...
public class ClientValidationsValidateResponseBodyOrderItemsItem {
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem() {
  }

  public ClientValidationsValidateResponseBodyOrderItemsItem id(String id) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem skuId(String skuId) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem productId(String productId) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem relatedObject(RelatedObjectEnum relatedObject) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem sourceId(String sourceId) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem quantity(Integer quantity) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem discountQuantity(Integer discountQuantity) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem initialQuantity(Integer initialQuantity) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem amount(Integer amount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem appliedDiscountQuantity(Integer appliedDiscountQuantity) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem appliedQuantity(Integer appliedQuantity) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem appliedQuantityAmount(Integer appliedQuantityAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem price(Integer price) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem subtotalAmount(Integer subtotalAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem product(OrderCalculatedItemProduct product) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem sku(OrderCalculatedItemSku sku) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem _object(ObjectEnum _object) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem metadata(Object metadata) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyOrderItemsItem applicationDetails(List<ApplicationDetailsItem> applicationDetails) {
    
    this.applicationDetails = applicationDetails;
    return this;
  }

  public ClientValidationsValidateResponseBodyOrderItemsItem addApplicationDetailsItem(ApplicationDetailsItem applicationDetailsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ClientValidationsValidateResponseBodyOrderItemsItem clientValidationsValidateResponseBodyOrderItemsItem = (ClientValidationsValidateResponseBodyOrderItemsItem) o;
    return Objects.equals(this.id, clientValidationsValidateResponseBodyOrderItemsItem.id) &&
        Objects.equals(this.skuId, clientValidationsValidateResponseBodyOrderItemsItem.skuId) &&
        Objects.equals(this.productId, clientValidationsValidateResponseBodyOrderItemsItem.productId) &&
        Objects.equals(this.relatedObject, clientValidationsValidateResponseBodyOrderItemsItem.relatedObject) &&
        Objects.equals(this.sourceId, clientValidationsValidateResponseBodyOrderItemsItem.sourceId) &&
        Objects.equals(this.quantity, clientValidationsValidateResponseBodyOrderItemsItem.quantity) &&
        Objects.equals(this.discountQuantity, clientValidationsValidateResponseBodyOrderItemsItem.discountQuantity) &&
        Objects.equals(this.initialQuantity, clientValidationsValidateResponseBodyOrderItemsItem.initialQuantity) &&
        Objects.equals(this.amount, clientValidationsValidateResponseBodyOrderItemsItem.amount) &&
        Objects.equals(this.discountAmount, clientValidationsValidateResponseBodyOrderItemsItem.discountAmount) &&
        Objects.equals(this.appliedDiscountAmount, clientValidationsValidateResponseBodyOrderItemsItem.appliedDiscountAmount) &&
        Objects.equals(this.appliedDiscountQuantity, clientValidationsValidateResponseBodyOrderItemsItem.appliedDiscountQuantity) &&
        Objects.equals(this.appliedQuantity, clientValidationsValidateResponseBodyOrderItemsItem.appliedQuantity) &&
        Objects.equals(this.appliedQuantityAmount, clientValidationsValidateResponseBodyOrderItemsItem.appliedQuantityAmount) &&
        Objects.equals(this.initialAmount, clientValidationsValidateResponseBodyOrderItemsItem.initialAmount) &&
        Objects.equals(this.price, clientValidationsValidateResponseBodyOrderItemsItem.price) &&
        Objects.equals(this.subtotalAmount, clientValidationsValidateResponseBodyOrderItemsItem.subtotalAmount) &&
        Objects.equals(this.product, clientValidationsValidateResponseBodyOrderItemsItem.product) &&
        Objects.equals(this.sku, clientValidationsValidateResponseBodyOrderItemsItem.sku) &&
        Objects.equals(this._object, clientValidationsValidateResponseBodyOrderItemsItem._object) &&
        Objects.equals(this.metadata, clientValidationsValidateResponseBodyOrderItemsItem.metadata) &&
        Objects.equals(this.applicationDetails, clientValidationsValidateResponseBodyOrderItemsItem.applicationDetails);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClientValidationsValidateResponseBodyOrderItemsItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClientValidationsValidateResponseBodyOrderItemsItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClientValidationsValidateResponseBodyOrderItemsItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClientValidationsValidateResponseBodyOrderItemsItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ClientValidationsValidateResponseBodyOrderItemsItem>() {
           @Override
           public void write(JsonWriter out, ClientValidationsValidateResponseBodyOrderItemsItem value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ClientValidationsValidateResponseBodyOrderItemsItem.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ClientValidationsValidateResponseBodyOrderItemsItem.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ClientValidationsValidateResponseBodyOrderItemsItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ClientValidationsValidateResponseBodyOrderItemsItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ClientValidationsValidateResponseBodyOrderItemsItem
  * @throws IOException if the JSON string is invalid with respect to ClientValidationsValidateResponseBodyOrderItemsItem
  */
  public static ClientValidationsValidateResponseBodyOrderItemsItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClientValidationsValidateResponseBodyOrderItemsItem.class);
  }

 /**
  * Convert an instance of ClientValidationsValidateResponseBodyOrderItemsItem to an JSON string
  *
  * @return JSON string
  */
