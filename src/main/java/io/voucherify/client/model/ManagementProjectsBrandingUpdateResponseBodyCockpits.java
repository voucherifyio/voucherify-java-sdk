...
public class ManagementProjectsBrandingUpdateResponseBodyCockpits {
  ...
  public ManagementProjectsBrandingUpdateResponseBodyCockpits() {
  }

  public ManagementProjectsBrandingUpdateResponseBodyCockpits campaignsOverviewEnabled(Boolean campaignsOverviewEnabled) {
  ...
  **/
  ...
  public ManagementProjectsBrandingUpdateResponseBodyCockpits loyaltyEnabled(Boolean loyaltyEnabled) {
  ...
  **/
  ...
  public ManagementProjectsBrandingUpdateResponseBodyCockpits giftCardsEnabled(Boolean giftCardsEnabled) {
  ...
  **/
  ...
  public ManagementProjectsBrandingUpdateResponseBodyCockpits couponsEnabled(Boolean couponsEnabled) {
  ...
  **/
  ...
  public ManagementProjectsBrandingUpdateResponseBodyCockpits referralsEnabled(Boolean referralsEnabled) {
  ...
  **/
  ...
  public ManagementProjectsBrandingUpdateResponseBodyCockpits theme(ThemeEnum theme) {
  ...
  **/
  ...
  public ManagementProjectsBrandingUpdateResponseBodyCockpits useCustomDoubleOptInRedirectUrl(Boolean useCustomDoubleOptInRedirectUrl) {
  ...
  **/
  ...
  public ManagementProjectsBrandingUpdateResponseBodyCockpits customDoubleOptInRedirectUrl(String customDoubleOptInRedirectUrl) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsBrandingUpdateResponseBodyCockpits managementProjectsBrandingUpdateResponseBodyCockpits = (ManagementProjectsBrandingUpdateResponseBodyCockpits) o;
    return Objects.equals(this.campaignsOverviewEnabled, managementProjectsBrandingUpdateResponseBodyCockpits.campaignsOverviewEnabled) &&
        Objects.equals(this.loyaltyEnabled, managementProjectsBrandingUpdateResponseBodyCockpits.loyaltyEnabled) &&
        Objects.equals(this.giftCardsEnabled, managementProjectsBrandingUpdateResponseBodyCockpits.giftCardsEnabled) &&
        Objects.equals(this.couponsEnabled, managementProjectsBrandingUpdateResponseBodyCockpits.couponsEnabled) &&
        Objects.equals(this.referralsEnabled, managementProjectsBrandingUpdateResponseBodyCockpits.referralsEnabled) &&
        Objects.equals(this.theme, managementProjectsBrandingUpdateResponseBodyCockpits.theme) &&
        Objects.equals(this.useCustomDoubleOptInRedirectUrl, managementProjectsBrandingUpdateResponseBodyCockpits.useCustomDoubleOptInRedirectUrl) &&
        Objects.equals(this.customDoubleOptInRedirectUrl, managementProjectsBrandingUpdateResponseBodyCockpits.customDoubleOptInRedirectUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagementProjectsBrandingUpdateResponseBodyCockpits {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsBrandingUpdateResponseBodyCockpits.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsBrandingUpdateResponseBodyCockpits' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsBrandingUpdateResponseBodyCockpits> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsBrandingUpdateResponseBodyCockpits.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsBrandingUpdateResponseBodyCockpits>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsBrandingUpdateResponseBodyCockpits value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ManagementProjectsBrandingUpdateResponseBodyCockpits.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ManagementProjectsBrandingUpdateResponseBodyCockpits.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ManagementProjectsBrandingUpdateResponseBodyCockpits read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagementProjectsBrandingUpdateResponseBodyCockpits given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagementProjectsBrandingUpdateResponseBodyCockpits
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsBrandingUpdateResponseBodyCockpits
  */
  public static ManagementProjectsBrandingUpdateResponseBodyCockpits fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsBrandingUpdateResponseBodyCockpits.class);
  }

 /**
  * Convert an instance of ManagementProjectsBrandingUpdateResponseBodyCockpits to an JSON string
  *
  * @return JSON string
  */
