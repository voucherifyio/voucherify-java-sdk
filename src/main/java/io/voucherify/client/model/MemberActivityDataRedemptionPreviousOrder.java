...
import io.voucherify.client.model.MemberActivityDataRedemptionPreviousOrderCustomer;
import io.voucherify.client.model.MemberActivityDataRedemptionPreviousOrderReferrer;
...
public class MemberActivityDataRedemptionPreviousOrder {
  ...
  private MemberActivityDataRedemptionPreviousOrderCustomer customer;
  ...
  private MemberActivityDataRedemptionPreviousOrderReferrer referrer;
  ...
  public MemberActivityDataRedemptionPreviousOrder() {
  }

  public MemberActivityDataRedemptionPreviousOrder id(String id) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder status(StatusEnum status) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder amount(Integer amount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder metadata(Object metadata) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder customerId(String customerId) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder customer(MemberActivityDataRedemptionPreviousOrderCustomer customer) {
  ...
  **/
  @javax.annotation.Nullable
  public MemberActivityDataRedemptionPreviousOrderCustomer getCustomer() {
    return customer;
  }


  public void setCustomer(MemberActivityDataRedemptionPreviousOrderCustomer customer) {
    this.customer = customer;
  ...
  public MemberActivityDataRedemptionPreviousOrder referrer(MemberActivityDataRedemptionPreviousOrderReferrer referrer) {
  ...
  **/
  @javax.annotation.Nullable
  public MemberActivityDataRedemptionPreviousOrderReferrer getReferrer() {
    return referrer;
  }


  public void setReferrer(MemberActivityDataRedemptionPreviousOrderReferrer referrer) {
    this.referrer = referrer;
  ...
  public MemberActivityDataRedemptionPreviousOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public MemberActivityDataRedemptionPreviousOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionPreviousOrder items(List<OrderCalculatedItem> items) {
    
    this.items = items;
    return this;
  }

  public MemberActivityDataRedemptionPreviousOrder addItemsItem(OrderCalculatedItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MemberActivityDataRedemptionPreviousOrder memberActivityDataRedemptionPreviousOrder = (MemberActivityDataRedemptionPreviousOrder) o;
    return Objects.equals(this.id, memberActivityDataRedemptionPreviousOrder.id) &&
        Objects.equals(this.sourceId, memberActivityDataRedemptionPreviousOrder.sourceId) &&
        Objects.equals(this.status, memberActivityDataRedemptionPreviousOrder.status) &&
        Objects.equals(this.amount, memberActivityDataRedemptionPreviousOrder.amount) &&
        Objects.equals(this.initialAmount, memberActivityDataRedemptionPreviousOrder.initialAmount) &&
        Objects.equals(this.discountAmount, memberActivityDataRedemptionPreviousOrder.discountAmount) &&
        Objects.equals(this.itemsDiscountAmount, memberActivityDataRedemptionPreviousOrder.itemsDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, memberActivityDataRedemptionPreviousOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAmount, memberActivityDataRedemptionPreviousOrder.totalAmount) &&
        Objects.equals(this.appliedDiscountAmount, memberActivityDataRedemptionPreviousOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, memberActivityDataRedemptionPreviousOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, memberActivityDataRedemptionPreviousOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.metadata, memberActivityDataRedemptionPreviousOrder.metadata) &&
        Objects.equals(this._object, memberActivityDataRedemptionPreviousOrder._object) &&
        Objects.equals(this.createdAt, memberActivityDataRedemptionPreviousOrder.createdAt) &&
        Objects.equals(this.updatedAt, memberActivityDataRedemptionPreviousOrder.updatedAt) &&
        Objects.equals(this.customerId, memberActivityDataRedemptionPreviousOrder.customerId) &&
        Objects.equals(this.referrerId, memberActivityDataRedemptionPreviousOrder.referrerId) &&
        Objects.equals(this.customer, memberActivityDataRedemptionPreviousOrder.customer) &&
        Objects.equals(this.referrer, memberActivityDataRedemptionPreviousOrder.referrer) &&
        Objects.equals(this.redemptions, memberActivityDataRedemptionPreviousOrder.redemptions) &&
        Objects.equals(this.items, memberActivityDataRedemptionPreviousOrder.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class MemberActivityDataRedemptionPreviousOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberActivityDataRedemptionPreviousOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberActivityDataRedemptionPreviousOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberActivityDataRedemptionPreviousOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberActivityDataRedemptionPreviousOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberActivityDataRedemptionPreviousOrder>() {
           @Override
           public void write(JsonWriter out, MemberActivityDataRedemptionPreviousOrder value) throws IOException {
            ...
            for (Field field : MemberActivityDataRedemptionPreviousOrder.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = MemberActivityDataRedemptionPreviousOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public MemberActivityDataRedemptionPreviousOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MemberActivityDataRedemptionPreviousOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberActivityDataRedemptionPreviousOrder
  * @throws IOException if the JSON string is invalid with respect to MemberActivityDataRedemptionPreviousOrder
  */
  public static MemberActivityDataRedemptionPreviousOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberActivityDataRedemptionPreviousOrder.class);
  }

 /**
  * Convert an instance of MemberActivityDataRedemptionPreviousOrder to an JSON string
  *
  * @return JSON string
  */
