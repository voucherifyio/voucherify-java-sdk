       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignsCreateResponseBody>() {
           ...
           public void write(JsonWriter out, CampaignsCreateResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : CampaignsCreateResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = CampaignsCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
