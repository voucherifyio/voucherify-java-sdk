    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionsRollbackCreateRequestBody>() {
           ...
           public void write(JsonWriter out, RedemptionsRollbackCreateRequestBody value) throws IOException {
            ...
            for (Field field : RedemptionsRollbackCreateRequestBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionsRollbackCreateRequestBody.class.getDeclaredField(fieldName + "IsSet");
