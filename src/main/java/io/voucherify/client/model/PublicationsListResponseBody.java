    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PublicationsListResponseBody>() {
           ...
           public void write(JsonWriter out, PublicationsListResponseBody value) throws IOException {
            ...
            for (Field field : PublicationsListResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = PublicationsListResponseBody.class.getDeclaredField(fieldName + "IsSet");
