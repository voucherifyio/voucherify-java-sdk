...
import io.voucherify.client.model.CampaignTemplate;
...
public class ManagementProjectsTemplatesCampaignsListResponseBody {
  ...
  private List<CampaignTemplate> data;
  ...
  public ManagementProjectsTemplatesCampaignsListResponseBody _object(ObjectEnum _object) {
  ...
  **/
  ...
  public ManagementProjectsTemplatesCampaignsListResponseBody dataRef(DataRefEnum dataRef) {
  ...
  **/
  ...
  public ManagementProjectsTemplatesCampaignsListResponseBody data(List<CampaignTemplate> data) {
    
    this.data = data;
    return this;
  }

  public ManagementProjectsTemplatesCampaignsListResponseBody addDataItem(CampaignTemplate dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public ManagementProjectsTemplatesCampaignsListResponseBody total(Integer total) {
  ...
  **/
  ...
  public ManagementProjectsTemplatesCampaignsListResponseBody hasMore(Boolean hasMore) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsTemplatesCampaignsListResponseBody managementProjectsTemplatesCampaignsListResponseBody = (ManagementProjectsTemplatesCampaignsListResponseBody) o;
    return Objects.equals(this._object, managementProjectsTemplatesCampaignsListResponseBody._object) &&
        Objects.equals(this.dataRef, managementProjectsTemplatesCampaignsListResponseBody.dataRef) &&
        Objects.equals(this.data, managementProjectsTemplatesCampaignsListResponseBody.data) &&
        Objects.equals(this.total, managementProjectsTemplatesCampaignsListResponseBody.total) &&
        Objects.equals(this.hasMore, managementProjectsTemplatesCampaignsListResponseBody.hasMore) &&
        Objects.equals(this.moreStartingAfter, managementProjectsTemplatesCampaignsListResponseBody.moreStartingAfter);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagementProjectsTemplatesCampaignsListResponseBody {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsTemplatesCampaignsListResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsTemplatesCampaignsListResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsTemplatesCampaignsListResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsTemplatesCampaignsListResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsTemplatesCampaignsListResponseBody>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsTemplatesCampaignsListResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ManagementProjectsTemplatesCampaignsListResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ManagementProjectsTemplatesCampaignsListResponseBody.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ManagementProjectsTemplatesCampaignsListResponseBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagementProjectsTemplatesCampaignsListResponseBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagementProjectsTemplatesCampaignsListResponseBody
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsTemplatesCampaignsListResponseBody
  */
  public static ManagementProjectsTemplatesCampaignsListResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsTemplatesCampaignsListResponseBody.class);
  }

 /**
  * Convert an instance of ManagementProjectsTemplatesCampaignsListResponseBody to an JSON string
  *
  * @return JSON string
  */
