       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductsMetadataUpdateInBulkResponseBody>() {
           ...
           public void write(JsonWriter out, ProductsMetadataUpdateInBulkResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ProductsMetadataUpdateInBulkResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ProductsMetadataUpdateInBulkResponseBody.class.getDeclaredField(fieldName + "IsSet");
