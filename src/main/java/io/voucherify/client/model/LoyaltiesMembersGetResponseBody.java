    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesMembersGetResponseBody>() {
           ...
           public void write(JsonWriter out, LoyaltiesMembersGetResponseBody value) throws IOException {
            ...
            for (Field field : LoyaltiesMembersGetResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltiesMembersGetResponseBody.class.getDeclaredField(fieldName + "IsSet");
