    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VoucherTransactionsExportFilterConditionsVoucherIdConditions>() {
           ...
           public void write(JsonWriter out, VoucherTransactionsExportFilterConditionsVoucherIdConditions value) throws IOException {
            ...
            for (Field field : VoucherTransactionsExportFilterConditionsVoucherIdConditions.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = VoucherTransactionsExportFilterConditionsVoucherIdConditions.class.getDeclaredField(fieldName + "IsSet");
