    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidationsValidateResponseBodyRedeemablesItemResultDiscountProduct>() {
           ...
           public void write(JsonWriter out, ValidationsValidateResponseBodyRedeemablesItemResultDiscountProduct value) throws IOException {
            ...
            for (Field field : ValidationsValidateResponseBodyRedeemablesItemResultDiscountProduct.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ValidationsValidateResponseBodyRedeemablesItemResultDiscountProduct.class.getDeclaredField(fieldName + "IsSet");
