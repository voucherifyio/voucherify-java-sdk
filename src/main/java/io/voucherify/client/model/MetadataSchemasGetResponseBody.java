    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MetadataSchemasGetResponseBody>() {
           ...
           public void write(JsonWriter out, MetadataSchemasGetResponseBody value) throws IOException {
            ...
            for (Field field : MetadataSchemasGetResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = MetadataSchemasGetResponseBody.class.getDeclaredField(fieldName + "IsSet");
