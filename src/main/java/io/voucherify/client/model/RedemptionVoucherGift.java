...
public class RedemptionVoucherGift {
  ...
  public RedemptionVoucherGift() {
  }

  public RedemptionVoucherGift amount(Integer amount) {
  ...
  **/
  ...
  public RedemptionVoucherGift subtractedAmount(Integer subtractedAmount) {
  ...
  **/
  ...
  public RedemptionVoucherGift balance(Integer balance) {
  ...
  **/
  ...
  public RedemptionVoucherGift effect(EffectEnum effect) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RedemptionVoucherGift redemptionVoucherGift = (RedemptionVoucherGift) o;
    return Objects.equals(this.amount, redemptionVoucherGift.amount) &&
        Objects.equals(this.subtractedAmount, redemptionVoucherGift.subtractedAmount) &&
        Objects.equals(this.balance, redemptionVoucherGift.balance) &&
        Objects.equals(this.effect, redemptionVoucherGift.effect);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionVoucherGift {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionVoucherGift.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionVoucherGift' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionVoucherGift> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionVoucherGift.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionVoucherGift>() {
           @Override
           public void write(JsonWriter out, RedemptionVoucherGift value) throws IOException {
            ...
            for (Field field : RedemptionVoucherGift.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionVoucherGift.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionVoucherGift read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedemptionVoucherGift given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionVoucherGift
  * @throws IOException if the JSON string is invalid with respect to RedemptionVoucherGift
  */
  public static RedemptionVoucherGift fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionVoucherGift.class);
  }

 /**
  * Convert an instance of RedemptionVoucherGift to an JSON string
  *
  * @return JSON string
  */
