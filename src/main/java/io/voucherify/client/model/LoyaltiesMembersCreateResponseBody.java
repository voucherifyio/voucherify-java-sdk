...
public class LoyaltiesMembersCreateResponseBody {
  ...
  private Object discount;
    private boolean discountIsSet = false;
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, code, campaign, campaignId, category, categoryId, type, discount, gift, loyaltyCard, startDate, expirationDate, validityTimeframe, validityDayOfWeek, validityHours, active, additionalInfo, metadata, assets, isReferralCode, createdAt, updatedAt, holderId, _object, publish, redemption);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesMembersCreateResponseBody>() {
           ...
           public void write(JsonWriter out, LoyaltiesMembersCreateResponseBody value) throws IOException {
            ...
            for (Field field : LoyaltiesMembersCreateResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltiesMembersCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
