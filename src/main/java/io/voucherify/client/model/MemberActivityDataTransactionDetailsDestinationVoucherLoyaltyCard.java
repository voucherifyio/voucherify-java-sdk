    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MemberActivityDataTransactionDetailsDestinationVoucherLoyaltyCard>() {
           ...
           public void write(JsonWriter out, MemberActivityDataTransactionDetailsDestinationVoucherLoyaltyCard value) throws IOException {
            ...
            for (Field field : MemberActivityDataTransactionDetailsDestinationVoucherLoyaltyCard.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = MemberActivityDataTransactionDetailsDestinationVoucherLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
