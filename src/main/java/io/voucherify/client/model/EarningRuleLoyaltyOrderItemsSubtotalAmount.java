    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EarningRuleLoyaltyOrderItemsSubtotalAmount>() {
           ...
           public void write(JsonWriter out, EarningRuleLoyaltyOrderItemsSubtotalAmount value) throws IOException {
            ...
            for (Field field : EarningRuleLoyaltyOrderItemsSubtotalAmount.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = EarningRuleLoyaltyOrderItemsSubtotalAmount.class.getDeclaredField(fieldName + "IsSet");
