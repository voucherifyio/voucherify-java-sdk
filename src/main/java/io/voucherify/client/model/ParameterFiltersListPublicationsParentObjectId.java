    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListPublicationsParentObjectId>() {
           ...
           public void write(JsonWriter out, ParameterFiltersListPublicationsParentObjectId value) throws IOException {
            ...
            for (Field field : ParameterFiltersListPublicationsParentObjectId.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ParameterFiltersListPublicationsParentObjectId.class.getDeclaredField(fieldName + "IsSet");
