       ...
       return (TypeAdapter<T>) new TypeAdapter<PromotionsStacksListResponseBody>() {
           ...
           public void write(JsonWriter out, PromotionsStacksListResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : PromotionsStacksListResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = PromotionsStacksListResponseBody.class.getDeclaredField(fieldName + "IsSet");
