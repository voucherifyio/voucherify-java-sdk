    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionRelatedRedemptionsRollbacksItem>() {
           ...
           public void write(JsonWriter out, RedemptionRelatedRedemptionsRollbacksItem value) throws IOException {
            ...
            for (Field field : RedemptionRelatedRedemptionsRollbacksItem.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionRelatedRedemptionsRollbacksItem.class.getDeclaredField(fieldName + "IsSet");
