...
public class ParameterFiltersListCampaignsVoucherTypeConditions {
  /**
   * Gets or Sets $in
   */
  ...
  public ParameterFiltersListCampaignsVoucherTypeConditions add$InItem(InEnum $inItem) {
    if (this.$in == null) {
  ...
  **/
  ...
  public ParameterFiltersListCampaignsVoucherTypeConditions add$NotInItem(NotInEnum $notInItem) {
    if (this.$notIn == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ParameterFiltersListCampaignsVoucherTypeConditions parameterFiltersListCampaignsVoucherTypeConditions = (ParameterFiltersListCampaignsVoucherTypeConditions) o;
    return Objects.equals(this.$in, parameterFiltersListCampaignsVoucherTypeConditions.$in) &&
        Objects.equals(this.$notIn, parameterFiltersListCampaignsVoucherTypeConditions.$notIn) &&
        Objects.equals(this.$is, parameterFiltersListCampaignsVoucherTypeConditions.$is) &&
        Objects.equals(this.$isNot, parameterFiltersListCampaignsVoucherTypeConditions.$isNot) &&
        Objects.equals(this.$hasValue, parameterFiltersListCampaignsVoucherTypeConditions.$hasValue) &&
        Objects.equals(this.$isUnknown, parameterFiltersListCampaignsVoucherTypeConditions.$isUnknown) &&
        Objects.equals(this.$startsWith, parameterFiltersListCampaignsVoucherTypeConditions.$startsWith) &&
        Objects.equals(this.$endsWith, parameterFiltersListCampaignsVoucherTypeConditions.$endsWith);
  }
  ...
  public String toString() {
    ...
    sb.append("class ParameterFiltersListCampaignsVoucherTypeConditions {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParameterFiltersListCampaignsVoucherTypeConditions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParameterFiltersListCampaignsVoucherTypeConditions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParameterFiltersListCampaignsVoucherTypeConditions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParameterFiltersListCampaignsVoucherTypeConditions.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListCampaignsVoucherTypeConditions>() {
           ...
           @Override
           public ParameterFiltersListCampaignsVoucherTypeConditions read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ParameterFiltersListCampaignsVoucherTypeConditions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ParameterFiltersListCampaignsVoucherTypeConditions
  * @throws IOException if the JSON string is invalid with respect to ParameterFiltersListCampaignsVoucherTypeConditions
  */
  public static ParameterFiltersListCampaignsVoucherTypeConditions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ParameterFiltersListCampaignsVoucherTypeConditions.class);
  }

 /**
  * Convert an instance of ParameterFiltersListCampaignsVoucherTypeConditions to an JSON string
  *
  * @return JSON string
  */
