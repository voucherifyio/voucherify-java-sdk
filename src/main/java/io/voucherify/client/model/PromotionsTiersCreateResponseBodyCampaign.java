       ...
       return (TypeAdapter<T>) new TypeAdapter<PromotionsTiersCreateResponseBodyCampaign>() {
           ...
           public void write(JsonWriter out, PromotionsTiersCreateResponseBodyCampaign value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : PromotionsTiersCreateResponseBodyCampaign.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = PromotionsTiersCreateResponseBodyCampaign.class.getDeclaredField(fieldName + "IsSet");
