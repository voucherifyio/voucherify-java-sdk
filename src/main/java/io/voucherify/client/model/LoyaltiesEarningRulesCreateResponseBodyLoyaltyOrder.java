       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrder>() {
           ...
           public void write(JsonWriter out, LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrder value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrder.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrder.class.getDeclaredField(fieldName + "IsSet");
