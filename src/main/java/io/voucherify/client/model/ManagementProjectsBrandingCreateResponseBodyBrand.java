...
public class ManagementProjectsBrandingCreateResponseBodyBrand {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsBrandingCreateResponseBodyBrand managementProjectsBrandingCreateResponseBodyBrand = (ManagementProjectsBrandingCreateResponseBodyBrand) o;
    return Objects.equals(this.name, managementProjectsBrandingCreateResponseBodyBrand.name) &&
        Objects.equals(this.privacyPolicyUrl, managementProjectsBrandingCreateResponseBodyBrand.privacyPolicyUrl) &&
        Objects.equals(this.termsOfUseUrl, managementProjectsBrandingCreateResponseBodyBrand.termsOfUseUrl) &&
        Objects.equals(this.permissionReminder, managementProjectsBrandingCreateResponseBodyBrand.permissionReminder) &&
        Objects.equals(this.websiteUrl, managementProjectsBrandingCreateResponseBodyBrand.websiteUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagementProjectsBrandingCreateResponseBodyBrand {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsBrandingCreateResponseBodyBrand.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsBrandingCreateResponseBodyBrand' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsBrandingCreateResponseBodyBrand> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsBrandingCreateResponseBodyBrand.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsBrandingCreateResponseBodyBrand>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsBrandingCreateResponseBodyBrand value) throws IOException {
            ...
            for (Field field : ManagementProjectsBrandingCreateResponseBodyBrand.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectsBrandingCreateResponseBodyBrand.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ManagementProjectsBrandingCreateResponseBodyBrand read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagementProjectsBrandingCreateResponseBodyBrand given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagementProjectsBrandingCreateResponseBodyBrand
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsBrandingCreateResponseBodyBrand
  */
  public static ManagementProjectsBrandingCreateResponseBodyBrand fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsBrandingCreateResponseBodyBrand.class);
  }

 /**
  * Convert an instance of ManagementProjectsBrandingCreateResponseBodyBrand to an JSON string
  *
  * @return JSON string
  */
