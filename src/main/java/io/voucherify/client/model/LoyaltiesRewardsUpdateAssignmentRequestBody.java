    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesRewardsUpdateAssignmentRequestBody>() {
           ...
           public void write(JsonWriter out, LoyaltiesRewardsUpdateAssignmentRequestBody value) throws IOException {
            ...
            for (Field field : LoyaltiesRewardsUpdateAssignmentRequestBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltiesRewardsUpdateAssignmentRequestBody.class.getDeclaredField(fieldName + "IsSet");
