       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListTemplatesName>() {
           ...
           public void write(JsonWriter out, ParameterFiltersListTemplatesName value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ParameterFiltersListTemplatesName.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ParameterFiltersListTemplatesName.class.getDeclaredField(fieldName + "IsSet");
