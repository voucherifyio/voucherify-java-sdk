       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionRewardResultParameters>() {
           ...
           public void write(JsonWriter out, RedemptionRewardResultParameters value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionRewardResultParameters.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionRewardResultParameters.class.getDeclaredField(fieldName + "IsSet");
