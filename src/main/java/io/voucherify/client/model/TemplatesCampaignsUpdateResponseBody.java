...
public class TemplatesCampaignsUpdateResponseBody {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TemplatesCampaignsUpdateResponseBody templatesCampaignsUpdateResponseBody = (TemplatesCampaignsUpdateResponseBody) o;
    return Objects.equals(this.id, templatesCampaignsUpdateResponseBody.id) &&
        Objects.equals(this.name, templatesCampaignsUpdateResponseBody.name) &&
        Objects.equals(this.description, templatesCampaignsUpdateResponseBody.description) &&
        Objects.equals(this.campaignType, templatesCampaignsUpdateResponseBody.campaignType) &&
        Objects.equals(this.createdAt, templatesCampaignsUpdateResponseBody.createdAt) &&
        Objects.equals(this._object, templatesCampaignsUpdateResponseBody._object) &&
        Objects.equals(this.updatedAt, templatesCampaignsUpdateResponseBody.updatedAt);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplatesCampaignsUpdateResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplatesCampaignsUpdateResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplatesCampaignsUpdateResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplatesCampaignsUpdateResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplatesCampaignsUpdateResponseBody>() {
           @Override
           public void write(JsonWriter out, TemplatesCampaignsUpdateResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : TemplatesCampaignsUpdateResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = TemplatesCampaignsUpdateResponseBody.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public TemplatesCampaignsUpdateResponseBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TemplatesCampaignsUpdateResponseBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TemplatesCampaignsUpdateResponseBody
  * @throws IOException if the JSON string is invalid with respect to TemplatesCampaignsUpdateResponseBody
  */
  public static TemplatesCampaignsUpdateResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplatesCampaignsUpdateResponseBody.class);
  }

 /**
  * Convert an instance of TemplatesCampaignsUpdateResponseBody to an JSON string
  *
  * @return JSON string
  */
