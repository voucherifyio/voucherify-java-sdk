...
import io.voucherify.client.model.MemberActivityDataRedemptionOrderItemsItemProduct;
import io.voucherify.client.model.MemberActivityDataRedemptionOrderItemsItemSku;
...
public class MemberActivityDataRedemptionOrderItemsItem {
  ...
  public MemberActivityDataRedemptionOrderItemsItem id(String id) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem _object(ObjectEnum _object) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem sourceId(String sourceId) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem relatedObject(RelatedObjectEnum relatedObject) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem productId(String productId) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem skuId(String skuId) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem quantity(Integer quantity) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem appliedQuantity(Integer appliedQuantity) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem appliedQuantityAmount(Integer appliedQuantityAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem discountQuantity(Integer discountQuantity) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem appliedDiscountQuantity(Integer appliedDiscountQuantity) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem amount(Integer amount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem price(Integer price) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem subtotalAmount(Integer subtotalAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem initialQuantity(Integer initialQuantity) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public MemberActivityDataRedemptionOrderItemsItem product(MemberActivityDataRedemptionOrderItemsItemProduct product) {
  ...
  **/
  @javax.annotation.Nullable
  public MemberActivityDataRedemptionOrderItemsItemProduct getProduct() {
    return product;
  }
  ...
  public MemberActivityDataRedemptionOrderItemsItem sku(MemberActivityDataRedemptionOrderItemsItemSku sku) {
  ...
  **/
  @javax.annotation.Nullable
  public MemberActivityDataRedemptionOrderItemsItemSku getSku() {
    return sku;
  }
  ...
  public MemberActivityDataRedemptionOrderItemsItem metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MemberActivityDataRedemptionOrderItemsItem memberActivityDataRedemptionOrderItemsItem = (MemberActivityDataRedemptionOrderItemsItem) o;
    return Objects.equals(this.id, memberActivityDataRedemptionOrderItemsItem.id) &&
        Objects.equals(this._object, memberActivityDataRedemptionOrderItemsItem._object) &&
        Objects.equals(this.sourceId, memberActivityDataRedemptionOrderItemsItem.sourceId) &&
        Objects.equals(this.relatedObject, memberActivityDataRedemptionOrderItemsItem.relatedObject) &&
        Objects.equals(this.productId, memberActivityDataRedemptionOrderItemsItem.productId) &&
        Objects.equals(this.skuId, memberActivityDataRedemptionOrderItemsItem.skuId) &&
        Objects.equals(this.quantity, memberActivityDataRedemptionOrderItemsItem.quantity) &&
        Objects.equals(this.appliedQuantity, memberActivityDataRedemptionOrderItemsItem.appliedQuantity) &&
        Objects.equals(this.appliedQuantityAmount, memberActivityDataRedemptionOrderItemsItem.appliedQuantityAmount) &&
        Objects.equals(this.discountQuantity, memberActivityDataRedemptionOrderItemsItem.discountQuantity) &&
        Objects.equals(this.appliedDiscountQuantity, memberActivityDataRedemptionOrderItemsItem.appliedDiscountQuantity) &&
        Objects.equals(this.amount, memberActivityDataRedemptionOrderItemsItem.amount) &&
        Objects.equals(this.discountAmount, memberActivityDataRedemptionOrderItemsItem.discountAmount) &&
        Objects.equals(this.appliedDiscountAmount, memberActivityDataRedemptionOrderItemsItem.appliedDiscountAmount) &&
        Objects.equals(this.price, memberActivityDataRedemptionOrderItemsItem.price) &&
        Objects.equals(this.subtotalAmount, memberActivityDataRedemptionOrderItemsItem.subtotalAmount) &&
        Objects.equals(this.initialQuantity, memberActivityDataRedemptionOrderItemsItem.initialQuantity) &&
        Objects.equals(this.initialAmount, memberActivityDataRedemptionOrderItemsItem.initialAmount) &&
        Objects.equals(this.product, memberActivityDataRedemptionOrderItemsItem.product) &&
        Objects.equals(this.sku, memberActivityDataRedemptionOrderItemsItem.sku) &&
        Objects.equals(this.metadata, memberActivityDataRedemptionOrderItemsItem.metadata);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, _object, sourceId, relatedObject, productId, skuId, quantity, appliedQuantity, appliedQuantityAmount, discountQuantity, appliedDiscountQuantity, amount, discountAmount, appliedDiscountAmount, price, subtotalAmount, initialQuantity, initialAmount, product, sku, metadata);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberActivityDataRedemptionOrderItemsItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberActivityDataRedemptionOrderItemsItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberActivityDataRedemptionOrderItemsItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberActivityDataRedemptionOrderItemsItem.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<MemberActivityDataRedemptionOrderItemsItem>() {
           ...
           @Override
           public MemberActivityDataRedemptionOrderItemsItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MemberActivityDataRedemptionOrderItemsItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberActivityDataRedemptionOrderItemsItem
  * @throws IOException if the JSON string is invalid with respect to MemberActivityDataRedemptionOrderItemsItem
  */
  public static MemberActivityDataRedemptionOrderItemsItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberActivityDataRedemptionOrderItemsItem.class);
  }

 /**
  * Convert an instance of MemberActivityDataRedemptionOrderItemsItem to an JSON string
  *
  * @return JSON string
  */
