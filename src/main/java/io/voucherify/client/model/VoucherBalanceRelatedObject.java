       ...
       return (TypeAdapter<T>) new TypeAdapter<VoucherBalanceRelatedObject>() {
           ...
           public void write(JsonWriter out, VoucherBalanceRelatedObject value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VoucherBalanceRelatedObject.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VoucherBalanceRelatedObject.class.getDeclaredField(fieldName + "IsSet");
