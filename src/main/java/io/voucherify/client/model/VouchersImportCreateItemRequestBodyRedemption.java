       ...
       return (TypeAdapter<T>) new TypeAdapter<VouchersImportCreateItemRequestBodyRedemption>() {
           ...
           public void write(JsonWriter out, VouchersImportCreateItemRequestBodyRedemption value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VouchersImportCreateItemRequestBodyRedemption.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VouchersImportCreateItemRequestBodyRedemption.class.getDeclaredField(fieldName + "IsSet");
