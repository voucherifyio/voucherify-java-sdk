...
import io.voucherify.client.model.ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer;
import io.voucherify.client.model.ClientValidationsValidateResponseBodyRedeemablesItemOrderReferrer;
...
public class ClientValidationsValidateResponseBodyRedeemablesItemOrder {
  ...
  private ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer customer;

  public static final String SERIALIZED_NAME_REFERRER = "referrer";
  @SerializedName(SERIALIZED_NAME_REFERRER)
  private ClientValidationsValidateResponseBodyRedeemablesItemOrderReferrer referrer;
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder() {
  }

  public ClientValidationsValidateResponseBodyRedeemablesItemOrder id(String id) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder status(StatusEnum status) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder amount(Integer amount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder metadata(Object metadata) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder customerId(String customerId) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder customer(ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer customer) {
  ...
  **/
  @javax.annotation.Nullable
  public ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer getCustomer() {
    return customer;
  }


  public void setCustomer(ClientValidationsValidateResponseBodyRedeemablesItemOrderCustomer customer) {
    this.customer = customer;
  }


  public ClientValidationsValidateResponseBodyRedeemablesItemOrder referrer(ClientValidationsValidateResponseBodyRedeemablesItemOrderReferrer referrer) {
  ...
  **/
  @javax.annotation.Nullable
  public ClientValidationsValidateResponseBodyRedeemablesItemOrderReferrer getReferrer() {
    return referrer;
  }


  public void setReferrer(ClientValidationsValidateResponseBodyRedeemablesItemOrderReferrer referrer) {
    this.referrer = referrer;
  }


  public ClientValidationsValidateResponseBodyRedeemablesItemOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public ClientValidationsValidateResponseBodyRedeemablesItemOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public ClientValidationsValidateResponseBodyRedeemablesItemOrder items(List<OrderCalculatedItem> items) {
    
    this.items = items;
    return this;
  }

  public ClientValidationsValidateResponseBodyRedeemablesItemOrder addItemsItem(OrderCalculatedItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ClientValidationsValidateResponseBodyRedeemablesItemOrder clientValidationsValidateResponseBodyRedeemablesItemOrder = (ClientValidationsValidateResponseBodyRedeemablesItemOrder) o;
    return Objects.equals(this.id, clientValidationsValidateResponseBodyRedeemablesItemOrder.id) &&
        Objects.equals(this.sourceId, clientValidationsValidateResponseBodyRedeemablesItemOrder.sourceId) &&
        Objects.equals(this.status, clientValidationsValidateResponseBodyRedeemablesItemOrder.status) &&
        Objects.equals(this.amount, clientValidationsValidateResponseBodyRedeemablesItemOrder.amount) &&
        Objects.equals(this.initialAmount, clientValidationsValidateResponseBodyRedeemablesItemOrder.initialAmount) &&
        Objects.equals(this.discountAmount, clientValidationsValidateResponseBodyRedeemablesItemOrder.discountAmount) &&
        Objects.equals(this.itemsDiscountAmount, clientValidationsValidateResponseBodyRedeemablesItemOrder.itemsDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, clientValidationsValidateResponseBodyRedeemablesItemOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAmount, clientValidationsValidateResponseBodyRedeemablesItemOrder.totalAmount) &&
        Objects.equals(this.appliedDiscountAmount, clientValidationsValidateResponseBodyRedeemablesItemOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, clientValidationsValidateResponseBodyRedeemablesItemOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, clientValidationsValidateResponseBodyRedeemablesItemOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.metadata, clientValidationsValidateResponseBodyRedeemablesItemOrder.metadata) &&
        Objects.equals(this._object, clientValidationsValidateResponseBodyRedeemablesItemOrder._object) &&
        Objects.equals(this.createdAt, clientValidationsValidateResponseBodyRedeemablesItemOrder.createdAt) &&
        Objects.equals(this.updatedAt, clientValidationsValidateResponseBodyRedeemablesItemOrder.updatedAt) &&
        Objects.equals(this.customerId, clientValidationsValidateResponseBodyRedeemablesItemOrder.customerId) &&
        Objects.equals(this.referrerId, clientValidationsValidateResponseBodyRedeemablesItemOrder.referrerId) &&
        Objects.equals(this.customer, clientValidationsValidateResponseBodyRedeemablesItemOrder.customer) &&
        Objects.equals(this.referrer, clientValidationsValidateResponseBodyRedeemablesItemOrder.referrer) &&
        Objects.equals(this.redemptions, clientValidationsValidateResponseBodyRedeemablesItemOrder.redemptions) &&
        Objects.equals(this.items, clientValidationsValidateResponseBodyRedeemablesItemOrder.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClientValidationsValidateResponseBodyRedeemablesItemOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClientValidationsValidateResponseBodyRedeemablesItemOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClientValidationsValidateResponseBodyRedeemablesItemOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClientValidationsValidateResponseBodyRedeemablesItemOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClientValidationsValidateResponseBodyRedeemablesItemOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<ClientValidationsValidateResponseBodyRedeemablesItemOrder>() {
           @Override
           public void write(JsonWriter out, ClientValidationsValidateResponseBodyRedeemablesItemOrder value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ClientValidationsValidateResponseBodyRedeemablesItemOrder.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ClientValidationsValidateResponseBodyRedeemablesItemOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ClientValidationsValidateResponseBodyRedeemablesItemOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ClientValidationsValidateResponseBodyRedeemablesItemOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ClientValidationsValidateResponseBodyRedeemablesItemOrder
  * @throws IOException if the JSON string is invalid with respect to ClientValidationsValidateResponseBodyRedeemablesItemOrder
  */
  public static ClientValidationsValidateResponseBodyRedeemablesItemOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClientValidationsValidateResponseBodyRedeemablesItemOrder.class);
  }

 /**
  * Convert an instance of ClientValidationsValidateResponseBodyRedeemablesItemOrder to an JSON string
  *
  * @return JSON string
  */
