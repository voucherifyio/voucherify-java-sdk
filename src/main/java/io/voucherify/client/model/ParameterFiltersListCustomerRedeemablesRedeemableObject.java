       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListCustomerRedeemablesRedeemableObject>() {
           ...
           public void write(JsonWriter out, ParameterFiltersListCustomerRedeemablesRedeemableObject value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ParameterFiltersListCustomerRedeemablesRedeemableObject.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ParameterFiltersListCustomerRedeemablesRedeemableObject.class.getDeclaredField(fieldName + "IsSet");
