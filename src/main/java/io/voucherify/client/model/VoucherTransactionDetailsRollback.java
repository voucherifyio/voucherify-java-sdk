       ...
       return (TypeAdapter<T>) new TypeAdapter<VoucherTransactionDetailsRollback>() {
           ...
           public void write(JsonWriter out, VoucherTransactionDetailsRollback value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VoucherTransactionDetailsRollback.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VoucherTransactionDetailsRollback.class.getDeclaredField(fieldName + "IsSet");
