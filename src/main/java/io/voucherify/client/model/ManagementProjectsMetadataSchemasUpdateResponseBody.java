       ...
       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsMetadataSchemasUpdateResponseBody>() {
           ...
           public void write(JsonWriter out, ManagementProjectsMetadataSchemasUpdateResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ManagementProjectsMetadataSchemasUpdateResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ManagementProjectsMetadataSchemasUpdateResponseBody.class.getDeclaredField(fieldName + "IsSet");
