...
public class RedeemableVoucher {
  ...
  **/
   ...
   * @return the RedeemableVoucher instance itself
   */
  public RedeemableVoucher putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, redeemableVoucher.id) &&
        ...
        Objects.equals(this.additionalProperties, redeemableVoucher.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, code, campaign, campaignId, category, categoryId, categories, type, discount, gift, loyaltyCard, startDate, expirationDate, validityTimeframe, validityDayOfWeek, validityHours, active, additionalInfo, metadata, assets, isReferralCode, createdAt, updatedAt, referrerId, holderId, _object, publish, redemption, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RedeemableVoucher>() {
           ...
           public RedeemableVoucher read(JsonReader in) throws IOException {
             ...
             RedeemableVoucher instance = thisAdapter.fromJsonTree(jsonObj);
