    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomersMetadataUpdateInBulkRequestBody>() {
           ...
           public void write(JsonWriter out, CustomersMetadataUpdateInBulkRequestBody value) throws IOException {
            ...
            for (Field field : CustomersMetadataUpdateInBulkRequestBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = CustomersMetadataUpdateInBulkRequestBody.class.getDeclaredField(fieldName + "IsSet");
