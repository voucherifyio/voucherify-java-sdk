...
public class QualificationsOptionFiltersResourceTypeConditions {
  ...
  **/
   ...
   * @return the QualificationsOptionFiltersResourceTypeConditions instance itself
   */
  public QualificationsOptionFiltersResourceTypeConditions putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<QualificationsOptionFiltersResourceTypeConditions>() {
           ...
           public QualificationsOptionFiltersResourceTypeConditions read(JsonReader in) throws IOException {
             ...
             QualificationsOptionFiltersResourceTypeConditions instance = thisAdapter.fromJsonTree(jsonObj);
