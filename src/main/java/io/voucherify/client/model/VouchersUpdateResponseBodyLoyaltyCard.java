...
public class VouchersUpdateResponseBodyLoyaltyCard {
  ...
  public VouchersUpdateResponseBodyLoyaltyCard() {
  }

  public VouchersUpdateResponseBodyLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public VouchersUpdateResponseBodyLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public VouchersUpdateResponseBodyLoyaltyCard nextExpirationDate(LocalDate nextExpirationDate) {
  ...
  **/
  ...
  public VouchersUpdateResponseBodyLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public VouchersUpdateResponseBodyLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public VouchersUpdateResponseBodyLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public VouchersUpdateResponseBodyLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VouchersUpdateResponseBodyLoyaltyCard vouchersUpdateResponseBodyLoyaltyCard = (VouchersUpdateResponseBodyLoyaltyCard) o;
    return Objects.equals(this.points, vouchersUpdateResponseBodyLoyaltyCard.points) &&
        Objects.equals(this.balance, vouchersUpdateResponseBodyLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, vouchersUpdateResponseBodyLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, vouchersUpdateResponseBodyLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, vouchersUpdateResponseBodyLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, vouchersUpdateResponseBodyLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, vouchersUpdateResponseBodyLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class VouchersUpdateResponseBodyLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VouchersUpdateResponseBodyLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VouchersUpdateResponseBodyLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VouchersUpdateResponseBodyLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VouchersUpdateResponseBodyLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<VouchersUpdateResponseBodyLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, VouchersUpdateResponseBodyLoyaltyCard value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VouchersUpdateResponseBodyLoyaltyCard.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VouchersUpdateResponseBodyLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public VouchersUpdateResponseBodyLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VouchersUpdateResponseBodyLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VouchersUpdateResponseBodyLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to VouchersUpdateResponseBodyLoyaltyCard
  */
  public static VouchersUpdateResponseBodyLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VouchersUpdateResponseBodyLoyaltyCard.class);
  }

 /**
  * Convert an instance of VouchersUpdateResponseBodyLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
