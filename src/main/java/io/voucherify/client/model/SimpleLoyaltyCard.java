  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.points, simpleLoyaltyCard.points) &&
        ...
        Objects.equals(this.pendingPoints, simpleLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, simpleLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, simpleLoyaltyCard.subtractedPoints);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SimpleLoyaltyCard>() {
           ...
           public void write(JsonWriter out, SimpleLoyaltyCard value) throws IOException {
            ...
            for (Field field : SimpleLoyaltyCard.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = SimpleLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
