    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RewardsCreateRequestBodyParameters>() {
           ...
           public void write(JsonWriter out, RewardsCreateRequestBodyParameters value) throws IOException {
            ...
            for (Field field : RewardsCreateRequestBodyParameters.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RewardsCreateRequestBodyParameters.class.getDeclaredField(fieldName + "IsSet");
