    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MemberActivityDataTransactionDetailsDestinationVoucherGift>() {
           ...
           public void write(JsonWriter out, MemberActivityDataTransactionDetailsDestinationVoucherGift value) throws IOException {
            ...
            for (Field field : MemberActivityDataTransactionDetailsDestinationVoucherGift.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = MemberActivityDataTransactionDetailsDestinationVoucherGift.class.getDeclaredField(fieldName + "IsSet");
