    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListCustomerRedeemablesHolderRoleConditions>() {
           ...
           public void write(JsonWriter out, ParameterFiltersListCustomerRedeemablesHolderRoleConditions value) throws IOException {
            ...
            for (Field field : ParameterFiltersListCustomerRedeemablesHolderRoleConditions.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ParameterFiltersListCustomerRedeemablesHolderRoleConditions.class.getDeclaredField(fieldName + "IsSet");
