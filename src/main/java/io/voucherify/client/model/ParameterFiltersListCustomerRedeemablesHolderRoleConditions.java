...
public class ParameterFiltersListCustomerRedeemablesHolderRoleConditions {
  ...
  public ParameterFiltersListCustomerRedeemablesHolderRoleConditions $in(List<InEnum> $in) {
    
    this.$in = $in;
    return this;
  }

  public ParameterFiltersListCustomerRedeemablesHolderRoleConditions add$InItem(InEnum $inItem) {
    if (this.$in == null) {
  ...
  **/
  ...
  public ParameterFiltersListCustomerRedeemablesHolderRoleConditions $notIn(List<NotInEnum> $notIn) {
    
    this.$notIn = $notIn;
    return this;
  }

  public ParameterFiltersListCustomerRedeemablesHolderRoleConditions add$NotInItem(NotInEnum $notInItem) {
    if (this.$notIn == null) {
  ...
  **/
  ...
  public ParameterFiltersListCustomerRedeemablesHolderRoleConditions $is(IsEnum $is) {
  ...
  **/
  ...
  public ParameterFiltersListCustomerRedeemablesHolderRoleConditions $isNot(IsNotEnum $isNot) {
  ...
  **/
  ...
  public ParameterFiltersListCustomerRedeemablesHolderRoleConditions $hasValue(String $hasValue) {
  ...
  **/
  ...
  public ParameterFiltersListCustomerRedeemablesHolderRoleConditions $isUnknown(String $isUnknown) {
  ...
  **/
  ...
  public ParameterFiltersListCustomerRedeemablesHolderRoleConditions $startsWith(String $startsWith) {
  ...
  **/
  ...
  public ParameterFiltersListCustomerRedeemablesHolderRoleConditions $endsWith(String $endsWith) {
  ...
  **/
   ...
   * @return the ParameterFiltersListCustomerRedeemablesHolderRoleConditions instance itself
   */
  public ParameterFiltersListCustomerRedeemablesHolderRoleConditions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ParameterFiltersListCustomerRedeemablesHolderRoleConditions parameterFiltersListCustomerRedeemablesHolderRoleConditions = (ParameterFiltersListCustomerRedeemablesHolderRoleConditions) o;
    return Objects.equals(this.$in, parameterFiltersListCustomerRedeemablesHolderRoleConditions.$in) &&
        Objects.equals(this.$notIn, parameterFiltersListCustomerRedeemablesHolderRoleConditions.$notIn) &&
        Objects.equals(this.$is, parameterFiltersListCustomerRedeemablesHolderRoleConditions.$is) &&
        Objects.equals(this.$isNot, parameterFiltersListCustomerRedeemablesHolderRoleConditions.$isNot) &&
        Objects.equals(this.$hasValue, parameterFiltersListCustomerRedeemablesHolderRoleConditions.$hasValue) &&
        Objects.equals(this.$isUnknown, parameterFiltersListCustomerRedeemablesHolderRoleConditions.$isUnknown) &&
        Objects.equals(this.$startsWith, parameterFiltersListCustomerRedeemablesHolderRoleConditions.$startsWith) &&
        Objects.equals(this.$endsWith, parameterFiltersListCustomerRedeemablesHolderRoleConditions.$endsWith)&&
        Objects.equals(this.additionalProperties, parameterFiltersListCustomerRedeemablesHolderRoleConditions.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ParameterFiltersListCustomerRedeemablesHolderRoleConditions {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParameterFiltersListCustomerRedeemablesHolderRoleConditions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParameterFiltersListCustomerRedeemablesHolderRoleConditions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParameterFiltersListCustomerRedeemablesHolderRoleConditions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParameterFiltersListCustomerRedeemablesHolderRoleConditions.class));

       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListCustomerRedeemablesHolderRoleConditions>() {
           @Override
           public void write(JsonWriter out, ParameterFiltersListCustomerRedeemablesHolderRoleConditions value) throws IOException {
           ...
           @Override
           public ParameterFiltersListCustomerRedeemablesHolderRoleConditions read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ParameterFiltersListCustomerRedeemablesHolderRoleConditions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ParameterFiltersListCustomerRedeemablesHolderRoleConditions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ParameterFiltersListCustomerRedeemablesHolderRoleConditions
  * @throws IOException if the JSON string is invalid with respect to ParameterFiltersListCustomerRedeemablesHolderRoleConditions
  */
  public static ParameterFiltersListCustomerRedeemablesHolderRoleConditions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ParameterFiltersListCustomerRedeemablesHolderRoleConditions.class);
  }

 /**
  * Convert an instance of ParameterFiltersListCustomerRedeemablesHolderRoleConditions to an JSON string
  *
  * @return JSON string
  */
