       ...
       return (TypeAdapter<T>) new TypeAdapter<VouchersImportCreateResponseBody>() {
           ...
           public void write(JsonWriter out, VouchersImportCreateResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VouchersImportCreateResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VouchersImportCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
