       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionsListResponseBodyRedemptionsItemPromotionTier>() {
           ...
           public void write(JsonWriter out, RedemptionsListResponseBodyRedemptionsItemPromotionTier value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionsListResponseBodyRedemptionsItemPromotionTier.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionsListResponseBodyRedemptionsItemPromotionTier.class.getDeclaredField(fieldName + "IsSet");
