       ...
       return (TypeAdapter<T>) new TypeAdapter<PublicationsCreateRequestBody>() {
           ...
           public void write(JsonWriter out, PublicationsCreateRequestBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : PublicationsCreateRequestBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = PublicationsCreateRequestBody.class.getDeclaredField(fieldName + "IsSet");
