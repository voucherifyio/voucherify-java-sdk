    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsWebhooksGetResponseBody>() {
           ...
           public void write(JsonWriter out, ManagementProjectsWebhooksGetResponseBody value) throws IOException {
            ...
            for (Field field : ManagementProjectsWebhooksGetResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectsWebhooksGetResponseBody.class.getDeclaredField(fieldName + "IsSet");
