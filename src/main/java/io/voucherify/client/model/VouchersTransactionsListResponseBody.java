       ...
       return (TypeAdapter<T>) new TypeAdapter<VouchersTransactionsListResponseBody>() {
           ...
           public void write(JsonWriter out, VouchersTransactionsListResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VouchersTransactionsListResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VouchersTransactionsListResponseBody.class.getDeclaredField(fieldName + "IsSet");
