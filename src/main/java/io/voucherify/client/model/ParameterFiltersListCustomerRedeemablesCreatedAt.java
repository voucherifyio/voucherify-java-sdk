       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListCustomerRedeemablesCreatedAt>() {
           ...
           public void write(JsonWriter out, ParameterFiltersListCustomerRedeemablesCreatedAt value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ParameterFiltersListCustomerRedeemablesCreatedAt.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ParameterFiltersListCustomerRedeemablesCreatedAt.class.getDeclaredField(fieldName + "IsSet");
