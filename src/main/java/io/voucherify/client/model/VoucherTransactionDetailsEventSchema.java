    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VoucherTransactionDetailsEventSchema>() {
           ...
           public void write(JsonWriter out, VoucherTransactionDetailsEventSchema value) throws IOException {
            ...
            for (Field field : VoucherTransactionDetailsEventSchema.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = VoucherTransactionDetailsEventSchema.class.getDeclaredField(fieldName + "IsSet");
