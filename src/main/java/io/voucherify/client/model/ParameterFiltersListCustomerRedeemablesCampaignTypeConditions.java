    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListCustomerRedeemablesCampaignTypeConditions>() {
           ...
           public void write(JsonWriter out, ParameterFiltersListCustomerRedeemablesCampaignTypeConditions value) throws IOException {
            ...
            for (Field field : ParameterFiltersListCustomerRedeemablesCampaignTypeConditions.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ParameterFiltersListCustomerRedeemablesCampaignTypeConditions.class.getDeclaredField(fieldName + "IsSet");
