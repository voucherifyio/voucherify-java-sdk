...
public class RedemptionOrderItemsItem {
  ...
  public RedemptionOrderItemsItem() {
  }

  public RedemptionOrderItemsItem id(String id) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem skuId(String skuId) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem productId(String productId) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem relatedObject(RelatedObjectEnum relatedObject) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem sourceId(String sourceId) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem quantity(Integer quantity) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem discountQuantity(Integer discountQuantity) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem initialQuantity(Integer initialQuantity) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem amount(Integer amount) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem appliedDiscountQuantity(Integer appliedDiscountQuantity) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem appliedQuantity(Integer appliedQuantity) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem appliedQuantityAmount(Integer appliedQuantityAmount) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem price(Integer price) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem subtotalAmount(Integer subtotalAmount) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem product(OrderCalculatedItemProduct product) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem sku(OrderCalculatedItemSku sku) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem _object(ObjectEnum _object) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem metadata(Object metadata) {
  ...
  **/
  ...
  public RedemptionOrderItemsItem applicationDetails(List<ApplicationDetailsItem> applicationDetails) {
    
    this.applicationDetails = applicationDetails;
    return this;
  }

  public RedemptionOrderItemsItem addApplicationDetailsItem(ApplicationDetailsItem applicationDetailsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RedemptionOrderItemsItem redemptionOrderItemsItem = (RedemptionOrderItemsItem) o;
    return Objects.equals(this.id, redemptionOrderItemsItem.id) &&
        Objects.equals(this.skuId, redemptionOrderItemsItem.skuId) &&
        Objects.equals(this.productId, redemptionOrderItemsItem.productId) &&
        Objects.equals(this.relatedObject, redemptionOrderItemsItem.relatedObject) &&
        Objects.equals(this.sourceId, redemptionOrderItemsItem.sourceId) &&
        Objects.equals(this.quantity, redemptionOrderItemsItem.quantity) &&
        Objects.equals(this.discountQuantity, redemptionOrderItemsItem.discountQuantity) &&
        Objects.equals(this.initialQuantity, redemptionOrderItemsItem.initialQuantity) &&
        Objects.equals(this.amount, redemptionOrderItemsItem.amount) &&
        Objects.equals(this.discountAmount, redemptionOrderItemsItem.discountAmount) &&
        Objects.equals(this.appliedDiscountAmount, redemptionOrderItemsItem.appliedDiscountAmount) &&
        Objects.equals(this.appliedDiscountQuantity, redemptionOrderItemsItem.appliedDiscountQuantity) &&
        Objects.equals(this.appliedQuantity, redemptionOrderItemsItem.appliedQuantity) &&
        Objects.equals(this.appliedQuantityAmount, redemptionOrderItemsItem.appliedQuantityAmount) &&
        Objects.equals(this.initialAmount, redemptionOrderItemsItem.initialAmount) &&
        Objects.equals(this.price, redemptionOrderItemsItem.price) &&
        Objects.equals(this.subtotalAmount, redemptionOrderItemsItem.subtotalAmount) &&
        Objects.equals(this.product, redemptionOrderItemsItem.product) &&
        Objects.equals(this.sku, redemptionOrderItemsItem.sku) &&
        Objects.equals(this._object, redemptionOrderItemsItem._object) &&
        Objects.equals(this.metadata, redemptionOrderItemsItem.metadata) &&
        Objects.equals(this.applicationDetails, redemptionOrderItemsItem.applicationDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionOrderItemsItem {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionOrderItemsItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionOrderItemsItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionOrderItemsItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionOrderItemsItem.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionOrderItemsItem>() {
           @Override
           public void write(JsonWriter out, RedemptionOrderItemsItem value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionOrderItemsItem.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionOrderItemsItem.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionOrderItemsItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedemptionOrderItemsItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionOrderItemsItem
  * @throws IOException if the JSON string is invalid with respect to RedemptionOrderItemsItem
  */
  public static RedemptionOrderItemsItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionOrderItemsItem.class);
  }

 /**
  * Convert an instance of RedemptionOrderItemsItem to an JSON string
  *
  * @return JSON string
  */
