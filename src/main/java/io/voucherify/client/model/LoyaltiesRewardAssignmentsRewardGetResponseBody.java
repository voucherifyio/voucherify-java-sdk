       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesRewardAssignmentsRewardGetResponseBody>() {
           ...
           public void write(JsonWriter out, LoyaltiesRewardAssignmentsRewardGetResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : LoyaltiesRewardAssignmentsRewardGetResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = LoyaltiesRewardAssignmentsRewardGetResponseBody.class.getDeclaredField(fieldName + "IsSet");
