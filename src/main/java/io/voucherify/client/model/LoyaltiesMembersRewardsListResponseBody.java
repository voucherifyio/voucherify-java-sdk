...
public class LoyaltiesMembersRewardsListResponseBody {
  ...
  private List<LoyaltiesMembersRewardsListResponseBodyDataItem> data;
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesMembersRewardsListResponseBody>() {
           ...
           public void write(JsonWriter out, LoyaltiesMembersRewardsListResponseBody value) throws IOException {
            ...
            for (Field field : LoyaltiesMembersRewardsListResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltiesMembersRewardsListResponseBody.class.getDeclaredField(fieldName + "IsSet");
