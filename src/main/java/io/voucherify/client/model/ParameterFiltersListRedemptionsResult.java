    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListRedemptionsResult>() {
           ...
           public void write(JsonWriter out, ParameterFiltersListRedemptionsResult value) throws IOException {
            ...
            for (Field field : ParameterFiltersListRedemptionsResult.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ParameterFiltersListRedemptionsResult.class.getDeclaredField(fieldName + "IsSet");
