    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReferralProgramRefereeRewardRelatedObjectParent>() {
           ...
           public void write(JsonWriter out, ReferralProgramRefereeRewardRelatedObjectParent value) throws IOException {
            ...
            for (Field field : ReferralProgramRefereeRewardRelatedObjectParent.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ReferralProgramRefereeRewardRelatedObjectParent.class.getDeclaredField(fieldName + "IsSet");
