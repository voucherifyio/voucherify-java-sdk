...
import io.voucherify.client.model.ManagementProjectsUpdateResponseBodyApiUsageNotifications;
import io.voucherify.client.model.ManagementProjectsUpdateResponseBodyDefaultCodeConfig;
import io.voucherify.client.model.ManagementProjectsUpdateResponseBodyLimits;
import io.voucherify.client.model.ManagementProjectsUpdateResponseBodyWebhooksCalloutNotifications;
...
public class ManagementProjectsUpdateResponseBody {
  ...
  private ManagementProjectsUpdateResponseBodyWebhooksCalloutNotifications webhooksCalloutNotifications;
  ...
  private ManagementProjectsUpdateResponseBodyApiUsageNotifications apiUsageNotifications;
  ...
  private ManagementProjectsUpdateResponseBodyDefaultCodeConfig defaultCodeConfig;
    private boolean defaultCodeConfigIsSet = false;

  public static final String SERIALIZED_NAME_LIMITS = "limits";
  @SerializedName(SERIALIZED_NAME_LIMITS)
  private ManagementProjectsUpdateResponseBodyLimits limits;
    private boolean limitsIsSet = false;

  public ManagementProjectsUpdateResponseBody() {
  }

  public ManagementProjectsUpdateResponseBody id(String id) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody name(String name) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody description(String description) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody timezone(String timezone) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody currency(String currency) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody dialCode(String dialCode) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody webhookVersion(WebhookVersionEnum webhookVersion) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody clientTrustedDomains(List<String> clientTrustedDomains) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody clientRedeemEnabled(Boolean clientRedeemEnabled) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody clientPublishEnabled(Boolean clientPublishEnabled) {
  ...
  **/
  @javax.annotation.Nullable
  public ManagementProjectsUpdateResponseBodyWebhooksCalloutNotifications getWebhooksCalloutNotifications() {
    return webhooksCalloutNotifications;
  }
  ...
  **/
  @javax.annotation.Nullable
  public ManagementProjectsUpdateResponseBodyApiUsageNotifications getApiUsageNotifications() {
    return apiUsageNotifications;
  }
  ...
  public ManagementProjectsUpdateResponseBody clusterId(String clusterId) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody caseSensitiveCodes(Boolean caseSensitiveCodes) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody apiVersion(ApiVersionEnum apiVersion) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody isSandbox(Boolean isSandbox) {
  ...
  **/
  ...
  public ManagementProjectsUpdateResponseBody webhookToken(String webhookToken) {
  ...
  **/
  @javax.annotation.Nullable
  public ManagementProjectsUpdateResponseBodyDefaultCodeConfig getDefaultCodeConfig() {
    return defaultCodeConfig;
  }
  ...
  **/
  @javax.annotation.Nullable
  public ManagementProjectsUpdateResponseBodyLimits getLimits() {
    return limits;
  }


  public void setLimits(ManagementProjectsUpdateResponseBodyLimits limits) {
    this.limits = limits;
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsUpdateResponseBody managementProjectsUpdateResponseBody = (ManagementProjectsUpdateResponseBody) o;
    return Objects.equals(this.id, managementProjectsUpdateResponseBody.id) &&
        Objects.equals(this.name, managementProjectsUpdateResponseBody.name) &&
        Objects.equals(this.description, managementProjectsUpdateResponseBody.description) &&
        Objects.equals(this.timezone, managementProjectsUpdateResponseBody.timezone) &&
        Objects.equals(this.currency, managementProjectsUpdateResponseBody.currency) &&
        Objects.equals(this.dialCode, managementProjectsUpdateResponseBody.dialCode) &&
        Objects.equals(this.webhookVersion, managementProjectsUpdateResponseBody.webhookVersion) &&
        Objects.equals(this.clientTrustedDomains, managementProjectsUpdateResponseBody.clientTrustedDomains) &&
        Objects.equals(this.clientRedeemEnabled, managementProjectsUpdateResponseBody.clientRedeemEnabled) &&
        Objects.equals(this.clientPublishEnabled, managementProjectsUpdateResponseBody.clientPublishEnabled) &&
        Objects.equals(this.clientListVouchersEnabled, managementProjectsUpdateResponseBody.clientListVouchersEnabled) &&
        Objects.equals(this.clientCreateCustomerEnabled, managementProjectsUpdateResponseBody.clientCreateCustomerEnabled) &&
        Objects.equals(this.clientLoyaltyEventsEnabled, managementProjectsUpdateResponseBody.clientLoyaltyEventsEnabled) &&
        Objects.equals(this.clientSetVoucherExpirationDateEnabled, managementProjectsUpdateResponseBody.clientSetVoucherExpirationDateEnabled) &&
        Objects.equals(this.webhooksCalloutNotifications, managementProjectsUpdateResponseBody.webhooksCalloutNotifications) &&
        Objects.equals(this.apiUsageNotifications, managementProjectsUpdateResponseBody.apiUsageNotifications) &&
        Objects.equals(this.clusterId, managementProjectsUpdateResponseBody.clusterId) &&
        Objects.equals(this.caseSensitiveCodes, managementProjectsUpdateResponseBody.caseSensitiveCodes) &&
        Objects.equals(this.apiVersion, managementProjectsUpdateResponseBody.apiVersion) &&
        Objects.equals(this.isSandbox, managementProjectsUpdateResponseBody.isSandbox) &&
        Objects.equals(this.webhookToken, managementProjectsUpdateResponseBody.webhookToken) &&
        Objects.equals(this.defaultCodeConfig, managementProjectsUpdateResponseBody.defaultCodeConfig) &&
        Objects.equals(this.limits, managementProjectsUpdateResponseBody.limits);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagementProjectsUpdateResponseBody {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsUpdateResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsUpdateResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsUpdateResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsUpdateResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsUpdateResponseBody>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsUpdateResponseBody value) throws IOException {
            ...
            for (Field field : ManagementProjectsUpdateResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectsUpdateResponseBody.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ManagementProjectsUpdateResponseBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagementProjectsUpdateResponseBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagementProjectsUpdateResponseBody
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsUpdateResponseBody
  */
  public static ManagementProjectsUpdateResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsUpdateResponseBody.class);
  }

 /**
  * Convert an instance of ManagementProjectsUpdateResponseBody to an JSON string
  *
  * @return JSON string
  */
