...
public class ValidationsValidateRequestBodyOptions {
  ...
  public ValidationsValidateRequestBodyOptions expand(List<ExpandEnum> expand) {
    
    this.expand = expand;
    return this;
  }

  public ValidationsValidateRequestBodyOptions addExpandItem(ExpandEnum expandItem) {
    if (this.expand == null) {
  ...
  **/
   ...
   * @return the ValidationsValidateRequestBodyOptions instance itself
   */
  public ValidationsValidateRequestBodyOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.expand, validationsValidateRequestBodyOptions.expand)&&
        Objects.equals(this.additionalProperties, validationsValidateRequestBodyOptions.additionalProperties);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidationsValidateRequestBodyOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidationsValidateRequestBodyOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidationsValidateRequestBodyOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidationsValidateRequestBodyOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidationsValidateRequestBodyOptions>() {
           @Override
           public void write(JsonWriter out, ValidationsValidateRequestBodyOptions value) throws IOException {
           ...
           @Override
           public ValidationsValidateRequestBodyOptions read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ValidationsValidateRequestBodyOptions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ValidationsValidateRequestBodyOptions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ValidationsValidateRequestBodyOptions
  * @throws IOException if the JSON string is invalid with respect to ValidationsValidateRequestBodyOptions
  */
  public static ValidationsValidateRequestBodyOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidationsValidateRequestBodyOptions.class);
  }

 /**
  * Convert an instance of ValidationsValidateRequestBodyOptions to an JSON string
  *
  * @return JSON string
  */
