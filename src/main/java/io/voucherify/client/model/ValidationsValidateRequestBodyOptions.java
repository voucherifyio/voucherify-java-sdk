    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidationsValidateRequestBodyOptions>() {
           ...
           public void write(JsonWriter out, ValidationsValidateRequestBodyOptions value) throws IOException {
            ...
            for (Field field : ValidationsValidateRequestBodyOptions.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ValidationsValidateRequestBodyOptions.class.getDeclaredField(fieldName + "IsSet");
