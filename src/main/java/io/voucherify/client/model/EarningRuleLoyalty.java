...
public class EarningRuleLoyalty {
  ...
  **/
  ...
  public EarningRuleLoyalty pointsFormula(String pointsFormula) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, earningRuleLoyalty.type) &&
        ...
        Objects.equals(this.pointsFormula, earningRuleLoyalty.pointsFormula) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EarningRuleLoyalty>() {
           ...
           public void write(JsonWriter out, EarningRuleLoyalty value) throws IOException {
            ...
            for (Field field : EarningRuleLoyalty.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = EarningRuleLoyalty.class.getDeclaredField(fieldName + "IsSet");
