    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListRedemptionsUserLogin>() {
           ...
           public void write(JsonWriter out, ParameterFiltersListRedemptionsUserLogin value) throws IOException {
            ...
            for (Field field : ParameterFiltersListRedemptionsUserLogin.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ParameterFiltersListRedemptionsUserLogin.class.getDeclaredField(fieldName + "IsSet");
