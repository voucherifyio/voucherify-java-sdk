...
public class LoyaltiesTransactionsListResponseBody {
  /**
  ...
  public LoyaltiesTransactionsListResponseBody() {
  }

  public LoyaltiesTransactionsListResponseBody _object(ObjectEnum _object) {
  ...
  **/
  ...
  public LoyaltiesTransactionsListResponseBody dataRef(DataRefEnum dataRef) {
  ...
  **/
  ...
  public LoyaltiesTransactionsListResponseBody data(List<LoyaltyCardTransaction> data) {
    
    this.data = data;
    return this;
  }

  public LoyaltiesTransactionsListResponseBody addDataItem(LoyaltyCardTransaction dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public LoyaltiesTransactionsListResponseBody hasMore(Boolean hasMore) {
  ...
  **/
  ...
  public LoyaltiesTransactionsListResponseBody moreStartingAfter(String moreStartingAfter) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LoyaltiesTransactionsListResponseBody loyaltiesTransactionsListResponseBody = (LoyaltiesTransactionsListResponseBody) o;
    return Objects.equals(this._object, loyaltiesTransactionsListResponseBody._object) &&
        Objects.equals(this.dataRef, loyaltiesTransactionsListResponseBody.dataRef) &&
        Objects.equals(this.data, loyaltiesTransactionsListResponseBody.data) &&
        Objects.equals(this.hasMore, loyaltiesTransactionsListResponseBody.hasMore) &&
        Objects.equals(this.moreStartingAfter, loyaltiesTransactionsListResponseBody.moreStartingAfter);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoyaltiesTransactionsListResponseBody {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoyaltiesTransactionsListResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoyaltiesTransactionsListResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoyaltiesTransactionsListResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoyaltiesTransactionsListResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesTransactionsListResponseBody>() {
           @Override
           public void write(JsonWriter out, LoyaltiesTransactionsListResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : LoyaltiesTransactionsListResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = LoyaltiesTransactionsListResponseBody.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public LoyaltiesTransactionsListResponseBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LoyaltiesTransactionsListResponseBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoyaltiesTransactionsListResponseBody
  * @throws IOException if the JSON string is invalid with respect to LoyaltiesTransactionsListResponseBody
  */
  public static LoyaltiesTransactionsListResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoyaltiesTransactionsListResponseBody.class);
  }

 /**
  * Convert an instance of LoyaltiesTransactionsListResponseBody to an JSON string
  *
  * @return JSON string
  */
