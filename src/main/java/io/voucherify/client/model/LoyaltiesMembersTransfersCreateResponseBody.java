...
public class LoyaltiesMembersTransfersCreateResponseBody {
  ...
  **/
   ...
   * @return the LoyaltiesMembersTransfersCreateResponseBody instance itself
   */
  public LoyaltiesMembersTransfersCreateResponseBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, loyaltiesMembersTransfersCreateResponseBody.id) &&
        ...
        Objects.equals(this.additionalProperties, loyaltiesMembersTransfersCreateResponseBody.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, code, campaign, campaignId, category, categoryId, categories, type, loyaltyCard, startDate, expirationDate, validityTimeframe, validityDayOfWeek, validityHours, publish, redemption, active, additionalInfo, metadata, assets, isReferralCode, holderId, updatedAt, createdAt, additionalProperties);
  }
