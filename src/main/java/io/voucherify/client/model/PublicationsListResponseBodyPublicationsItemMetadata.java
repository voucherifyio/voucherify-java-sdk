...
public class PublicationsListResponseBodyPublicationsItemMetadata {
  ...
  public PublicationsListResponseBodyPublicationsItemMetadata() {
  }
  ...
  **/
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PublicationsListResponseBodyPublicationsItemMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PublicationsListResponseBodyPublicationsItemMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PublicationsListResponseBodyPublicationsItemMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PublicationsListResponseBodyPublicationsItemMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<PublicationsListResponseBodyPublicationsItemMetadata>() {
           @Override
           public void write(JsonWriter out, PublicationsListResponseBodyPublicationsItemMetadata value) throws IOException {
            ...
            for (Field field : PublicationsListResponseBodyPublicationsItemMetadata.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = PublicationsListResponseBodyPublicationsItemMetadata.class.getDeclaredField(fieldName + "IsSet");
 ...
 /**
  * Create an instance of PublicationsListResponseBodyPublicationsItemMetadata given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PublicationsListResponseBodyPublicationsItemMetadata
  * @throws IOException if the JSON string is invalid with respect to PublicationsListResponseBodyPublicationsItemMetadata
  */
  public static PublicationsListResponseBodyPublicationsItemMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PublicationsListResponseBodyPublicationsItemMetadata.class);
  }

 /**
  * Convert an instance of PublicationsListResponseBodyPublicationsItemMetadata to an JSON string
  *
  * @return JSON string
  */
