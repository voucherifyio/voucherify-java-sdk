    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ExportsCreateRequestBodyParameters>() {
           ...
           public void write(JsonWriter out, ExportsCreateRequestBodyParameters value) throws IOException {
            ...
            for (Field field : ExportsCreateRequestBodyParameters.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ExportsCreateRequestBodyParameters.class.getDeclaredField(fieldName + "IsSet");
