       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductCollectionsCreateResponseBody>() {
           ...
           public void write(JsonWriter out, ProductCollectionsCreateResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ProductCollectionsCreateResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ProductCollectionsCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
