...
import io.voucherify.client.model.MemberActivityDataOrderCustomer;
import io.voucherify.client.model.MemberActivityDataOrderItemsItem;
import io.voucherify.client.model.MemberActivityDataOrderReferrer;
...
public class MemberActivityDataOrder {
  ...
  private List<MemberActivityDataOrderItemsItem> items;
  ...
  private MemberActivityDataOrderCustomer customer;
  ...
  private MemberActivityDataOrderReferrer referrer;
  ...
  public MemberActivityDataOrder() {
  }

  public MemberActivityDataOrder id(String id) {
  ...
  **/
  ...
  public MemberActivityDataOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public MemberActivityDataOrder status(StatusEnum status) {
  ...
  **/
  ...
  public MemberActivityDataOrder customerId(String customerId) {
  ...
  **/
  ...
  public MemberActivityDataOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public MemberActivityDataOrder amount(Integer amount) {
  ...
  **/
  ...
  public MemberActivityDataOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public MemberActivityDataOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public MemberActivityDataOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public MemberActivityDataOrder items(List<MemberActivityDataOrderItemsItem> items) {
    
    this.items = items;
    return this;
  }

  public MemberActivityDataOrder addItemsItem(MemberActivityDataOrderItemsItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<MemberActivityDataOrderItemsItem> getItems() {
    return items;
  }


  public void setItems(List<MemberActivityDataOrderItemsItem> items) {
    this.items = items;
  ...
  public MemberActivityDataOrder metadata(Object metadata) {
  ...
  **/
  ...
  public MemberActivityDataOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public MemberActivityDataOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public MemberActivityDataOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public MemberActivityDataOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public MemberActivityDataOrder customer(MemberActivityDataOrderCustomer customer) {
  ...
  **/
  @javax.annotation.Nullable
  public MemberActivityDataOrderCustomer getCustomer() {
    return customer;
  }


  public void setCustomer(MemberActivityDataOrderCustomer customer) {
    this.customer = customer;
  ...
  public MemberActivityDataOrder referrer(MemberActivityDataOrderReferrer referrer) {
  ...
  **/
  @javax.annotation.Nullable
  public MemberActivityDataOrderReferrer getReferrer() {
    return referrer;
  }


  public void setReferrer(MemberActivityDataOrderReferrer referrer) {
    this.referrer = referrer;
  ...
  public MemberActivityDataOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public MemberActivityDataOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MemberActivityDataOrder memberActivityDataOrder = (MemberActivityDataOrder) o;
    return Objects.equals(this.id, memberActivityDataOrder.id) &&
        Objects.equals(this.sourceId, memberActivityDataOrder.sourceId) &&
        Objects.equals(this.status, memberActivityDataOrder.status) &&
        Objects.equals(this.customerId, memberActivityDataOrder.customerId) &&
        Objects.equals(this.referrerId, memberActivityDataOrder.referrerId) &&
        Objects.equals(this.amount, memberActivityDataOrder.amount) &&
        Objects.equals(this.discountAmount, memberActivityDataOrder.discountAmount) &&
        Objects.equals(this.appliedDiscountAmount, memberActivityDataOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsDiscountAmount, memberActivityDataOrder.itemsDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, memberActivityDataOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, memberActivityDataOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, memberActivityDataOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.totalAmount, memberActivityDataOrder.totalAmount) &&
        Objects.equals(this.items, memberActivityDataOrder.items) &&
        Objects.equals(this.metadata, memberActivityDataOrder.metadata) &&
        Objects.equals(this._object, memberActivityDataOrder._object) &&
        Objects.equals(this.initialAmount, memberActivityDataOrder.initialAmount) &&
        Objects.equals(this.createdAt, memberActivityDataOrder.createdAt) &&
        Objects.equals(this.updatedAt, memberActivityDataOrder.updatedAt) &&
        Objects.equals(this.customer, memberActivityDataOrder.customer) &&
        Objects.equals(this.referrer, memberActivityDataOrder.referrer) &&
        Objects.equals(this.redemptions, memberActivityDataOrder.redemptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class MemberActivityDataOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberActivityDataOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberActivityDataOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberActivityDataOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberActivityDataOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberActivityDataOrder>() {
           @Override
           public void write(JsonWriter out, MemberActivityDataOrder value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : MemberActivityDataOrder.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = MemberActivityDataOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public MemberActivityDataOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MemberActivityDataOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberActivityDataOrder
  * @throws IOException if the JSON string is invalid with respect to MemberActivityDataOrder
  */
  public static MemberActivityDataOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberActivityDataOrder.class);
  }

 /**
  * Convert an instance of MemberActivityDataOrder to an JSON string
  *
  * @return JSON string
  */
