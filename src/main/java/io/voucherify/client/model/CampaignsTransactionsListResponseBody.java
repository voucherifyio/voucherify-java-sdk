...
public class CampaignsTransactionsListResponseBody {
  /**
  ...
  public CampaignsTransactionsListResponseBody() {
  }
  ...
  **/
  ...
  public CampaignsTransactionsListResponseBody addDataItem(VoucherTransaction dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampaignsTransactionsListResponseBody campaignsTransactionsListResponseBody = (CampaignsTransactionsListResponseBody) o;
    return Objects.equals(this._object, campaignsTransactionsListResponseBody._object) &&
        Objects.equals(this.dataRef, campaignsTransactionsListResponseBody.dataRef) &&
        Objects.equals(this.data, campaignsTransactionsListResponseBody.data) &&
        Objects.equals(this.hasMore, campaignsTransactionsListResponseBody.hasMore) &&
        Objects.equals(this.moreStartingAfter, campaignsTransactionsListResponseBody.moreStartingAfter);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsTransactionsListResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsTransactionsListResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsTransactionsListResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsTransactionsListResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsTransactionsListResponseBody>() {
           @Override
           public void write(JsonWriter out, CampaignsTransactionsListResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : CampaignsTransactionsListResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = CampaignsTransactionsListResponseBody.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public CampaignsTransactionsListResponseBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignsTransactionsListResponseBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsTransactionsListResponseBody
  * @throws IOException if the JSON string is invalid with respect to CampaignsTransactionsListResponseBody
  */
  public static CampaignsTransactionsListResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsTransactionsListResponseBody.class);
  }

 /**
  * Convert an instance of CampaignsTransactionsListResponseBody to an JSON string
  *
  * @return JSON string
  */
