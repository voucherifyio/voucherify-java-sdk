...
public class ValidationRuleError {
  ...
  **/
   ...
   * @return the ValidationRuleError instance itself
   */
  public ValidationRuleError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, validationRuleError.message)&&
        Objects.equals(this.additionalProperties, validationRuleError.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidationRuleError>() {
           ...
           public ValidationRuleError read(JsonReader in) throws IOException {
             ...
             ValidationRuleError instance = thisAdapter.fromJsonTree(jsonObj);
