...
public class ProductsSkusListResponseBody {
  ...
  private List<Sku> skus;
    private boolean skusIsSet = false;
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductsSkusListResponseBody>() {
           ...
           public void write(JsonWriter out, ProductsSkusListResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ProductsSkusListResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ProductsSkusListResponseBody.class.getDeclaredField(fieldName + "IsSet");
