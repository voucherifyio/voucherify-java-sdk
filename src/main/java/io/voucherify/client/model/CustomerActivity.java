...
public class CustomerActivity {
  ...
  **/
   ...
   * @return the CustomerActivity instance itself
   */
  public CustomerActivity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, customerActivity.id) &&
        ...
        Objects.equals(this.additionalProperties, customerActivity.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerActivity>() {
           ...
           public CustomerActivity read(JsonReader in) throws IOException {
             ...
             CustomerActivity instance = thisAdapter.fromJsonTree(jsonObj);
