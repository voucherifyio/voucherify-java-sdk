...
public class EarningRulePendingPoints {
  /**
  ...
  public EarningRulePendingPoints() {
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EarningRulePendingPoints earningRulePendingPoints = (EarningRulePendingPoints) o;
    return Objects.equals(this.periodType, earningRulePendingPoints.periodType) &&
        Objects.equals(this.periodValue, earningRulePendingPoints.periodValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class EarningRulePendingPoints {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EarningRulePendingPoints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EarningRulePendingPoints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EarningRulePendingPoints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EarningRulePendingPoints.class));

       return (TypeAdapter<T>) new TypeAdapter<EarningRulePendingPoints>() {
           @Override
           public void write(JsonWriter out, EarningRulePendingPoints value) throws IOException {
            ...
            for (Field field : EarningRulePendingPoints.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = EarningRulePendingPoints.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public EarningRulePendingPoints read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EarningRulePendingPoints given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EarningRulePendingPoints
  * @throws IOException if the JSON string is invalid with respect to EarningRulePendingPoints
  */
  public static EarningRulePendingPoints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EarningRulePendingPoints.class);
  }

 /**
  * Convert an instance of EarningRulePendingPoints to an JSON string
  *
  * @return JSON string
  */
