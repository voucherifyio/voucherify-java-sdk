...
import io.voucherify.client.model.RedemptionsRedeemResponseBodyOrderItemsItem;
...
public class RedemptionsRedeemResponseBodyOrder {
  ...
  private List<RedemptionsRedeemResponseBodyOrderItemsItem> items;
    private boolean itemsIsSet = false;

  public RedemptionsRedeemResponseBodyOrder() {
  }

  public RedemptionsRedeemResponseBodyOrder id(String id) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder status(StatusEnum status) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder amount(Integer amount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder metadata(Object metadata) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder customerId(String customerId) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder customer(CustomerId customer) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder referrer(ReferrerId referrer) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public RedemptionsRedeemResponseBodyOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public RedemptionsRedeemResponseBodyOrder items(List<RedemptionsRedeemResponseBodyOrderItemsItem> items) {
    
    this.items = items;
    return this;
  }

  public RedemptionsRedeemResponseBodyOrder addItemsItem(RedemptionsRedeemResponseBodyOrderItemsItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<RedemptionsRedeemResponseBodyOrderItemsItem> getItems() {
    return items;
  }


  public void setItems(List<RedemptionsRedeemResponseBodyOrderItemsItem> items) {
    this.items = items;
  ...
  public boolean equals(Object o) {
    ...
    RedemptionsRedeemResponseBodyOrder redemptionsRedeemResponseBodyOrder = (RedemptionsRedeemResponseBodyOrder) o;
    return Objects.equals(this.id, redemptionsRedeemResponseBodyOrder.id) &&
        Objects.equals(this.sourceId, redemptionsRedeemResponseBodyOrder.sourceId) &&
        Objects.equals(this.status, redemptionsRedeemResponseBodyOrder.status) &&
        Objects.equals(this.amount, redemptionsRedeemResponseBodyOrder.amount) &&
        Objects.equals(this.initialAmount, redemptionsRedeemResponseBodyOrder.initialAmount) &&
        Objects.equals(this.discountAmount, redemptionsRedeemResponseBodyOrder.discountAmount) &&
        Objects.equals(this.itemsDiscountAmount, redemptionsRedeemResponseBodyOrder.itemsDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, redemptionsRedeemResponseBodyOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAmount, redemptionsRedeemResponseBodyOrder.totalAmount) &&
        Objects.equals(this.appliedDiscountAmount, redemptionsRedeemResponseBodyOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, redemptionsRedeemResponseBodyOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, redemptionsRedeemResponseBodyOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.metadata, redemptionsRedeemResponseBodyOrder.metadata) &&
        Objects.equals(this._object, redemptionsRedeemResponseBodyOrder._object) &&
        Objects.equals(this.createdAt, redemptionsRedeemResponseBodyOrder.createdAt) &&
        Objects.equals(this.updatedAt, redemptionsRedeemResponseBodyOrder.updatedAt) &&
        Objects.equals(this.customerId, redemptionsRedeemResponseBodyOrder.customerId) &&
        Objects.equals(this.referrerId, redemptionsRedeemResponseBodyOrder.referrerId) &&
        Objects.equals(this.customer, redemptionsRedeemResponseBodyOrder.customer) &&
        Objects.equals(this.referrer, redemptionsRedeemResponseBodyOrder.referrer) &&
        Objects.equals(this.redemptions, redemptionsRedeemResponseBodyOrder.redemptions) &&
        Objects.equals(this.items, redemptionsRedeemResponseBodyOrder.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionsRedeemResponseBodyOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionsRedeemResponseBodyOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionsRedeemResponseBodyOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionsRedeemResponseBodyOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionsRedeemResponseBodyOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionsRedeemResponseBodyOrder>() {
           @Override
           public void write(JsonWriter out, RedemptionsRedeemResponseBodyOrder value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionsRedeemResponseBodyOrder.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionsRedeemResponseBodyOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionsRedeemResponseBodyOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedemptionsRedeemResponseBodyOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionsRedeemResponseBodyOrder
  * @throws IOException if the JSON string is invalid with respect to RedemptionsRedeemResponseBodyOrder
  */
  public static RedemptionsRedeemResponseBodyOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionsRedeemResponseBodyOrder.class);
  }

 /**
  * Convert an instance of RedemptionsRedeemResponseBodyOrder to an JSON string
  *
  * @return JSON string
  */
