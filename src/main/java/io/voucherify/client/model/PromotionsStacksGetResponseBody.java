       ...
       return (TypeAdapter<T>) new TypeAdapter<PromotionsStacksGetResponseBody>() {
           ...
           public void write(JsonWriter out, PromotionsStacksGetResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : PromotionsStacksGetResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = PromotionsStacksGetResponseBody.class.getDeclaredField(fieldName + "IsSet");
