...
import io.voucherify.client.model.ValidationsValidateResponseBodyRedeemablesItemOrderCustomer;
import io.voucherify.client.model.ValidationsValidateResponseBodyRedeemablesItemOrderReferrer;
...
public class ValidationsValidateResponseBodyRedeemablesItemOrder {
  ...
  private ValidationsValidateResponseBodyRedeemablesItemOrderCustomer customer;

  public static final String SERIALIZED_NAME_REFERRER = "referrer";
  @SerializedName(SERIALIZED_NAME_REFERRER)
  private ValidationsValidateResponseBodyRedeemablesItemOrderReferrer referrer;
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder() {
  }

  public ValidationsValidateResponseBodyRedeemablesItemOrder id(String id) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder status(StatusEnum status) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder amount(Integer amount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder metadata(Object metadata) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder customerId(String customerId) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder customer(ValidationsValidateResponseBodyRedeemablesItemOrderCustomer customer) {
  ...
  **/
  @javax.annotation.Nullable
  public ValidationsValidateResponseBodyRedeemablesItemOrderCustomer getCustomer() {
    return customer;
  }


  public void setCustomer(ValidationsValidateResponseBodyRedeemablesItemOrderCustomer customer) {
    this.customer = customer;
  }


  public ValidationsValidateResponseBodyRedeemablesItemOrder referrer(ValidationsValidateResponseBodyRedeemablesItemOrderReferrer referrer) {
  ...
  **/
  @javax.annotation.Nullable
  public ValidationsValidateResponseBodyRedeemablesItemOrderReferrer getReferrer() {
    return referrer;
  }


  public void setReferrer(ValidationsValidateResponseBodyRedeemablesItemOrderReferrer referrer) {
    this.referrer = referrer;
  }


  public ValidationsValidateResponseBodyRedeemablesItemOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public ValidationsValidateResponseBodyRedeemablesItemOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public ValidationsValidateResponseBodyRedeemablesItemOrder items(List<OrderCalculatedItem> items) {
    
    this.items = items;
    return this;
  }

  public ValidationsValidateResponseBodyRedeemablesItemOrder addItemsItem(OrderCalculatedItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ValidationsValidateResponseBodyRedeemablesItemOrder validationsValidateResponseBodyRedeemablesItemOrder = (ValidationsValidateResponseBodyRedeemablesItemOrder) o;
    return Objects.equals(this.id, validationsValidateResponseBodyRedeemablesItemOrder.id) &&
        Objects.equals(this.sourceId, validationsValidateResponseBodyRedeemablesItemOrder.sourceId) &&
        Objects.equals(this.status, validationsValidateResponseBodyRedeemablesItemOrder.status) &&
        Objects.equals(this.amount, validationsValidateResponseBodyRedeemablesItemOrder.amount) &&
        Objects.equals(this.initialAmount, validationsValidateResponseBodyRedeemablesItemOrder.initialAmount) &&
        Objects.equals(this.discountAmount, validationsValidateResponseBodyRedeemablesItemOrder.discountAmount) &&
        Objects.equals(this.itemsDiscountAmount, validationsValidateResponseBodyRedeemablesItemOrder.itemsDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, validationsValidateResponseBodyRedeemablesItemOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAmount, validationsValidateResponseBodyRedeemablesItemOrder.totalAmount) &&
        Objects.equals(this.appliedDiscountAmount, validationsValidateResponseBodyRedeemablesItemOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, validationsValidateResponseBodyRedeemablesItemOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, validationsValidateResponseBodyRedeemablesItemOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.metadata, validationsValidateResponseBodyRedeemablesItemOrder.metadata) &&
        Objects.equals(this._object, validationsValidateResponseBodyRedeemablesItemOrder._object) &&
        Objects.equals(this.createdAt, validationsValidateResponseBodyRedeemablesItemOrder.createdAt) &&
        Objects.equals(this.updatedAt, validationsValidateResponseBodyRedeemablesItemOrder.updatedAt) &&
        Objects.equals(this.customerId, validationsValidateResponseBodyRedeemablesItemOrder.customerId) &&
        Objects.equals(this.referrerId, validationsValidateResponseBodyRedeemablesItemOrder.referrerId) &&
        Objects.equals(this.customer, validationsValidateResponseBodyRedeemablesItemOrder.customer) &&
        Objects.equals(this.referrer, validationsValidateResponseBodyRedeemablesItemOrder.referrer) &&
        Objects.equals(this.redemptions, validationsValidateResponseBodyRedeemablesItemOrder.redemptions) &&
        Objects.equals(this.items, validationsValidateResponseBodyRedeemablesItemOrder.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValidationsValidateResponseBodyRedeemablesItemOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidationsValidateResponseBodyRedeemablesItemOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidationsValidateResponseBodyRedeemablesItemOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidationsValidateResponseBodyRedeemablesItemOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidationsValidateResponseBodyRedeemablesItemOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidationsValidateResponseBodyRedeemablesItemOrder>() {
           @Override
           public void write(JsonWriter out, ValidationsValidateResponseBodyRedeemablesItemOrder value) throws IOException {
            ...
            for (Field field : ValidationsValidateResponseBodyRedeemablesItemOrder.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ValidationsValidateResponseBodyRedeemablesItemOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ValidationsValidateResponseBodyRedeemablesItemOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ValidationsValidateResponseBodyRedeemablesItemOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ValidationsValidateResponseBodyRedeemablesItemOrder
  * @throws IOException if the JSON string is invalid with respect to ValidationsValidateResponseBodyRedeemablesItemOrder
  */
  public static ValidationsValidateResponseBodyRedeemablesItemOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidationsValidateResponseBodyRedeemablesItemOrder.class);
  }

 /**
  * Convert an instance of ValidationsValidateResponseBodyRedeemablesItemOrder to an JSON string
  *
  * @return JSON string
  */
