    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidationsRedeemableSkippedResult>() {
           ...
           public void write(JsonWriter out, ValidationsRedeemableSkippedResult value) throws IOException {
            ...
            for (Field field : ValidationsRedeemableSkippedResult.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ValidationsRedeemableSkippedResult.class.getDeclaredField(fieldName + "IsSet");
