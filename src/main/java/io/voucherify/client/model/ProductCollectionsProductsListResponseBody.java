    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductCollectionsProductsListResponseBody>() {
           ...
           public void write(JsonWriter out, ProductCollectionsProductsListResponseBody value) throws IOException {
            ...
            for (Field field : ProductCollectionsProductsListResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ProductCollectionsProductsListResponseBody.class.getDeclaredField(fieldName + "IsSet");
