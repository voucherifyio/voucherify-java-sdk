...
public class ValidationRule {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, validationRule.name) &&
        Objects.equals(this.rules, validationRule.rules) &&
        Objects.equals(this.bundleRules, validationRule.bundleRules) &&
        Objects.equals(this.error, validationRule.error) &&
        Objects.equals(this.applicableTo, validationRule.applicableTo) &&
        Objects.equals(this.type, validationRule.type) &&
        Objects.equals(this.contextType, validationRule.contextType) &&
        Objects.equals(this.id, validationRule.id) &&
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidationRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidationRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidationRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidationRule.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidationRule>() {
           @Override
           public void write(JsonWriter out, ValidationRule value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ValidationRule.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ValidationRule.class.getDeclaredField(fieldName + "IsSet");
  ...
  * @throws IOException if the JSON string is invalid with respect to ValidationRule
  */
  public static ValidationRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidationRule.class);
  }
