    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesMembersTransfersCreateResponseBodyAssetsQr>() {
           ...
           public void write(JsonWriter out, LoyaltiesMembersTransfersCreateResponseBodyAssetsQr value) throws IOException {
            ...
            for (Field field : LoyaltiesMembersTransfersCreateResponseBodyAssetsQr.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltiesMembersTransfersCreateResponseBodyAssetsQr.class.getDeclaredField(fieldName + "IsSet");
