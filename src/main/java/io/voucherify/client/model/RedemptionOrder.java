...
import io.voucherify.client.model.RedemptionOrderCustomer;
import io.voucherify.client.model.RedemptionOrderItemsItem;
import io.voucherify.client.model.RedemptionOrderReferrer;
...
public class RedemptionOrder {
  ...
  private RedemptionOrderCustomer customer;
  ...
  private RedemptionOrderReferrer referrer;
  ...
  private List<RedemptionOrderItemsItem> items;
    private boolean itemsIsSet = false;

  public RedemptionOrder() {
  }

  public RedemptionOrder id(String id) {
  ...
  **/
  ...
  public RedemptionOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public RedemptionOrder status(StatusEnum status) {
  ...
  **/
  ...
  public RedemptionOrder amount(Integer amount) {
  ...
  **/
  ...
  public RedemptionOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public RedemptionOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public RedemptionOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public RedemptionOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public RedemptionOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public RedemptionOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionOrder metadata(Object metadata) {
  ...
  **/
  ...
  public RedemptionOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public RedemptionOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public RedemptionOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public RedemptionOrder customerId(String customerId) {
  ...
  **/
  ...
  public RedemptionOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public RedemptionOrder customer(RedemptionOrderCustomer customer) {
  ...
  **/
  @javax.annotation.Nullable
  public RedemptionOrderCustomer getCustomer() {
    return customer;
  }


  public void setCustomer(RedemptionOrderCustomer customer) {
    this.customer = customer;
  ...
  public RedemptionOrder referrer(RedemptionOrderReferrer referrer) {
  ...
  **/
  @javax.annotation.Nullable
  public RedemptionOrderReferrer getReferrer() {
    return referrer;
  }


  public void setReferrer(RedemptionOrderReferrer referrer) {
    this.referrer = referrer;
  ...
  public RedemptionOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public RedemptionOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public RedemptionOrder items(List<RedemptionOrderItemsItem> items) {
    
    this.items = items;
    return this;
  }

  public RedemptionOrder addItemsItem(RedemptionOrderItemsItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<RedemptionOrderItemsItem> getItems() {
    return items;
  }


  public void setItems(List<RedemptionOrderItemsItem> items) {
    this.items = items;
  ...
  public boolean equals(Object o) {
    ...
    RedemptionOrder redemptionOrder = (RedemptionOrder) o;
    return Objects.equals(this.id, redemptionOrder.id) &&
        Objects.equals(this.sourceId, redemptionOrder.sourceId) &&
        Objects.equals(this.status, redemptionOrder.status) &&
        Objects.equals(this.amount, redemptionOrder.amount) &&
        Objects.equals(this.initialAmount, redemptionOrder.initialAmount) &&
        Objects.equals(this.discountAmount, redemptionOrder.discountAmount) &&
        Objects.equals(this.itemsDiscountAmount, redemptionOrder.itemsDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, redemptionOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAmount, redemptionOrder.totalAmount) &&
        Objects.equals(this.appliedDiscountAmount, redemptionOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, redemptionOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, redemptionOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.metadata, redemptionOrder.metadata) &&
        Objects.equals(this._object, redemptionOrder._object) &&
        Objects.equals(this.createdAt, redemptionOrder.createdAt) &&
        Objects.equals(this.updatedAt, redemptionOrder.updatedAt) &&
        Objects.equals(this.customerId, redemptionOrder.customerId) &&
        Objects.equals(this.referrerId, redemptionOrder.referrerId) &&
        Objects.equals(this.customer, redemptionOrder.customer) &&
        Objects.equals(this.referrer, redemptionOrder.referrer) &&
        Objects.equals(this.redemptions, redemptionOrder.redemptions) &&
        Objects.equals(this.items, redemptionOrder.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionOrder>() {
           @Override
           public void write(JsonWriter out, RedemptionOrder value) throws IOException {
            ...
            for (Field field : RedemptionOrder.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedemptionOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionOrder
  * @throws IOException if the JSON string is invalid with respect to RedemptionOrder
  */
  public static RedemptionOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionOrder.class);
  }

 /**
  * Convert an instance of RedemptionOrder to an JSON string
  *
  * @return JSON string
  */
