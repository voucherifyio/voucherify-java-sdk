...
public class ManagementProjectsStackingRules {
  ...
  public ManagementProjectsStackingRules id(String id) {
  ...
  **/
  ...
  public ManagementProjectsStackingRules applicableRedeemablesCategoryLimits(Map<String, Integer> applicableRedeemablesCategoryLimits) {
  ...
  public ManagementProjectsStackingRules putApplicableRedeemablesCategoryLimitsItem(String key, Integer applicableRedeemablesCategoryLimitsItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRules discountCalculationMode(DiscountCalculationModeEnum discountCalculationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRules redeemablesApplicationMode(RedeemablesApplicationModeEnum redeemablesApplicationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRules redeemablesSortingRule(RedeemablesSortingRuleEnum redeemablesSortingRule) {
  ...
  **/
  ...
  public ManagementProjectsStackingRules redeemablesProductsApplicationMode(RedeemablesProductsApplicationModeEnum redeemablesProductsApplicationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRules redeemablesNoEffectRule(RedeemablesNoEffectRuleEnum redeemablesNoEffectRule) {
  ...
  **/
  ...
  public ManagementProjectsStackingRules noEffectSkipCategories(List<String> noEffectSkipCategories) {
  ...
  public ManagementProjectsStackingRules addNoEffectSkipCategoriesItem(String noEffectSkipCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRules noEffectRedeemAnywayCategories(List<String> noEffectRedeemAnywayCategories) {
  ...
  public ManagementProjectsStackingRules addNoEffectRedeemAnywayCategoriesItem(String noEffectRedeemAnywayCategoriesItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRules redeemablesRollbackOrderMode(RedeemablesRollbackOrderModeEnum redeemablesRollbackOrderMode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsStackingRules managementProjectsStackingRules = (ManagementProjectsStackingRules) o;
    return Objects.equals(this.id, managementProjectsStackingRules.id) &&
        Objects.equals(this.exclusiveCategories, managementProjectsStackingRules.exclusiveCategories) &&
        Objects.equals(this.jointCategories, managementProjectsStackingRules.jointCategories) &&
        Objects.equals(this.redeemablesLimit, managementProjectsStackingRules.redeemablesLimit) &&
        Objects.equals(this.applicableRedeemablesLimit, managementProjectsStackingRules.applicableRedeemablesLimit) &&
        Objects.equals(this.applicableRedeemablesPerCategoryLimit, managementProjectsStackingRules.applicableRedeemablesPerCategoryLimit) &&
        Objects.equals(this.applicableRedeemablesCategoryLimits, managementProjectsStackingRules.applicableRedeemablesCategoryLimits) &&
        Objects.equals(this.applicableExclusiveRedeemablesLimit, managementProjectsStackingRules.applicableExclusiveRedeemablesLimit) &&
        Objects.equals(this.applicableExclusiveRedeemablesPerCategoryLimit, managementProjectsStackingRules.applicableExclusiveRedeemablesPerCategoryLimit) &&
        Objects.equals(this.discountCalculationMode, managementProjectsStackingRules.discountCalculationMode) &&
        Objects.equals(this.initialAmountModeCategories, managementProjectsStackingRules.initialAmountModeCategories) &&
        Objects.equals(this.discountedAmountModeCategories, managementProjectsStackingRules.discountedAmountModeCategories) &&
        Objects.equals(this.redeemablesApplicationMode, managementProjectsStackingRules.redeemablesApplicationMode) &&
        Objects.equals(this.redeemablesSortingRule, managementProjectsStackingRules.redeemablesSortingRule) &&
        Objects.equals(this.redeemablesProductsApplicationMode, managementProjectsStackingRules.redeemablesProductsApplicationMode) &&
        Objects.equals(this.redeemablesNoEffectRule, managementProjectsStackingRules.redeemablesNoEffectRule) &&
        Objects.equals(this.noEffectSkipCategories, managementProjectsStackingRules.noEffectSkipCategories) &&
        Objects.equals(this.noEffectRedeemAnywayCategories, managementProjectsStackingRules.noEffectRedeemAnywayCategories) &&
        Objects.equals(this.redeemablesRollbackOrderMode, managementProjectsStackingRules.redeemablesRollbackOrderMode) &&
        Objects.equals(this.createdAt, managementProjectsStackingRules.createdAt) &&
        Objects.equals(this.updatedAt, managementProjectsStackingRules.updatedAt);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsStackingRules.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsStackingRules' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsStackingRules> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsStackingRules.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsStackingRules>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsStackingRules value) throws IOException {
            ...
            for (Field field : ManagementProjectsStackingRules.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectsStackingRules.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ManagementProjectsStackingRules read(JsonReader in) throws IOException {
  ...
  * @return An instance of ManagementProjectsStackingRules
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsStackingRules
  */
  public static ManagementProjectsStackingRules fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsStackingRules.class);
  }
