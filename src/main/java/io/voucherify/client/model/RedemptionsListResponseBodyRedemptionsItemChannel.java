    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionsListResponseBodyRedemptionsItemChannel>() {
           ...
           public void write(JsonWriter out, RedemptionsListResponseBodyRedemptionsItemChannel value) throws IOException {
            ...
            for (Field field : RedemptionsListResponseBodyRedemptionsItemChannel.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionsListResponseBodyRedemptionsItemChannel.class.getDeclaredField(fieldName + "IsSet");
