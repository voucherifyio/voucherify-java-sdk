...
public class CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard {
  ...
  public CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard() {
  }

  public CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard nextExpirationDate(LocalDate nextExpirationDate) {
  ...
  **/
  ...
  public CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard campaignsVouchersCreateCombinedResponseBodyLoyaltyCard = (CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard) o;
    return Objects.equals(this.points, campaignsVouchersCreateCombinedResponseBodyLoyaltyCard.points) &&
        Objects.equals(this.balance, campaignsVouchersCreateCombinedResponseBodyLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, campaignsVouchersCreateCombinedResponseBodyLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, campaignsVouchersCreateCombinedResponseBodyLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, campaignsVouchersCreateCombinedResponseBodyLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, campaignsVouchersCreateCombinedResponseBodyLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, campaignsVouchersCreateCombinedResponseBodyLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard value) throws IOException {
            ...
            for (Field field : CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard
  */
  public static CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard.class);
  }

 /**
  * Convert an instance of CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
