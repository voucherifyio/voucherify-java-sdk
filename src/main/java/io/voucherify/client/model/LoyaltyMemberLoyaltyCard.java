...
public class LoyaltyMemberLoyaltyCard {
  ...
  **/
  ...
  public LoyaltyMemberLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public LoyaltyMemberLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public LoyaltyMemberLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.points, loyaltyMemberLoyaltyCard.points) &&
        ...
        Objects.equals(this.pendingPoints, loyaltyMemberLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, loyaltyMemberLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, loyaltyMemberLoyaltyCard.subtractedPoints);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltyMemberLoyaltyCard>() {
           ...
           public void write(JsonWriter out, LoyaltyMemberLoyaltyCard value) throws IOException {
            ...
            for (Field field : LoyaltyMemberLoyaltyCard.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltyMemberLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
