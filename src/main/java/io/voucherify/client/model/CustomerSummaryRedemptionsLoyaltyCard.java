...
public class CustomerSummaryRedemptionsLoyaltyCard {
  ...
  private Integer pointsToGo;
    private boolean pointsToGoIsSet = false;
  ...
  **/
  ...
  public boolean isPointsToGoSet() {
    return pointsToGoIsSet;
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerSummaryRedemptionsLoyaltyCard>() {
           ...
           public void write(JsonWriter out, CustomerSummaryRedemptionsLoyaltyCard value) throws IOException {
            ...
            for (Field field : CustomerSummaryRedemptionsLoyaltyCard.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = CustomerSummaryRedemptionsLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
