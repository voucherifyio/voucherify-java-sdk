...
public class LocationShapeDistance {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LocationShapeDistance locationShapeDistance = (LocationShapeDistance) o;
    return Objects.equals(this.center, locationShapeDistance.center) &&
        Objects.equals(this.radius, locationShapeDistance.radius);
  }
  ...
  public String toString() {
    ...
    sb.append("class LocationShapeDistance {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocationShapeDistance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocationShapeDistance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocationShapeDistance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocationShapeDistance.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<LocationShapeDistance>() {
           ...
           @Override
           public LocationShapeDistance read(JsonReader in) throws IOException {
  ...
  * @return An instance of LocationShapeDistance
  * @throws IOException if the JSON string is invalid with respect to LocationShapeDistance
  */
  public static LocationShapeDistance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocationShapeDistance.class);
  }
