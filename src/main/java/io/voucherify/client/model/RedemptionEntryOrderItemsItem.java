...
import io.voucherify.client.model.RedemptionEntryOrderItemsItemProduct;
import io.voucherify.client.model.RedemptionEntryOrderItemsItemSku;
...
public class RedemptionEntryOrderItemsItem {
  ...
  private RedemptionEntryOrderItemsItemProduct product;

  public static final String SERIALIZED_NAME_SKU = "sku";
  @SerializedName(SERIALIZED_NAME_SKU)
  private RedemptionEntryOrderItemsItemSku sku;
  ...
  public RedemptionEntryOrderItemsItem() {
  }

  public RedemptionEntryOrderItemsItem id(String id) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem skuId(String skuId) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem productId(String productId) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem relatedObject(RelatedObjectEnum relatedObject) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem sourceId(String sourceId) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem quantity(Integer quantity) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem discountQuantity(Integer discountQuantity) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem initialQuantity(Integer initialQuantity) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem amount(Integer amount) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem appliedDiscountQuantity(Integer appliedDiscountQuantity) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem appliedQuantity(Integer appliedQuantity) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem appliedQuantityAmount(Integer appliedQuantityAmount) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem price(Integer price) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem subtotalAmount(Integer subtotalAmount) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem product(RedemptionEntryOrderItemsItemProduct product) {
  ...
  **/
  @javax.annotation.Nullable
  public RedemptionEntryOrderItemsItemProduct getProduct() {
    return product;
  }


  public void setProduct(RedemptionEntryOrderItemsItemProduct product) {
    this.product = product;
  }


  public RedemptionEntryOrderItemsItem sku(RedemptionEntryOrderItemsItemSku sku) {
  ...
  **/
  @javax.annotation.Nullable
  public RedemptionEntryOrderItemsItemSku getSku() {
    return sku;
  }


  public void setSku(RedemptionEntryOrderItemsItemSku sku) {
    this.sku = sku;
  }


  public RedemptionEntryOrderItemsItem _object(ObjectEnum _object) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem metadata(Object metadata) {
  ...
  **/
  ...
  public RedemptionEntryOrderItemsItem applicationDetails(List<ApplicationDetailsItem> applicationDetails) {
    
    this.applicationDetails = applicationDetails;
    return this;
  }

  public RedemptionEntryOrderItemsItem addApplicationDetailsItem(ApplicationDetailsItem applicationDetailsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RedemptionEntryOrderItemsItem redemptionEntryOrderItemsItem = (RedemptionEntryOrderItemsItem) o;
    return Objects.equals(this.id, redemptionEntryOrderItemsItem.id) &&
        Objects.equals(this.skuId, redemptionEntryOrderItemsItem.skuId) &&
        Objects.equals(this.productId, redemptionEntryOrderItemsItem.productId) &&
        Objects.equals(this.relatedObject, redemptionEntryOrderItemsItem.relatedObject) &&
        Objects.equals(this.sourceId, redemptionEntryOrderItemsItem.sourceId) &&
        Objects.equals(this.quantity, redemptionEntryOrderItemsItem.quantity) &&
        Objects.equals(this.discountQuantity, redemptionEntryOrderItemsItem.discountQuantity) &&
        Objects.equals(this.initialQuantity, redemptionEntryOrderItemsItem.initialQuantity) &&
        Objects.equals(this.amount, redemptionEntryOrderItemsItem.amount) &&
        Objects.equals(this.discountAmount, redemptionEntryOrderItemsItem.discountAmount) &&
        Objects.equals(this.appliedDiscountAmount, redemptionEntryOrderItemsItem.appliedDiscountAmount) &&
        Objects.equals(this.appliedDiscountQuantity, redemptionEntryOrderItemsItem.appliedDiscountQuantity) &&
        Objects.equals(this.appliedQuantity, redemptionEntryOrderItemsItem.appliedQuantity) &&
        Objects.equals(this.appliedQuantityAmount, redemptionEntryOrderItemsItem.appliedQuantityAmount) &&
        Objects.equals(this.initialAmount, redemptionEntryOrderItemsItem.initialAmount) &&
        Objects.equals(this.price, redemptionEntryOrderItemsItem.price) &&
        Objects.equals(this.subtotalAmount, redemptionEntryOrderItemsItem.subtotalAmount) &&
        Objects.equals(this.product, redemptionEntryOrderItemsItem.product) &&
        Objects.equals(this.sku, redemptionEntryOrderItemsItem.sku) &&
        Objects.equals(this._object, redemptionEntryOrderItemsItem._object) &&
        Objects.equals(this.metadata, redemptionEntryOrderItemsItem.metadata) &&
        Objects.equals(this.applicationDetails, redemptionEntryOrderItemsItem.applicationDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionEntryOrderItemsItem {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionEntryOrderItemsItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionEntryOrderItemsItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionEntryOrderItemsItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionEntryOrderItemsItem.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionEntryOrderItemsItem>() {
           @Override
           public void write(JsonWriter out, RedemptionEntryOrderItemsItem value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionEntryOrderItemsItem.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionEntryOrderItemsItem.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionEntryOrderItemsItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedemptionEntryOrderItemsItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionEntryOrderItemsItem
  * @throws IOException if the JSON string is invalid with respect to RedemptionEntryOrderItemsItem
  */
  public static RedemptionEntryOrderItemsItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionEntryOrderItemsItem.class);
  }

 /**
  * Convert an instance of RedemptionEntryOrderItemsItem to an JSON string
  *
  * @return JSON string
  */
