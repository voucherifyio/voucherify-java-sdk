...
public class ProductsSkusUpdateRequestBody {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sku, price, currency, attributes, imageUrl, metadata);
  }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductsSkusUpdateRequestBody>() {
           ...
           public void write(JsonWriter out, ProductsSkusUpdateRequestBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ProductsSkusUpdateRequestBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ProductsSkusUpdateRequestBody.class.getDeclaredField(fieldName + "IsSet");
