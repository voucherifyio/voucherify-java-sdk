...
public class ProductsSkusUpdateRequestBody {
  ...
  **/
   ...
   * @return the ProductsSkusUpdateRequestBody instance itself
   */
  public ProductsSkusUpdateRequestBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductsSkusUpdateRequestBody productsSkusUpdateRequestBody = (ProductsSkusUpdateRequestBody) o;
    return Objects.equals(this.sku, productsSkusUpdateRequestBody.sku) &&
        Objects.equals(this.price, productsSkusUpdateRequestBody.price) &&
        Objects.equals(this.currency, productsSkusUpdateRequestBody.currency) &&
        Objects.equals(this.attributes, productsSkusUpdateRequestBody.attributes) &&
        Objects.equals(this.imageUrl, productsSkusUpdateRequestBody.imageUrl) &&
        Objects.equals(this.metadata, productsSkusUpdateRequestBody.metadata)&&
        Objects.equals(this.additionalProperties, productsSkusUpdateRequestBody.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sku, price, currency, attributes, imageUrl, metadata, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductsSkusUpdateRequestBody {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductsSkusUpdateRequestBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductsSkusUpdateRequestBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductsSkusUpdateRequestBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductsSkusUpdateRequestBody.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductsSkusUpdateRequestBody>() {
           @Override
           public void write(JsonWriter out, ProductsSkusUpdateRequestBody value) throws IOException {
  ...
  * @return An instance of ProductsSkusUpdateRequestBody
  * @throws IOException if the JSON string is invalid with respect to ProductsSkusUpdateRequestBody
  */
  public static ProductsSkusUpdateRequestBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductsSkusUpdateRequestBody.class);
  }
