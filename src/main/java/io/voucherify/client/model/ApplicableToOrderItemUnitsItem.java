    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ApplicableToOrderItemUnitsItem>() {
           ...
           public void write(JsonWriter out, ApplicableToOrderItemUnitsItem value) throws IOException {
            ...
            for (Field field : ApplicableToOrderItemUnitsItem.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ApplicableToOrderItemUnitsItem.class.getDeclaredField(fieldName + "IsSet");
