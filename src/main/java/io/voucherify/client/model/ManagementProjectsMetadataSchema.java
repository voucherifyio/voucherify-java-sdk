...
public class ManagementProjectsMetadataSchema {
  ...
  public ManagementProjectsMetadataSchema() {
  }

  public ManagementProjectsMetadataSchema id(String id) {
  ...
  **/
  ...
  public ManagementProjectsMetadataSchema relatedObject(String relatedObject) {
  ...
  **/
  ...
  public ManagementProjectsMetadataSchema properties(Map<String, ManagementProjectsMetadataSchemaDefinition> properties) {
    
    this.properties = properties;
    return this;
  }

  public ManagementProjectsMetadataSchema putPropertiesItem(String key, ManagementProjectsMetadataSchemaDefinition propertiesItem) {
  ...
  **/
  ...
  public ManagementProjectsMetadataSchema allowDefinedOnly(Boolean allowDefinedOnly) {
  ...
  **/
  ...
  public ManagementProjectsMetadataSchema createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ManagementProjectsMetadataSchema updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ManagementProjectsMetadataSchema _object(String _object) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsMetadataSchema managementProjectsMetadataSchema = (ManagementProjectsMetadataSchema) o;
    return Objects.equals(this.id, managementProjectsMetadataSchema.id) &&
        Objects.equals(this.relatedObject, managementProjectsMetadataSchema.relatedObject) &&
        Objects.equals(this.properties, managementProjectsMetadataSchema.properties) &&
        Objects.equals(this.allowDefinedOnly, managementProjectsMetadataSchema.allowDefinedOnly) &&
        Objects.equals(this.createdAt, managementProjectsMetadataSchema.createdAt) &&
        Objects.equals(this.updatedAt, managementProjectsMetadataSchema.updatedAt) &&
        Objects.equals(this._object, managementProjectsMetadataSchema._object);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagementProjectsMetadataSchema {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsMetadataSchema.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsMetadataSchema' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsMetadataSchema> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsMetadataSchema.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsMetadataSchema>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsMetadataSchema value) throws IOException {
            ...
            for (Field field : ManagementProjectsMetadataSchema.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectsMetadataSchema.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ManagementProjectsMetadataSchema read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagementProjectsMetadataSchema given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagementProjectsMetadataSchema
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsMetadataSchema
  */
  public static ManagementProjectsMetadataSchema fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsMetadataSchema.class);
  }

 /**
  * Convert an instance of ManagementProjectsMetadataSchema to an JSON string
  *
  * @return JSON string
  */
