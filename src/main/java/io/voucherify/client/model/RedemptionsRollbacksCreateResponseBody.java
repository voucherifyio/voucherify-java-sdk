    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionsRollbacksCreateResponseBody>() {
           ...
           public void write(JsonWriter out, RedemptionsRollbacksCreateResponseBody value) throws IOException {
            ...
            for (Field field : RedemptionsRollbacksCreateResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionsRollbacksCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
