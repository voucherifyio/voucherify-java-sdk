       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListBinResourceId>() {
           ...
           public void write(JsonWriter out, ParameterFiltersListBinResourceId value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ParameterFiltersListBinResourceId.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ParameterFiltersListBinResourceId.class.getDeclaredField(fieldName + "IsSet");
