       ...
       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsCreateRequestBodyApiUsageNotifications>() {
           ...
           public void write(JsonWriter out, ManagementProjectsCreateRequestBodyApiUsageNotifications value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ManagementProjectsCreateRequestBodyApiUsageNotifications.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ManagementProjectsCreateRequestBodyApiUsageNotifications.class.getDeclaredField(fieldName + "IsSet");
