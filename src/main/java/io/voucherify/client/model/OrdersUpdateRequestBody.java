...
public class OrdersUpdateRequestBody {
  ...
  **/
  ...
  public OrdersUpdateRequestBody items(List<OrderItemEssential> items) {
    
    this.items = items;
    return this;
  }

  public OrdersUpdateRequestBody addItemsItem(OrderItemEssential itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceId, status, amount, initialAmount, discountAmount, items, metadata, createdAt, referrerId, customer, referrer, additionalProperties);
  }
