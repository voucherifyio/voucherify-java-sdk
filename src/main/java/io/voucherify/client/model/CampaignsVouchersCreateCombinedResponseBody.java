...
public class CampaignsVouchersCreateCombinedResponseBody {
  ...
  **/
   ...
   * @return the CampaignsVouchersCreateCombinedResponseBody instance itself
   */
  public CampaignsVouchersCreateCombinedResponseBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, campaignsVouchersCreateCombinedResponseBody.id) &&
        ...
        Objects.equals(this.additionalProperties, campaignsVouchersCreateCombinedResponseBody.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, code, campaign, campaignId, category, categoryId, type, discount, gift, loyaltyCard, startDate, expirationDate, validityTimeframe, validityDayOfWeek, validityHours, active, additionalInfo, metadata, assets, isReferralCode, createdAt, updatedAt, holderId, referrerId, _object, publish, redemption, categories, validationRulesAssignments, asyncActionId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignsVouchersCreateCombinedResponseBody>() {
           ...
           public CampaignsVouchersCreateCombinedResponseBody read(JsonReader in) throws IOException {
             ...
             CampaignsVouchersCreateCombinedResponseBody instance = thisAdapter.fromJsonTree(jsonObj);
