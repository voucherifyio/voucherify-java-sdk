...
public class VouchersEnableResponseBodyLoyaltyCard {
  ...
  public VouchersEnableResponseBodyLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public VouchersEnableResponseBodyLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public VouchersEnableResponseBodyLoyaltyCard nextExpirationDate(LocalDate nextExpirationDate) {
  ...
  **/
  ...
  public VouchersEnableResponseBodyLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public VouchersEnableResponseBodyLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public VouchersEnableResponseBodyLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public VouchersEnableResponseBodyLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VouchersEnableResponseBodyLoyaltyCard vouchersEnableResponseBodyLoyaltyCard = (VouchersEnableResponseBodyLoyaltyCard) o;
    return Objects.equals(this.points, vouchersEnableResponseBodyLoyaltyCard.points) &&
        Objects.equals(this.balance, vouchersEnableResponseBodyLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, vouchersEnableResponseBodyLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, vouchersEnableResponseBodyLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, vouchersEnableResponseBodyLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, vouchersEnableResponseBodyLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, vouchersEnableResponseBodyLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class VouchersEnableResponseBodyLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VouchersEnableResponseBodyLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VouchersEnableResponseBodyLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VouchersEnableResponseBodyLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VouchersEnableResponseBodyLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<VouchersEnableResponseBodyLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, VouchersEnableResponseBodyLoyaltyCard value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VouchersEnableResponseBodyLoyaltyCard.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VouchersEnableResponseBodyLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public VouchersEnableResponseBodyLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VouchersEnableResponseBodyLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VouchersEnableResponseBodyLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to VouchersEnableResponseBodyLoyaltyCard
  */
  public static VouchersEnableResponseBodyLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VouchersEnableResponseBodyLoyaltyCard.class);
  }

 /**
  * Convert an instance of VouchersEnableResponseBodyLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
