    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsMetadataSchemasUpdateRequestBody>() {
           ...
           public void write(JsonWriter out, ManagementProjectsMetadataSchemasUpdateRequestBody value) throws IOException {
            ...
            for (Field field : ManagementProjectsMetadataSchemasUpdateRequestBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectsMetadataSchemasUpdateRequestBody.class.getDeclaredField(fieldName + "IsSet");
