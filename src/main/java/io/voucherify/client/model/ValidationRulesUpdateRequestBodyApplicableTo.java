    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidationRulesUpdateRequestBodyApplicableTo>() {
           ...
           public void write(JsonWriter out, ValidationRulesUpdateRequestBodyApplicableTo value) throws IOException {
            ...
            for (Field field : ValidationRulesUpdateRequestBodyApplicableTo.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ValidationRulesUpdateRequestBodyApplicableTo.class.getDeclaredField(fieldName + "IsSet");
