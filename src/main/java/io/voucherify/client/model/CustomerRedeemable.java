...
public class CustomerRedeemable {
  ...
  private CustomerRedeemableRedeemable redeemable;
    private boolean redeemableIsSet = false;
  ...
  **/
  ...
  public boolean isRedeemableSet() {
    return redeemableIsSet;
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerRedeemable>() {
           ...
           public void write(JsonWriter out, CustomerRedeemable value) throws IOException {
            ...
            for (Field field : CustomerRedeemable.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = CustomerRedeemable.class.getDeclaredField(fieldName + "IsSet");
