...
public class VoucherLoyaltyCard {
  ...
  **/
  ...
  public VoucherLoyaltyCard pendingPoints(Integer pendingPoints) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VoucherLoyaltyCard>() {
           ...
           public void write(JsonWriter out, VoucherLoyaltyCard value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VoucherLoyaltyCard.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VoucherLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
