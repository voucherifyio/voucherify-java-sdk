    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignsVouchersCreateResponseBodyLoyaltyCard>() {
           ...
           public void write(JsonWriter out, CampaignsVouchersCreateResponseBodyLoyaltyCard value) throws IOException {
            ...
            for (Field field : CampaignsVouchersCreateResponseBodyLoyaltyCard.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = CampaignsVouchersCreateResponseBodyLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
