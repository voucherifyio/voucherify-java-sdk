...
public class RewardAssignmentParameters {
  ...
  **/
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RewardAssignmentParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RewardAssignmentParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RewardAssignmentParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RewardAssignmentParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<RewardAssignmentParameters>() {
           @Override
           public void write(JsonWriter out, RewardAssignmentParameters value) throws IOException {
            ...
            for (Field field : RewardAssignmentParameters.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RewardAssignmentParameters.class.getDeclaredField(fieldName + "IsSet");
 ...
 /**
  * Create an instance of RewardAssignmentParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RewardAssignmentParameters
  * @throws IOException if the JSON string is invalid with respect to RewardAssignmentParameters
  */
  public static RewardAssignmentParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RewardAssignmentParameters.class);
  }

 /**
  * Convert an instance of RewardAssignmentParameters to an JSON string
  *
  * @return JSON string
  */
