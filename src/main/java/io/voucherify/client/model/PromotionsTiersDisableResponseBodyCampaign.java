       ...
       return (TypeAdapter<T>) new TypeAdapter<PromotionsTiersDisableResponseBodyCampaign>() {
           ...
           public void write(JsonWriter out, PromotionsTiersDisableResponseBodyCampaign value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : PromotionsTiersDisableResponseBodyCampaign.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = PromotionsTiersDisableResponseBodyCampaign.class.getDeclaredField(fieldName + "IsSet");
