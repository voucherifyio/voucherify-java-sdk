       ...
       return (TypeAdapter<T>) new TypeAdapter<VoucherTransactionsExportFilterConditionsVoucherId>() {
           ...
           public void write(JsonWriter out, VoucherTransactionsExportFilterConditionsVoucherId value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VoucherTransactionsExportFilterConditionsVoucherId.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VoucherTransactionsExportFilterConditionsVoucherId.class.getDeclaredField(fieldName + "IsSet");
