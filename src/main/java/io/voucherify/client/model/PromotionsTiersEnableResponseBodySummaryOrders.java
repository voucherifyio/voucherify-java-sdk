       ...
       return (TypeAdapter<T>) new TypeAdapter<PromotionsTiersEnableResponseBodySummaryOrders>() {
           ...
           public void write(JsonWriter out, PromotionsTiersEnableResponseBodySummaryOrders value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : PromotionsTiersEnableResponseBodySummaryOrders.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = PromotionsTiersEnableResponseBodySummaryOrders.class.getDeclaredField(fieldName + "IsSet");
