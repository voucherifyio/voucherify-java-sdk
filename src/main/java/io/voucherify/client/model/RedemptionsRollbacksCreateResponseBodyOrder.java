...
public class RedemptionsRollbacksCreateResponseBodyOrder {
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder() {
  }

  public RedemptionsRollbacksCreateResponseBodyOrder id(String id) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder status(StatusEnum status) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder amount(Integer amount) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder metadata(Object metadata) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder customerId(String customerId) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder customer(CustomerId customer) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder referrer(ReferrerId referrer) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public RedemptionsRollbacksCreateResponseBodyOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public RedemptionsRollbacksCreateResponseBodyOrder items(List<OrderCalculatedItem> items) {
    
    this.items = items;
    return this;
  }

  public RedemptionsRollbacksCreateResponseBodyOrder addItemsItem(OrderCalculatedItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RedemptionsRollbacksCreateResponseBodyOrder redemptionsRollbacksCreateResponseBodyOrder = (RedemptionsRollbacksCreateResponseBodyOrder) o;
    return Objects.equals(this.id, redemptionsRollbacksCreateResponseBodyOrder.id) &&
        Objects.equals(this.sourceId, redemptionsRollbacksCreateResponseBodyOrder.sourceId) &&
        Objects.equals(this.status, redemptionsRollbacksCreateResponseBodyOrder.status) &&
        Objects.equals(this.amount, redemptionsRollbacksCreateResponseBodyOrder.amount) &&
        Objects.equals(this.initialAmount, redemptionsRollbacksCreateResponseBodyOrder.initialAmount) &&
        Objects.equals(this.discountAmount, redemptionsRollbacksCreateResponseBodyOrder.discountAmount) &&
        Objects.equals(this.itemsDiscountAmount, redemptionsRollbacksCreateResponseBodyOrder.itemsDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, redemptionsRollbacksCreateResponseBodyOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAmount, redemptionsRollbacksCreateResponseBodyOrder.totalAmount) &&
        Objects.equals(this.appliedDiscountAmount, redemptionsRollbacksCreateResponseBodyOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, redemptionsRollbacksCreateResponseBodyOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, redemptionsRollbacksCreateResponseBodyOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.metadata, redemptionsRollbacksCreateResponseBodyOrder.metadata) &&
        Objects.equals(this._object, redemptionsRollbacksCreateResponseBodyOrder._object) &&
        Objects.equals(this.createdAt, redemptionsRollbacksCreateResponseBodyOrder.createdAt) &&
        Objects.equals(this.updatedAt, redemptionsRollbacksCreateResponseBodyOrder.updatedAt) &&
        Objects.equals(this.customerId, redemptionsRollbacksCreateResponseBodyOrder.customerId) &&
        Objects.equals(this.referrerId, redemptionsRollbacksCreateResponseBodyOrder.referrerId) &&
        Objects.equals(this.customer, redemptionsRollbacksCreateResponseBodyOrder.customer) &&
        Objects.equals(this.referrer, redemptionsRollbacksCreateResponseBodyOrder.referrer) &&
        Objects.equals(this.redemptions, redemptionsRollbacksCreateResponseBodyOrder.redemptions) &&
        Objects.equals(this.items, redemptionsRollbacksCreateResponseBodyOrder.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionsRollbacksCreateResponseBodyOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionsRollbacksCreateResponseBodyOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionsRollbacksCreateResponseBodyOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionsRollbacksCreateResponseBodyOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionsRollbacksCreateResponseBodyOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionsRollbacksCreateResponseBodyOrder>() {
           @Override
           public void write(JsonWriter out, RedemptionsRollbacksCreateResponseBodyOrder value) throws IOException {
            ...
            for (Field field : RedemptionsRollbacksCreateResponseBodyOrder.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionsRollbacksCreateResponseBodyOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionsRollbacksCreateResponseBodyOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedemptionsRollbacksCreateResponseBodyOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionsRollbacksCreateResponseBodyOrder
  * @throws IOException if the JSON string is invalid with respect to RedemptionsRollbacksCreateResponseBodyOrder
  */
  public static RedemptionsRollbacksCreateResponseBodyOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionsRollbacksCreateResponseBodyOrder.class);
  }

 /**
  * Convert an instance of RedemptionsRollbacksCreateResponseBodyOrder to an JSON string
  *
  * @return JSON string
  */
