    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomersUpdateResponseBody>() {
           ...
           public void write(JsonWriter out, CustomersUpdateResponseBody value) throws IOException {
            ...
            for (Field field : CustomersUpdateResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = CustomersUpdateResponseBody.class.getDeclaredField(fieldName + "IsSet");
