       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesEarningRulesUpdateResponseBody>() {
           ...
           public void write(JsonWriter out, LoyaltiesEarningRulesUpdateResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : LoyaltiesEarningRulesUpdateResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = LoyaltiesEarningRulesUpdateResponseBody.class.getDeclaredField(fieldName + "IsSet");
