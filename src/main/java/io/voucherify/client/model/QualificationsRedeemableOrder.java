...
import io.voucherify.client.model.QualificationsRedeemableOrderItemsItem;
...
public class QualificationsRedeemableOrder {
  ...
  private List<QualificationsRedeemableOrderItemsItem> items;
    private boolean itemsIsSet = false;

  public QualificationsRedeemableOrder() {
  }

  public QualificationsRedeemableOrder id(String id) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder status(StatusEnum status) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder amount(Integer amount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder metadata(Object metadata) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder customerId(String customerId) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder customer(CustomerId customer) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder referrer(ReferrerId referrer) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public QualificationsRedeemableOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public QualificationsRedeemableOrder items(List<QualificationsRedeemableOrderItemsItem> items) {
    
    this.items = items;
    return this;
  }

  public QualificationsRedeemableOrder addItemsItem(QualificationsRedeemableOrderItemsItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<QualificationsRedeemableOrderItemsItem> getItems() {
    return items;
  }


  public void setItems(List<QualificationsRedeemableOrderItemsItem> items) {
    this.items = items;
  ...
  public boolean equals(Object o) {
    ...
    QualificationsRedeemableOrder qualificationsRedeemableOrder = (QualificationsRedeemableOrder) o;
    return Objects.equals(this.id, qualificationsRedeemableOrder.id) &&
        Objects.equals(this.sourceId, qualificationsRedeemableOrder.sourceId) &&
        Objects.equals(this.status, qualificationsRedeemableOrder.status) &&
        Objects.equals(this.amount, qualificationsRedeemableOrder.amount) &&
        Objects.equals(this.initialAmount, qualificationsRedeemableOrder.initialAmount) &&
        Objects.equals(this.discountAmount, qualificationsRedeemableOrder.discountAmount) &&
        Objects.equals(this.itemsDiscountAmount, qualificationsRedeemableOrder.itemsDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, qualificationsRedeemableOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAmount, qualificationsRedeemableOrder.totalAmount) &&
        Objects.equals(this.appliedDiscountAmount, qualificationsRedeemableOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, qualificationsRedeemableOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, qualificationsRedeemableOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.metadata, qualificationsRedeemableOrder.metadata) &&
        Objects.equals(this._object, qualificationsRedeemableOrder._object) &&
        Objects.equals(this.createdAt, qualificationsRedeemableOrder.createdAt) &&
        Objects.equals(this.updatedAt, qualificationsRedeemableOrder.updatedAt) &&
        Objects.equals(this.customerId, qualificationsRedeemableOrder.customerId) &&
        Objects.equals(this.referrerId, qualificationsRedeemableOrder.referrerId) &&
        Objects.equals(this.customer, qualificationsRedeemableOrder.customer) &&
        Objects.equals(this.referrer, qualificationsRedeemableOrder.referrer) &&
        Objects.equals(this.redemptions, qualificationsRedeemableOrder.redemptions) &&
        Objects.equals(this.items, qualificationsRedeemableOrder.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class QualificationsRedeemableOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QualificationsRedeemableOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QualificationsRedeemableOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QualificationsRedeemableOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QualificationsRedeemableOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<QualificationsRedeemableOrder>() {
           @Override
           public void write(JsonWriter out, QualificationsRedeemableOrder value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : QualificationsRedeemableOrder.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = QualificationsRedeemableOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public QualificationsRedeemableOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of QualificationsRedeemableOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of QualificationsRedeemableOrder
  * @throws IOException if the JSON string is invalid with respect to QualificationsRedeemableOrder
  */
  public static QualificationsRedeemableOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QualificationsRedeemableOrder.class);
  }

 /**
  * Convert an instance of QualificationsRedeemableOrder to an JSON string
  *
  * @return JSON string
  */
