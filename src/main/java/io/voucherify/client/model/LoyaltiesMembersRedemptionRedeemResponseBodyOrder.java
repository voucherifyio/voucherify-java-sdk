...
import io.voucherify.client.model.LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer;
import io.voucherify.client.model.LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem;
import io.voucherify.client.model.LoyaltiesMembersRedemptionRedeemResponseBodyOrderReferrer;
...
public class LoyaltiesMembersRedemptionRedeemResponseBodyOrder {
  ...
  private LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer customer;
  ...
  private LoyaltiesMembersRedemptionRedeemResponseBodyOrderReferrer referrer;
    private boolean referrerIsSet = false;
  ...
  private List<LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem> items;
    private boolean itemsIsSet = false;

  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder() {
  }

  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder id(String id) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder status(StatusEnum status) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder amount(Integer amount) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder itemsAppliedDiscountAmount(Integer itemsAppliedDiscountAmount) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder totalAppliedDiscountAmount(Integer totalAppliedDiscountAmount) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder metadata(Object metadata) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder customerId(String customerId) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder customer(LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer customer) {
  ...
  **/
  @javax.annotation.Nullable
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer getCustomer() {
    return customer;
  }


  public void setCustomer(LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer customer) {
    this.customer = customer;
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder referrer(LoyaltiesMembersRedemptionRedeemResponseBodyOrderReferrer referrer) {
  ...
  **/
  @javax.annotation.Nullable
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrderReferrer getReferrer() {
    return referrer;
  }


  public void setReferrer(LoyaltiesMembersRedemptionRedeemResponseBodyOrderReferrer referrer) {
    this.referrer = referrer;
    this.referrerIsSet = true;
  }
  public boolean isReferrerSet() {
    return referrerIsSet;
  }


  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder redemptions(Map<String, OrderRedemptionsEntry> redemptions) {
    
    this.redemptions = redemptions;
    return this;
  }

  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder putRedemptionsItem(String key, OrderRedemptionsEntry redemptionsItem) {
  ...
  **/
  ...
  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder items(List<LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem> items) {
    
    this.items = items;
    return this;
  }

  public LoyaltiesMembersRedemptionRedeemResponseBodyOrder addItemsItem(LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem> getItems() {
    return items;
  }


  public void setItems(List<LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem> items) {
    this.items = items;
  ...
  public boolean equals(Object o) {
    ...
    LoyaltiesMembersRedemptionRedeemResponseBodyOrder loyaltiesMembersRedemptionRedeemResponseBodyOrder = (LoyaltiesMembersRedemptionRedeemResponseBodyOrder) o;
    return Objects.equals(this.id, loyaltiesMembersRedemptionRedeemResponseBodyOrder.id) &&
        Objects.equals(this.sourceId, loyaltiesMembersRedemptionRedeemResponseBodyOrder.sourceId) &&
        Objects.equals(this.status, loyaltiesMembersRedemptionRedeemResponseBodyOrder.status) &&
        Objects.equals(this.amount, loyaltiesMembersRedemptionRedeemResponseBodyOrder.amount) &&
        Objects.equals(this.initialAmount, loyaltiesMembersRedemptionRedeemResponseBodyOrder.initialAmount) &&
        Objects.equals(this.discountAmount, loyaltiesMembersRedemptionRedeemResponseBodyOrder.discountAmount) &&
        Objects.equals(this.itemsDiscountAmount, loyaltiesMembersRedemptionRedeemResponseBodyOrder.itemsDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, loyaltiesMembersRedemptionRedeemResponseBodyOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAmount, loyaltiesMembersRedemptionRedeemResponseBodyOrder.totalAmount) &&
        Objects.equals(this.appliedDiscountAmount, loyaltiesMembersRedemptionRedeemResponseBodyOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, loyaltiesMembersRedemptionRedeemResponseBodyOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, loyaltiesMembersRedemptionRedeemResponseBodyOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.metadata, loyaltiesMembersRedemptionRedeemResponseBodyOrder.metadata) &&
        Objects.equals(this._object, loyaltiesMembersRedemptionRedeemResponseBodyOrder._object) &&
        Objects.equals(this.createdAt, loyaltiesMembersRedemptionRedeemResponseBodyOrder.createdAt) &&
        Objects.equals(this.updatedAt, loyaltiesMembersRedemptionRedeemResponseBodyOrder.updatedAt) &&
        Objects.equals(this.customerId, loyaltiesMembersRedemptionRedeemResponseBodyOrder.customerId) &&
        Objects.equals(this.referrerId, loyaltiesMembersRedemptionRedeemResponseBodyOrder.referrerId) &&
        Objects.equals(this.customer, loyaltiesMembersRedemptionRedeemResponseBodyOrder.customer) &&
        Objects.equals(this.referrer, loyaltiesMembersRedemptionRedeemResponseBodyOrder.referrer) &&
        Objects.equals(this.redemptions, loyaltiesMembersRedemptionRedeemResponseBodyOrder.redemptions) &&
        Objects.equals(this.items, loyaltiesMembersRedemptionRedeemResponseBodyOrder.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoyaltiesMembersRedemptionRedeemResponseBodyOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoyaltiesMembersRedemptionRedeemResponseBodyOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoyaltiesMembersRedemptionRedeemResponseBodyOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoyaltiesMembersRedemptionRedeemResponseBodyOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoyaltiesMembersRedemptionRedeemResponseBodyOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesMembersRedemptionRedeemResponseBodyOrder>() {
           @Override
           public void write(JsonWriter out, LoyaltiesMembersRedemptionRedeemResponseBodyOrder value) throws IOException {
            ...
            for (Field field : LoyaltiesMembersRedemptionRedeemResponseBodyOrder.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltiesMembersRedemptionRedeemResponseBodyOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public LoyaltiesMembersRedemptionRedeemResponseBodyOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoyaltiesMembersRedemptionRedeemResponseBodyOrder
  * @throws IOException if the JSON string is invalid with respect to LoyaltiesMembersRedemptionRedeemResponseBodyOrder
  */
  public static LoyaltiesMembersRedemptionRedeemResponseBodyOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoyaltiesMembersRedemptionRedeemResponseBodyOrder.class);
  }

 /**
  * Convert an instance of LoyaltiesMembersRedemptionRedeemResponseBodyOrder to an JSON string
  *
  * @return JSON string
  */
