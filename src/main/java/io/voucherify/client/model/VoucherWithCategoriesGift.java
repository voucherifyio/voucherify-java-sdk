...
public class VoucherWithCategoriesGift {
  ...
  public VoucherWithCategoriesGift() {
  }

  public VoucherWithCategoriesGift amount(Integer amount) {
  ...
  **/
  ...
  public VoucherWithCategoriesGift subtractedAmount(Integer subtractedAmount) {
  ...
  **/
  ...
  public VoucherWithCategoriesGift balance(Integer balance) {
  ...
  **/
  ...
  public VoucherWithCategoriesGift effect(EffectEnum effect) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VoucherWithCategoriesGift voucherWithCategoriesGift = (VoucherWithCategoriesGift) o;
    return Objects.equals(this.amount, voucherWithCategoriesGift.amount) &&
        Objects.equals(this.subtractedAmount, voucherWithCategoriesGift.subtractedAmount) &&
        Objects.equals(this.balance, voucherWithCategoriesGift.balance) &&
        Objects.equals(this.effect, voucherWithCategoriesGift.effect);
  }
  ...
  public String toString() {
    ...
    sb.append("class VoucherWithCategoriesGift {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VoucherWithCategoriesGift.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VoucherWithCategoriesGift' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VoucherWithCategoriesGift> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VoucherWithCategoriesGift.class));

       return (TypeAdapter<T>) new TypeAdapter<VoucherWithCategoriesGift>() {
           @Override
           public void write(JsonWriter out, VoucherWithCategoriesGift value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VoucherWithCategoriesGift.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VoucherWithCategoriesGift.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public VoucherWithCategoriesGift read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VoucherWithCategoriesGift given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VoucherWithCategoriesGift
  * @throws IOException if the JSON string is invalid with respect to VoucherWithCategoriesGift
  */
  public static VoucherWithCategoriesGift fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VoucherWithCategoriesGift.class);
  }

 /**
  * Convert an instance of VoucherWithCategoriesGift to an JSON string
  *
  * @return JSON string
  */
