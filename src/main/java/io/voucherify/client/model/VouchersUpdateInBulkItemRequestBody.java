       ...
       return (TypeAdapter<T>) new TypeAdapter<VouchersUpdateInBulkItemRequestBody>() {
           ...
           public void write(JsonWriter out, VouchersUpdateInBulkItemRequestBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VouchersUpdateInBulkItemRequestBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VouchersUpdateInBulkItemRequestBody.class.getDeclaredField(fieldName + "IsSet");
