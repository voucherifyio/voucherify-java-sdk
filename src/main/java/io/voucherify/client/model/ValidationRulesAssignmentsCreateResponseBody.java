       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidationRulesAssignmentsCreateResponseBody>() {
           ...
           public void write(JsonWriter out, ValidationRulesAssignmentsCreateResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ValidationRulesAssignmentsCreateResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ValidationRulesAssignmentsCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
