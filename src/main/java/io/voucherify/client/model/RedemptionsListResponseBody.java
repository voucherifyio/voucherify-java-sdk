       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionsListResponseBody>() {
           ...
           public void write(JsonWriter out, RedemptionsListResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionsListResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionsListResponseBody.class.getDeclaredField(fieldName + "IsSet");
