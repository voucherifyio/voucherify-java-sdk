...
import io.voucherify.client.model.LoyaltiesRewardsGetResponseBodyParameters;
...
public class LoyaltiesRewardsGetResponseBody {
  ...
  private LoyaltiesRewardsGetResponseBodyParameters parameters;
  ...
  **/
  @javax.annotation.Nullable
  public LoyaltiesRewardsGetResponseBodyParameters getParameters() {
    return parameters;
  }


  public void setParameters(LoyaltiesRewardsGetResponseBodyParameters parameters) {
    this.parameters = parameters;
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesRewardsGetResponseBody>() {
           ...
           public void write(JsonWriter out, LoyaltiesRewardsGetResponseBody value) throws IOException {
            ...
            for (Field field : LoyaltiesRewardsGetResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltiesRewardsGetResponseBody.class.getDeclaredField(fieldName + "IsSet");
