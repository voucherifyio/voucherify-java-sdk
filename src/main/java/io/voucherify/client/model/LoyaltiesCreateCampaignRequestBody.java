    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesCreateCampaignRequestBody>() {
           ...
           public void write(JsonWriter out, LoyaltiesCreateCampaignRequestBody value) throws IOException {
            ...
            for (Field field : LoyaltiesCreateCampaignRequestBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltiesCreateCampaignRequestBody.class.getDeclaredField(fieldName + "IsSet");
