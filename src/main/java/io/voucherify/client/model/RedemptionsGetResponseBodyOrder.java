...
import io.voucherify.client.model.RedemptionsGetResponseBodyOrderItemsItem;
...
public class RedemptionsGetResponseBodyOrder {
  ...
  private List<RedemptionsGetResponseBodyOrderItemsItem> items;
    private boolean itemsIsSet = false;

  public RedemptionsGetResponseBodyOrder() {
  }

  public RedemptionsGetResponseBodyOrder id(String id) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder sourceId(String sourceId) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder status(StatusEnum status) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder amount(Integer amount) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder itemsDiscountAmount(Integer itemsDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder totalDiscountAmount(Integer totalDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder totalAmount(Integer totalAmount) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder metadata(Object metadata) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder _object(ObjectEnum _object) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder customerId(String customerId) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder referrerId(String referrerId) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyOrder items(List<RedemptionsGetResponseBodyOrderItemsItem> items) {
    
    this.items = items;
    return this;
  }

  public RedemptionsGetResponseBodyOrder addItemsItem(RedemptionsGetResponseBodyOrderItemsItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<RedemptionsGetResponseBodyOrderItemsItem> getItems() {
    return items;
  }


  public void setItems(List<RedemptionsGetResponseBodyOrderItemsItem> items) {
    this.items = items;
  ...
  public boolean equals(Object o) {
    ...
    RedemptionsGetResponseBodyOrder redemptionsGetResponseBodyOrder = (RedemptionsGetResponseBodyOrder) o;
    return Objects.equals(this.id, redemptionsGetResponseBodyOrder.id) &&
        Objects.equals(this.sourceId, redemptionsGetResponseBodyOrder.sourceId) &&
        Objects.equals(this.status, redemptionsGetResponseBodyOrder.status) &&
        Objects.equals(this.amount, redemptionsGetResponseBodyOrder.amount) &&
        Objects.equals(this.initialAmount, redemptionsGetResponseBodyOrder.initialAmount) &&
        Objects.equals(this.discountAmount, redemptionsGetResponseBodyOrder.discountAmount) &&
        Objects.equals(this.itemsDiscountAmount, redemptionsGetResponseBodyOrder.itemsDiscountAmount) &&
        Objects.equals(this.totalDiscountAmount, redemptionsGetResponseBodyOrder.totalDiscountAmount) &&
        Objects.equals(this.totalAmount, redemptionsGetResponseBodyOrder.totalAmount) &&
        Objects.equals(this.appliedDiscountAmount, redemptionsGetResponseBodyOrder.appliedDiscountAmount) &&
        Objects.equals(this.itemsAppliedDiscountAmount, redemptionsGetResponseBodyOrder.itemsAppliedDiscountAmount) &&
        Objects.equals(this.totalAppliedDiscountAmount, redemptionsGetResponseBodyOrder.totalAppliedDiscountAmount) &&
        Objects.equals(this.metadata, redemptionsGetResponseBodyOrder.metadata) &&
        Objects.equals(this._object, redemptionsGetResponseBodyOrder._object) &&
        Objects.equals(this.createdAt, redemptionsGetResponseBodyOrder.createdAt) &&
        Objects.equals(this.updatedAt, redemptionsGetResponseBodyOrder.updatedAt) &&
        Objects.equals(this.customerId, redemptionsGetResponseBodyOrder.customerId) &&
        Objects.equals(this.referrerId, redemptionsGetResponseBodyOrder.referrerId) &&
        Objects.equals(this.customer, redemptionsGetResponseBodyOrder.customer) &&
        Objects.equals(this.referrer, redemptionsGetResponseBodyOrder.referrer) &&
        Objects.equals(this.redemptions, redemptionsGetResponseBodyOrder.redemptions) &&
        Objects.equals(this.items, redemptionsGetResponseBodyOrder.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionsGetResponseBodyOrder {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionsGetResponseBodyOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionsGetResponseBodyOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionsGetResponseBodyOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionsGetResponseBodyOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionsGetResponseBodyOrder>() {
           @Override
           public void write(JsonWriter out, RedemptionsGetResponseBodyOrder value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionsGetResponseBodyOrder.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionsGetResponseBodyOrder.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionsGetResponseBodyOrder read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedemptionsGetResponseBodyOrder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionsGetResponseBodyOrder
  * @throws IOException if the JSON string is invalid with respect to RedemptionsGetResponseBodyOrder
  */
  public static RedemptionsGetResponseBodyOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionsGetResponseBodyOrder.class);
  }

 /**
  * Convert an instance of RedemptionsGetResponseBodyOrder to an JSON string
  *
  * @return JSON string
  */
