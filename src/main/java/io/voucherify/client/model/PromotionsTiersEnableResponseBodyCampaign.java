    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PromotionsTiersEnableResponseBodyCampaign>() {
           ...
           public void write(JsonWriter out, PromotionsTiersEnableResponseBodyCampaign value) throws IOException {
            ...
            for (Field field : PromotionsTiersEnableResponseBodyCampaign.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = PromotionsTiersEnableResponseBodyCampaign.class.getDeclaredField(fieldName + "IsSet");
