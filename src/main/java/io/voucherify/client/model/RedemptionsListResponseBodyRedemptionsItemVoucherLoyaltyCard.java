...
public class RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard {
  ...
  public RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard() {
  }

  public RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard nextExpirationDate(LocalDate nextExpirationDate) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard redemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard = (RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard) o;
    return Objects.equals(this.points, redemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.points) &&
        Objects.equals(this.balance, redemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, redemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, redemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, redemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, redemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, redemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard
  */
  public static RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.class);
  }

 /**
  * Convert an instance of RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
