       ...
       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsCustomEventSchemasCreateRequestBodySchema>() {
           ...
           public void write(JsonWriter out, ManagementProjectsCustomEventSchemasCreateRequestBodySchema value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ManagementProjectsCustomEventSchemasCreateRequestBodySchema.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ManagementProjectsCustomEventSchemasCreateRequestBodySchema.class.getDeclaredField(fieldName + "IsSet");
