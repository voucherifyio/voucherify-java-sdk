       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterCreatedBeforeAfter>() {
           ...
           public void write(JsonWriter out, ParameterCreatedBeforeAfter value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ParameterCreatedBeforeAfter.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ParameterCreatedBeforeAfter.class.getDeclaredField(fieldName + "IsSet");
