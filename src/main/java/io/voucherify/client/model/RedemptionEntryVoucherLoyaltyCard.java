...
public class RedemptionEntryVoucherLoyaltyCard {
  ...
  public RedemptionEntryVoucherLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public RedemptionEntryVoucherLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public RedemptionEntryVoucherLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public RedemptionEntryVoucherLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RedemptionEntryVoucherLoyaltyCard redemptionEntryVoucherLoyaltyCard = (RedemptionEntryVoucherLoyaltyCard) o;
    return Objects.equals(this.points, redemptionEntryVoucherLoyaltyCard.points) &&
        Objects.equals(this.balance, redemptionEntryVoucherLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, redemptionEntryVoucherLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, redemptionEntryVoucherLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, redemptionEntryVoucherLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, redemptionEntryVoucherLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, redemptionEntryVoucherLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionEntryVoucherLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionEntryVoucherLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionEntryVoucherLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionEntryVoucherLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionEntryVoucherLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionEntryVoucherLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, RedemptionEntryVoucherLoyaltyCard value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionEntryVoucherLoyaltyCard.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionEntryVoucherLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionEntryVoucherLoyaltyCard read(JsonReader in) throws IOException {
  ...
  * @return An instance of RedemptionEntryVoucherLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to RedemptionEntryVoucherLoyaltyCard
  */
  public static RedemptionEntryVoucherLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionEntryVoucherLoyaltyCard.class);
  }
