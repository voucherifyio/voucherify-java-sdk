...
public class EarningRuleBaseSource {
  ...
  **/
   ...
   * @return the EarningRuleBaseSource instance itself
   */
  public EarningRuleBaseSource putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EarningRuleBaseSource>() {
           ...
           public EarningRuleBaseSource read(JsonReader in) throws IOException {
             ...
             EarningRuleBaseSource instance = thisAdapter.fromJsonTree(jsonObj);
