       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListRedemptionsRelatedObjectId>() {
           ...
           public void write(JsonWriter out, ParameterFiltersListRedemptionsRelatedObjectId value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ParameterFiltersListRedemptionsRelatedObjectId.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ParameterFiltersListRedemptionsRelatedObjectId.class.getDeclaredField(fieldName + "IsSet");
