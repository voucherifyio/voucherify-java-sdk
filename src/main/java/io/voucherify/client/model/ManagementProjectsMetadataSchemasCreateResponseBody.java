...
public class ManagementProjectsMetadataSchemasCreateResponseBody {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsMetadataSchemasCreateResponseBody managementProjectsMetadataSchemasCreateResponseBody = (ManagementProjectsMetadataSchemasCreateResponseBody) o;
    return Objects.equals(this.id, managementProjectsMetadataSchemasCreateResponseBody.id) &&
        Objects.equals(this.relatedObject, managementProjectsMetadataSchemasCreateResponseBody.relatedObject) &&
        Objects.equals(this.properties, managementProjectsMetadataSchemasCreateResponseBody.properties) &&
        Objects.equals(this.allowDefinedOnly, managementProjectsMetadataSchemasCreateResponseBody.allowDefinedOnly) &&
        Objects.equals(this.createdAt, managementProjectsMetadataSchemasCreateResponseBody.createdAt) &&
        Objects.equals(this.updatedAt, managementProjectsMetadataSchemasCreateResponseBody.updatedAt) &&
        Objects.equals(this._object, managementProjectsMetadataSchemasCreateResponseBody._object);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagementProjectsMetadataSchemasCreateResponseBody {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsMetadataSchemasCreateResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsMetadataSchemasCreateResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsMetadataSchemasCreateResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsMetadataSchemasCreateResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsMetadataSchemasCreateResponseBody>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsMetadataSchemasCreateResponseBody value) throws IOException {
            ...
            for (Field field : ManagementProjectsMetadataSchemasCreateResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectsMetadataSchemasCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ManagementProjectsMetadataSchemasCreateResponseBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagementProjectsMetadataSchemasCreateResponseBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagementProjectsMetadataSchemasCreateResponseBody
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsMetadataSchemasCreateResponseBody
  */
  public static ManagementProjectsMetadataSchemasCreateResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsMetadataSchemasCreateResponseBody.class);
  }

 /**
  * Convert an instance of ManagementProjectsMetadataSchemasCreateResponseBody to an JSON string
  *
  * @return JSON string
  */
