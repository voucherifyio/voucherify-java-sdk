...
import io.voucherify.client.model.RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct;
import io.voucherify.client.model.RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku;
...
public class RedemptionsListResponseBodyRedemptionsItemOrderItemsItem {
  ...
  private RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct product;

  public static final String SERIALIZED_NAME_SKU = "sku";
  @SerializedName(SERIALIZED_NAME_SKU)
  private RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku sku;
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem() {
  }

  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem id(String id) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem skuId(String skuId) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem productId(String productId) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem relatedObject(RelatedObjectEnum relatedObject) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem sourceId(String sourceId) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem quantity(Integer quantity) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem discountQuantity(Integer discountQuantity) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem initialQuantity(Integer initialQuantity) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem amount(Integer amount) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem discountAmount(Integer discountAmount) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem appliedDiscountAmount(Integer appliedDiscountAmount) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem appliedDiscountQuantity(Integer appliedDiscountQuantity) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem appliedQuantity(Integer appliedQuantity) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem appliedQuantityAmount(Integer appliedQuantityAmount) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem initialAmount(Integer initialAmount) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem price(Integer price) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem subtotalAmount(Integer subtotalAmount) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem product(RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct product) {
  ...
  **/
  @javax.annotation.Nullable
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct getProduct() {
    return product;
  }


  public void setProduct(RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct product) {
    this.product = product;
  }


  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem sku(RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku sku) {
  ...
  **/
  @javax.annotation.Nullable
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku getSku() {
    return sku;
  }


  public void setSku(RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku sku) {
    this.sku = sku;
  }


  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem _object(ObjectEnum _object) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem metadata(Object metadata) {
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem applicationDetails(List<ApplicationDetailsItem> applicationDetails) {
    
    this.applicationDetails = applicationDetails;
    return this;
  }

  public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem addApplicationDetailsItem(ApplicationDetailsItem applicationDetailsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RedemptionsListResponseBodyRedemptionsItemOrderItemsItem redemptionsListResponseBodyRedemptionsItemOrderItemsItem = (RedemptionsListResponseBodyRedemptionsItemOrderItemsItem) o;
    return Objects.equals(this.id, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.id) &&
        Objects.equals(this.skuId, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.skuId) &&
        Objects.equals(this.productId, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.productId) &&
        Objects.equals(this.relatedObject, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.relatedObject) &&
        Objects.equals(this.sourceId, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.sourceId) &&
        Objects.equals(this.quantity, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.quantity) &&
        Objects.equals(this.discountQuantity, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.discountQuantity) &&
        Objects.equals(this.initialQuantity, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.initialQuantity) &&
        Objects.equals(this.amount, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.amount) &&
        Objects.equals(this.discountAmount, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.discountAmount) &&
        Objects.equals(this.appliedDiscountAmount, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.appliedDiscountAmount) &&
        Objects.equals(this.appliedDiscountQuantity, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.appliedDiscountQuantity) &&
        Objects.equals(this.appliedQuantity, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.appliedQuantity) &&
        Objects.equals(this.appliedQuantityAmount, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.appliedQuantityAmount) &&
        Objects.equals(this.initialAmount, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.initialAmount) &&
        Objects.equals(this.price, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.price) &&
        Objects.equals(this.subtotalAmount, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.subtotalAmount) &&
        Objects.equals(this.product, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.product) &&
        Objects.equals(this.sku, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.sku) &&
        Objects.equals(this._object, redemptionsListResponseBodyRedemptionsItemOrderItemsItem._object) &&
        Objects.equals(this.metadata, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.metadata) &&
        Objects.equals(this.applicationDetails, redemptionsListResponseBodyRedemptionsItemOrderItemsItem.applicationDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionsListResponseBodyRedemptionsItemOrderItemsItem {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionsListResponseBodyRedemptionsItemOrderItemsItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionsListResponseBodyRedemptionsItemOrderItemsItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionsListResponseBodyRedemptionsItemOrderItemsItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionsListResponseBodyRedemptionsItemOrderItemsItem.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionsListResponseBodyRedemptionsItemOrderItemsItem>() {
           @Override
           public void write(JsonWriter out, RedemptionsListResponseBodyRedemptionsItemOrderItemsItem value) throws IOException {
            ...
            for (Field field : RedemptionsListResponseBodyRedemptionsItemOrderItemsItem.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RedemptionsListResponseBodyRedemptionsItemOrderItemsItem.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedemptionsListResponseBodyRedemptionsItemOrderItemsItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionsListResponseBodyRedemptionsItemOrderItemsItem
  * @throws IOException if the JSON string is invalid with respect to RedemptionsListResponseBodyRedemptionsItemOrderItemsItem
  */
  public static RedemptionsListResponseBodyRedemptionsItemOrderItemsItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionsListResponseBodyRedemptionsItemOrderItemsItem.class);
  }

 /**
  * Convert an instance of RedemptionsListResponseBodyRedemptionsItemOrderItemsItem to an JSON string
  *
  * @return JSON string
  */
