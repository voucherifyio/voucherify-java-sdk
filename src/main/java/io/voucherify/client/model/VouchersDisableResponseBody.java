    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VouchersDisableResponseBody>() {
           ...
           public void write(JsonWriter out, VouchersDisableResponseBody value) throws IOException {
            ...
            for (Field field : VouchersDisableResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = VouchersDisableResponseBody.class.getDeclaredField(fieldName + "IsSet");
