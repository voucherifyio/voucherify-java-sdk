...
public class CampaignsImportVoucherItem {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, redemption, active, metadata, category, startDate, expirationDate, validityTimeframe, validityDayOfWeek, additionalInfo, type, loyaltyCard, gift, discount);
  }
       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignsImportVoucherItem>() {
           ...
           public void write(JsonWriter out, CampaignsImportVoucherItem value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : CampaignsImportVoucherItem.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = CampaignsImportVoucherItem.class.getDeclaredField(fieldName + "IsSet");
