    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignsImportVoucherItemRedemption>() {
           ...
           public void write(JsonWriter out, CampaignsImportVoucherItemRedemption value) throws IOException {
            ...
            for (Field field : CampaignsImportVoucherItemRedemption.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = CampaignsImportVoucherItemRedemption.class.getDeclaredField(fieldName + "IsSet");
