    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesPointsExpirationExportCreateRequestBodyParameters>() {
           ...
           public void write(JsonWriter out, LoyaltiesPointsExpirationExportCreateRequestBodyParameters value) throws IOException {
            ...
            for (Field field : LoyaltiesPointsExpirationExportCreateRequestBodyParameters.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltiesPointsExpirationExportCreateRequestBodyParameters.class.getDeclaredField(fieldName + "IsSet");
