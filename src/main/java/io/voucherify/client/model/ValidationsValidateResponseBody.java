       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidationsValidateResponseBody>() {
           ...
           public void write(JsonWriter out, ValidationsValidateResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ValidationsValidateResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ValidationsValidateResponseBody.class.getDeclaredField(fieldName + "IsSet");
