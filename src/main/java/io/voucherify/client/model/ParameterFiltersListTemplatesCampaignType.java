    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListTemplatesCampaignType>() {
           ...
           public void write(JsonWriter out, ParameterFiltersListTemplatesCampaignType value) throws IOException {
            ...
            for (Field field : ParameterFiltersListTemplatesCampaignType.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ParameterFiltersListTemplatesCampaignType.class.getDeclaredField(fieldName + "IsSet");
