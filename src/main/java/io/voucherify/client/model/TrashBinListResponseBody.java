...
import io.voucherify.client.model.TrashBinItem;
...
public class TrashBinListResponseBody {
  ...
  private List<TrashBinItem> data;
  ...
  **/
  ...
  public TrashBinListResponseBody addDataItem(TrashBinItem dataItem) {
    if (this.data == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<TrashBinItem> getData() {
    return data;
  }


  public void setData(List<TrashBinItem> data) {
    this.data = data;
    this.dataIsSet = true;
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TrashBinListResponseBody>() {
           ...
           public void write(JsonWriter out, TrashBinListResponseBody value) throws IOException {
            ...
            for (Field field : TrashBinListResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = TrashBinListResponseBody.class.getDeclaredField(fieldName + "IsSet");
