...
public class ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem {
  ...
  public ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem() {
  }
  ...
  **/
  ...
  public ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem addApplicationDetailsItem(ApplicationDetailsItem applicationDetailsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem clientQualificationsCheckEligibilityResponseBodyOrderItemsItem = (ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem) o;
    return Objects.equals(this.id, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.id) &&
        Objects.equals(this.skuId, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.skuId) &&
        Objects.equals(this.productId, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.productId) &&
        Objects.equals(this.relatedObject, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.relatedObject) &&
        Objects.equals(this.sourceId, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.sourceId) &&
        Objects.equals(this.quantity, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.quantity) &&
        Objects.equals(this.discountQuantity, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.discountQuantity) &&
        Objects.equals(this.initialQuantity, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.initialQuantity) &&
        Objects.equals(this.amount, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.amount) &&
        Objects.equals(this.discountAmount, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.discountAmount) &&
        Objects.equals(this.appliedDiscountAmount, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.appliedDiscountAmount) &&
        Objects.equals(this.appliedDiscountQuantity, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.appliedDiscountQuantity) &&
        Objects.equals(this.appliedQuantity, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.appliedQuantity) &&
        Objects.equals(this.appliedQuantityAmount, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.appliedQuantityAmount) &&
        Objects.equals(this.initialAmount, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.initialAmount) &&
        Objects.equals(this.price, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.price) &&
        Objects.equals(this.subtotalAmount, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.subtotalAmount) &&
        Objects.equals(this.product, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.product) &&
        Objects.equals(this.sku, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.sku) &&
        Objects.equals(this._object, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem._object) &&
        Objects.equals(this.metadata, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.metadata) &&
        Objects.equals(this.applicationDetails, clientQualificationsCheckEligibilityResponseBodyOrderItemsItem.applicationDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem>() {
           @Override
           public void write(JsonWriter out, ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem value) throws IOException {
            ...
            for (Field field : ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem
  * @throws IOException if the JSON string is invalid with respect to ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem
  */
  public static ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem.class);
  }

 /**
  * Convert an instance of ClientQualificationsCheckEligibilityResponseBodyOrderItemsItem to an JSON string
  *
  * @return JSON string
  */
