    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PromotionsTiersEnableResponseBody>() {
           ...
           public void write(JsonWriter out, PromotionsTiersEnableResponseBody value) throws IOException {
            ...
            for (Field field : PromotionsTiersEnableResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = PromotionsTiersEnableResponseBody.class.getDeclaredField(fieldName + "IsSet");
