       ...
       return (TypeAdapter<T>) new TypeAdapter<PromotionsTiersUpdateResponseBodyCampaign>() {
           ...
           public void write(JsonWriter out, PromotionsTiersUpdateResponseBodyCampaign value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : PromotionsTiersUpdateResponseBodyCampaign.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = PromotionsTiersUpdateResponseBodyCampaign.class.getDeclaredField(fieldName + "IsSet");
