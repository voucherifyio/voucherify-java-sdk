...
public class ParameterFiltersListTemplatesCampaignTypeConditions {
  ...
  public ParameterFiltersListTemplatesCampaignTypeConditions() {
  }

  public ParameterFiltersListTemplatesCampaignTypeConditions $in(List<InEnum> $in) {
    
    this.$in = $in;
    return this;
  }

  public ParameterFiltersListTemplatesCampaignTypeConditions add$InItem(InEnum $inItem) {
    if (this.$in == null) {
  ...
  **/
  ...
  public ParameterFiltersListTemplatesCampaignTypeConditions $notIn(List<NotInEnum> $notIn) {
    
    this.$notIn = $notIn;
    return this;
  }

  public ParameterFiltersListTemplatesCampaignTypeConditions add$NotInItem(NotInEnum $notInItem) {
    if (this.$notIn == null) {
  ...
  **/
  ...
  public ParameterFiltersListTemplatesCampaignTypeConditions $is(IsEnum $is) {
  ...
  **/
  ...
  public ParameterFiltersListTemplatesCampaignTypeConditions $isNot(IsNotEnum $isNot) {
  ...
  **/
  ...
  public ParameterFiltersListTemplatesCampaignTypeConditions $hasValue(String $hasValue) {
  ...
  **/
  ...
  public ParameterFiltersListTemplatesCampaignTypeConditions $isUnknown(String $isUnknown) {
  ...
  **/
  ...
  public ParameterFiltersListTemplatesCampaignTypeConditions $startsWith(String $startsWith) {
  ...
  **/
  ...
  public ParameterFiltersListTemplatesCampaignTypeConditions $endsWith(String $endsWith) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ParameterFiltersListTemplatesCampaignTypeConditions parameterFiltersListTemplatesCampaignTypeConditions = (ParameterFiltersListTemplatesCampaignTypeConditions) o;
    return Objects.equals(this.$in, parameterFiltersListTemplatesCampaignTypeConditions.$in) &&
        Objects.equals(this.$notIn, parameterFiltersListTemplatesCampaignTypeConditions.$notIn) &&
        Objects.equals(this.$is, parameterFiltersListTemplatesCampaignTypeConditions.$is) &&
        Objects.equals(this.$isNot, parameterFiltersListTemplatesCampaignTypeConditions.$isNot) &&
        Objects.equals(this.$hasValue, parameterFiltersListTemplatesCampaignTypeConditions.$hasValue) &&
        Objects.equals(this.$isUnknown, parameterFiltersListTemplatesCampaignTypeConditions.$isUnknown) &&
        Objects.equals(this.$startsWith, parameterFiltersListTemplatesCampaignTypeConditions.$startsWith) &&
        Objects.equals(this.$endsWith, parameterFiltersListTemplatesCampaignTypeConditions.$endsWith);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParameterFiltersListTemplatesCampaignTypeConditions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParameterFiltersListTemplatesCampaignTypeConditions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParameterFiltersListTemplatesCampaignTypeConditions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParameterFiltersListTemplatesCampaignTypeConditions.class));

       return (TypeAdapter<T>) new TypeAdapter<ParameterFiltersListTemplatesCampaignTypeConditions>() {
           @Override
           public void write(JsonWriter out, ParameterFiltersListTemplatesCampaignTypeConditions value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : ParameterFiltersListTemplatesCampaignTypeConditions.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = ParameterFiltersListTemplatesCampaignTypeConditions.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ParameterFiltersListTemplatesCampaignTypeConditions read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ParameterFiltersListTemplatesCampaignTypeConditions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ParameterFiltersListTemplatesCampaignTypeConditions
  * @throws IOException if the JSON string is invalid with respect to ParameterFiltersListTemplatesCampaignTypeConditions
  */
  public static ParameterFiltersListTemplatesCampaignTypeConditions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ParameterFiltersListTemplatesCampaignTypeConditions.class);
  }

 /**
  * Convert an instance of ParameterFiltersListTemplatesCampaignTypeConditions to an JSON string
  *
  * @return JSON string
  */
