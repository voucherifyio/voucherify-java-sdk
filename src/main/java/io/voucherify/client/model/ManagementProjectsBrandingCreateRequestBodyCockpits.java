...
public class ManagementProjectsBrandingCreateRequestBodyCockpits {
  ...
  **/
  ...
  public ManagementProjectsBrandingCreateRequestBodyCockpits loyaltyEnabled(Boolean loyaltyEnabled) {
  ...
  **/
  ...
  public ManagementProjectsBrandingCreateRequestBodyCockpits couponsEnabled(Boolean couponsEnabled) {
  ...
  **/
  ...
  public ManagementProjectsBrandingCreateRequestBodyCockpits theme(ThemeEnum theme) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsBrandingCreateRequestBodyCockpits managementProjectsBrandingCreateRequestBodyCockpits = (ManagementProjectsBrandingCreateRequestBodyCockpits) o;
    return Objects.equals(this.campaignsOverviewEnabled, managementProjectsBrandingCreateRequestBodyCockpits.campaignsOverviewEnabled) &&
        Objects.equals(this.loyaltyEnabled, managementProjectsBrandingCreateRequestBodyCockpits.loyaltyEnabled) &&
        Objects.equals(this.giftCardsEnabled, managementProjectsBrandingCreateRequestBodyCockpits.giftCardsEnabled) &&
        Objects.equals(this.couponsEnabled, managementProjectsBrandingCreateRequestBodyCockpits.couponsEnabled) &&
        Objects.equals(this.referralsEnabled, managementProjectsBrandingCreateRequestBodyCockpits.referralsEnabled) &&
        Objects.equals(this.theme, managementProjectsBrandingCreateRequestBodyCockpits.theme) &&
        Objects.equals(this.useCustomDoubleOptInRedirectUrl, managementProjectsBrandingCreateRequestBodyCockpits.useCustomDoubleOptInRedirectUrl) &&
        Objects.equals(this.customDoubleOptInRedirectUrl, managementProjectsBrandingCreateRequestBodyCockpits.customDoubleOptInRedirectUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManagementProjectsBrandingCreateRequestBodyCockpits {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsBrandingCreateRequestBodyCockpits.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsBrandingCreateRequestBodyCockpits' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsBrandingCreateRequestBodyCockpits> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsBrandingCreateRequestBodyCockpits.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsBrandingCreateRequestBodyCockpits>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsBrandingCreateRequestBodyCockpits value) throws IOException {
            ...
            for (Field field : ManagementProjectsBrandingCreateRequestBodyCockpits.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectsBrandingCreateRequestBodyCockpits.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ManagementProjectsBrandingCreateRequestBodyCockpits read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagementProjectsBrandingCreateRequestBodyCockpits given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagementProjectsBrandingCreateRequestBodyCockpits
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsBrandingCreateRequestBodyCockpits
  */
  public static ManagementProjectsBrandingCreateRequestBodyCockpits fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsBrandingCreateRequestBodyCockpits.class);
  }

 /**
  * Convert an instance of ManagementProjectsBrandingCreateRequestBodyCockpits to an JSON string
  *
  * @return JSON string
  */
