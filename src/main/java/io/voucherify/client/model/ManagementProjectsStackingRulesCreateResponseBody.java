...
public class ManagementProjectsStackingRulesCreateResponseBody {
  ...
  public ManagementProjectsStackingRulesCreateResponseBody id(String id) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateResponseBody redeemablesLimit(Integer redeemablesLimit) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateResponseBody applicableRedeemablesCategoryLimits(Map<String, Integer> applicableRedeemablesCategoryLimits) {
  ...
  public ManagementProjectsStackingRulesCreateResponseBody putApplicableRedeemablesCategoryLimitsItem(String key, Integer applicableRedeemablesCategoryLimitsItem) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateResponseBody discountCalculationMode(DiscountCalculationModeEnum discountCalculationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateResponseBody redeemablesApplicationMode(RedeemablesApplicationModeEnum redeemablesApplicationMode) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateResponseBody redeemablesSortingRule(RedeemablesSortingRuleEnum redeemablesSortingRule) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateResponseBody createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ManagementProjectsStackingRulesCreateResponseBody updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ManagementProjectsStackingRulesCreateResponseBody managementProjectsStackingRulesCreateResponseBody = (ManagementProjectsStackingRulesCreateResponseBody) o;
    return Objects.equals(this.id, managementProjectsStackingRulesCreateResponseBody.id) &&
        Objects.equals(this.exclusiveCategories, managementProjectsStackingRulesCreateResponseBody.exclusiveCategories) &&
        Objects.equals(this.jointCategories, managementProjectsStackingRulesCreateResponseBody.jointCategories) &&
        Objects.equals(this.redeemablesLimit, managementProjectsStackingRulesCreateResponseBody.redeemablesLimit) &&
        Objects.equals(this.applicableRedeemablesLimit, managementProjectsStackingRulesCreateResponseBody.applicableRedeemablesLimit) &&
        Objects.equals(this.applicableRedeemablesPerCategoryLimit, managementProjectsStackingRulesCreateResponseBody.applicableRedeemablesPerCategoryLimit) &&
        Objects.equals(this.applicableRedeemablesCategoryLimits, managementProjectsStackingRulesCreateResponseBody.applicableRedeemablesCategoryLimits) &&
        Objects.equals(this.applicableExclusiveRedeemablesLimit, managementProjectsStackingRulesCreateResponseBody.applicableExclusiveRedeemablesLimit) &&
        Objects.equals(this.applicableExclusiveRedeemablesPerCategoryLimit, managementProjectsStackingRulesCreateResponseBody.applicableExclusiveRedeemablesPerCategoryLimit) &&
        Objects.equals(this.discountCalculationMode, managementProjectsStackingRulesCreateResponseBody.discountCalculationMode) &&
        Objects.equals(this.initialAmountModeCategories, managementProjectsStackingRulesCreateResponseBody.initialAmountModeCategories) &&
  ...
  public String toString() {
    ...
    sb.append("class ManagementProjectsStackingRulesCreateResponseBody {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ManagementProjectsStackingRulesCreateResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ManagementProjectsStackingRulesCreateResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ManagementProjectsStackingRulesCreateResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ManagementProjectsStackingRulesCreateResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<ManagementProjectsStackingRulesCreateResponseBody>() {
           @Override
           public void write(JsonWriter out, ManagementProjectsStackingRulesCreateResponseBody value) throws IOException {
            ...
            for (Field field : ManagementProjectsStackingRulesCreateResponseBody.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = ManagementProjectsStackingRulesCreateResponseBody.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public ManagementProjectsStackingRulesCreateResponseBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ManagementProjectsStackingRulesCreateResponseBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ManagementProjectsStackingRulesCreateResponseBody
  * @throws IOException if the JSON string is invalid with respect to ManagementProjectsStackingRulesCreateResponseBody
  */
  public static ManagementProjectsStackingRulesCreateResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ManagementProjectsStackingRulesCreateResponseBody.class);
  }

 /**
  * Convert an instance of ManagementProjectsStackingRulesCreateResponseBody to an JSON string
  *
  * @return JSON string
  */
