    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltiesMembersRedemptionRedeemResponseBodyRelatedRedemptions>() {
           ...
           public void write(JsonWriter out, LoyaltiesMembersRedemptionRedeemResponseBodyRelatedRedemptions value) throws IOException {
            ...
            for (Field field : LoyaltiesMembersRedemptionRedeemResponseBodyRelatedRedemptions.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = LoyaltiesMembersRedemptionRedeemResponseBodyRelatedRedemptions.class.getDeclaredField(fieldName + "IsSet");
