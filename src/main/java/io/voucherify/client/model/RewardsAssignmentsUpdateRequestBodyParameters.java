    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RewardsAssignmentsUpdateRequestBodyParameters>() {
           ...
           public void write(JsonWriter out, RewardsAssignmentsUpdateRequestBodyParameters value) throws IOException {
            ...
            for (Field field : RewardsAssignmentsUpdateRequestBodyParameters.class.getDeclaredFields()) {
              String fieldName = field.getName();
              if (fieldName.endsWith("IsSet")) continue;
              try {
                Field isSetField = RewardsAssignmentsUpdateRequestBodyParameters.class.getDeclaredField(fieldName + "IsSet");
