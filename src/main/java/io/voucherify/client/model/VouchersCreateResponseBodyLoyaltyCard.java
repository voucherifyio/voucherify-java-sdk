...
public class VouchersCreateResponseBodyLoyaltyCard {
  ...
  public VouchersCreateResponseBodyLoyaltyCard() {
  }

  public VouchersCreateResponseBodyLoyaltyCard points(Integer points) {
  ...
  **/
  ...
  public VouchersCreateResponseBodyLoyaltyCard balance(Integer balance) {
  ...
  **/
  ...
  public VouchersCreateResponseBodyLoyaltyCard nextExpirationDate(LocalDate nextExpirationDate) {
  ...
  **/
  ...
  public VouchersCreateResponseBodyLoyaltyCard nextExpirationPoints(Integer nextExpirationPoints) {
  ...
  **/
  ...
  public VouchersCreateResponseBodyLoyaltyCard pendingPoints(Integer pendingPoints) {
  ...
  **/
  ...
  public VouchersCreateResponseBodyLoyaltyCard expiredPoints(Integer expiredPoints) {
  ...
  **/
  ...
  public VouchersCreateResponseBodyLoyaltyCard subtractedPoints(Integer subtractedPoints) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VouchersCreateResponseBodyLoyaltyCard vouchersCreateResponseBodyLoyaltyCard = (VouchersCreateResponseBodyLoyaltyCard) o;
    return Objects.equals(this.points, vouchersCreateResponseBodyLoyaltyCard.points) &&
        Objects.equals(this.balance, vouchersCreateResponseBodyLoyaltyCard.balance) &&
        Objects.equals(this.nextExpirationDate, vouchersCreateResponseBodyLoyaltyCard.nextExpirationDate) &&
        Objects.equals(this.nextExpirationPoints, vouchersCreateResponseBodyLoyaltyCard.nextExpirationPoints) &&
        Objects.equals(this.pendingPoints, vouchersCreateResponseBodyLoyaltyCard.pendingPoints) &&
        Objects.equals(this.expiredPoints, vouchersCreateResponseBodyLoyaltyCard.expiredPoints) &&
        Objects.equals(this.subtractedPoints, vouchersCreateResponseBodyLoyaltyCard.subtractedPoints);
  }
  ...
  public String toString() {
    ...
    sb.append("class VouchersCreateResponseBodyLoyaltyCard {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VouchersCreateResponseBodyLoyaltyCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VouchersCreateResponseBodyLoyaltyCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VouchersCreateResponseBodyLoyaltyCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VouchersCreateResponseBodyLoyaltyCard.class));

       return (TypeAdapter<T>) new TypeAdapter<VouchersCreateResponseBodyLoyaltyCard>() {
           @Override
           public void write(JsonWriter out, VouchersCreateResponseBodyLoyaltyCard value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : VouchersCreateResponseBodyLoyaltyCard.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = VouchersCreateResponseBodyLoyaltyCard.class.getDeclaredField(fieldName + "IsSet");
           ...
           @Override
           public VouchersCreateResponseBodyLoyaltyCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VouchersCreateResponseBodyLoyaltyCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VouchersCreateResponseBodyLoyaltyCard
  * @throws IOException if the JSON string is invalid with respect to VouchersCreateResponseBodyLoyaltyCard
  */
  public static VouchersCreateResponseBodyLoyaltyCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VouchersCreateResponseBodyLoyaltyCard.class);
  }

 /**
  * Convert an instance of VouchersCreateResponseBodyLoyaltyCard to an JSON string
  *
  * @return JSON string
  */
