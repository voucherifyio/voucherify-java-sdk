       ...
       return (TypeAdapter<T>) new TypeAdapter<RewardsAssignmentsListResponseBody>() {
           ...
           public void write(JsonWriter out, RewardsAssignmentsListResponseBody value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RewardsAssignmentsListResponseBody.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RewardsAssignmentsListResponseBody.class.getDeclaredField(fieldName + "IsSet");
