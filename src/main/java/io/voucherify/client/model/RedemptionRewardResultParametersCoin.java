       ...
       return (TypeAdapter<T>) new TypeAdapter<RedemptionRewardResultParametersCoin>() {
           ...
           public void write(JsonWriter out, RedemptionRewardResultParametersCoin value) throws IOException {
            ...
            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              ...
              for (Field field : RedemptionRewardResultParametersCoin.class.getDeclaredFields()) {
                String fieldName = field.getName();
                if (fieldName.endsWith("IsSet")) continue;

                try {
                  Field isSetField = RedemptionRewardResultParametersCoin.class.getDeclaredField(fieldName + "IsSet");
