...
public class RedemptionRewardResultParametersCoin {
  ...
  **/
   ...
   * @return the RedemptionRewardResultParametersCoin instance itself
   */
  public RedemptionRewardResultParametersCoin putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RedemptionRewardResultParametersCoin redemptionRewardResultParametersCoin = (RedemptionRewardResultParametersCoin) o;
    return Objects.equals(this.exchangeRatio, redemptionRewardResultParametersCoin.exchangeRatio) &&
        Objects.equals(this.pointsRatio, redemptionRewardResultParametersCoin.pointsRatio)&&
        Objects.equals(this.additionalProperties, redemptionRewardResultParametersCoin.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedemptionRewardResultParametersCoin {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionRewardResultParametersCoin.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionRewardResultParametersCoin' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionRewardResultParametersCoin> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionRewardResultParametersCoin.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionRewardResultParametersCoin>() {
           @Override
           public void write(JsonWriter out, RedemptionRewardResultParametersCoin value) throws IOException {
           ...
           @Override
           public RedemptionRewardResultParametersCoin read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RedemptionRewardResultParametersCoin instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  * @return An instance of RedemptionRewardResultParametersCoin
  * @throws IOException if the JSON string is invalid with respect to RedemptionRewardResultParametersCoin
  */
  public static RedemptionRewardResultParametersCoin fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionRewardResultParametersCoin.class);
  }
