...
public class LoyaltiesModule extends AbsModule<ExtAsync, ExtRxJava> {
    ...
    public class ExtAsync extends AbsModule.Async {
        ...
        public void delete(String id, DeleteCampaignParams deleteCampaignParams, VoucherifyCallback<Void> callback) {
        ...
        public void update(String id, UpdateCampaign updateCampaign, VoucherifyCallback<CampaignResponse> callback) {
            RxUtils.subscribe(executor, rx().update(id, updateCampaign), callback);
        }

        public void createRewardAssignment(String id, List<CreateRewardAssignment> create, VoucherifyCallback<RewardAssignmentResponse> callback) {
            RxUtils.subscribe(executor, rx().createRewardAssignment(id, create), callback);
        }

        public void updateRewardAssignment(String id, String assignmentId, UpdateRewardAssignment update, VoucherifyCallback<RewardAssignmentResponse> callback) {
            RxUtils.subscribe(executor, rx().updateRewardAssignment(id, assignmentId, update), callback);
        }

        public void deleteRewardAssignment(String id, String assignmentId, VoucherifyCallback<Void> callback) {
            RxUtils.subscribe(executor, rx().deleteRewardAssignment(id, assignmentId), callback);
        }

        public void listRewardAssignments(String id, RewardsAssignmentsFilter filter, VoucherifyCallback<ListRewardAssignmentsResponse> callback) {
            RxUtils.subscribe(executor, rx().listRewardAssignments(id, filter), callback);
        }

        public void createEarningRules(String id, List<CreateEarningRule> create, VoucherifyCallback<EarningRuleResponse> callback) {
            RxUtils.subscribe(executor, rx().createEarningRules(id, create), callback);
        }

        public void updateEarningRule(String id, String ruleId, UpdateEarningRule update, VoucherifyCallback<EarningRuleResponse> callback) {
        ...
        public void listEarningRules(String id, EarningRulesFilter filter, VoucherifyCallback<ListEarningRulesResponse> callback) {
            RxUtils.subscribe(executor, rx().listEarningRules(id, filter), callback);
        }

        public void addMember(String id, AddMember addMember, VoucherifyCallback<VoucherResponse> callback) {
            RxUtils.subscribe(executor, rx().addMember(id, addMember), callback);
        }

        public void listMembers(String id, MembersFilter filter, VoucherifyCallback<VouchersResponse> callback) {
            RxUtils.subscribe(executor, rx().listMembers(id, filter), callback);
        }

        public void getMember(String id, String memberId, VoucherifyCallback<VoucherResponse> callback) {
            RxUtils.subscribe(executor, rx().getMember(id, memberId), callback);
        }

        public void redeemReward(String id, String memberId, RedeemReward redeemReward, VoucherifyCallback<RedeemVoucherResponse> callback) {
            RxUtils.subscribe(executor, rx().redeemReward(id, memberId, redeemReward), callback);
        }

        public void addLoyaltyCardBalance(String id, String memberId, AddBalance addBalance, VoucherifyCallback<AddBalanceResponse> callback) {
    ...
    public class ExtRxJava extends AbsModule.Rx {
        ...
        public Observable<Void> delete(final String id, final DeleteCampaignParams deleteCampaignParams) {
        ...
        public Observable<CampaignResponse> update(final String id, final UpdateCampaign updateCampaign) {
            return RxUtils.defer(new RxUtils.DefFunc<CampaignResponse>() {
                @Override
                public CampaignResponse method() {
        ...
        public Observable<RewardAssignmentResponse> createRewardAssignment(final String id, final List<CreateRewardAssignment> createRewardAssignment) {
        ...
        public Observable<ListRewardAssignmentsResponse> listRewardAssignments(final String id, final RewardsAssignmentsFilter filter) {
        ...
        public Observable<EarningRuleResponse> createEarningRules(final String id, final List<CreateEarningRule> create) {
        ...
        public Observable<ListEarningRulesResponse> listEarningRules(final String id, final EarningRulesFilter filter) {
            return RxUtils.defer(new RxUtils.DefFunc<ListEarningRulesResponse>() {
                @Override
        ...
        public Observable<RedeemVoucherResponse> redeemReward(final String id, final String memberId, final RedeemReward redeemReward) {
        ...
        public Observable<AddBalanceResponse> addLoyaltyCardBalance(final String id, final String memberId, final AddBalance addBalance) {
