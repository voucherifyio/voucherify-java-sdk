...
public final class ValidationsModule extends AbsModule<ExtAsync, ExtRxJava> {
  ...
  public VoucherValidationResponse validate(String code, VoucherValidation voucherValidation) {
    return executeSyncApiCall(api.validateVoucher(code, voucherValidation));
  }

  public PromotionValidationResponse validate(PromotionValidation promotionValidation) {
    return executeSyncApiCall(api.validatePromotion(promotionValidation));
  }
  ...
  public class ExtRxJava extends AbsModule.Rx {
    ...
    public Observable<VoucherValidationResponse> validate(
        final String code, final VoucherValidation voucherValidation) {
      return RxUtils.defer(
          new RxUtils.DefFunc<VoucherValidationResponse>() {
    ...
    public Observable<PromotionValidationResponse> validate(
        final PromotionValidation promotionValidation) {
      return RxUtils.defer(
          new RxUtils.DefFunc<PromotionValidationResponse>() {
