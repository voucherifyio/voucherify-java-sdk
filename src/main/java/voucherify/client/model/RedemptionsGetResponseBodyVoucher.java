...
import voucherify.client.model.RedemptionsGetResponseBodyVoucherGift;
import voucherify.client.model.RedemptionsGetResponseBodyVoucherLoyaltyCard;
import voucherify.client.model.RedemptionsGetResponseBodyVoucherPublish;
import voucherify.client.model.RedemptionsGetResponseBodyVoucherRedemption;
...
public class RedemptionsGetResponseBodyVoucher {
  ...
  public RedemptionsGetResponseBodyVoucher() {
  }

  public RedemptionsGetResponseBodyVoucher id(String id) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher code(String code) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher campaign(String campaign) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher campaignId(String campaignId) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher category(String category) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher categoryId(String categoryId) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher categories(List<Category> categories) {
    
    this.categories = categories;
    return this;
  }

  public RedemptionsGetResponseBodyVoucher addCategoriesItem(Category categoriesItem) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher type(TypeEnum type) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher gift(RedemptionsGetResponseBodyVoucherGift gift) {
  ...
  **/
  ...
  public void setGift(RedemptionsGetResponseBodyVoucherGift gift) {
    this.gift = gift;
  }


  public RedemptionsGetResponseBodyVoucher loyaltyCard(RedemptionsGetResponseBodyVoucherLoyaltyCard loyaltyCard) {
  ...
  **/
  ...
  public void setLoyaltyCard(RedemptionsGetResponseBodyVoucherLoyaltyCard loyaltyCard) {
    this.loyaltyCard = loyaltyCard;
  }


  public RedemptionsGetResponseBodyVoucher startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher expirationDate(OffsetDateTime expirationDate) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher validityDayOfWeek(List<ValidityDayOfWeekEnum> validityDayOfWeek) {
    
    this.validityDayOfWeek = validityDayOfWeek;
    return this;
  }

  public RedemptionsGetResponseBodyVoucher addValidityDayOfWeekItem(ValidityDayOfWeekEnum validityDayOfWeekItem) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher active(Boolean active) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher additionalInfo(String additionalInfo) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher metadata(Object metadata) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher assets(VoucherAssets assets) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher isReferralCode(Boolean isReferralCode) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher holderId(String holderId) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher referrerId(String referrerId) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher _object(String _object) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher validationRulesAssignments(ValidationRulesAssignmentsList validationRulesAssignments) {
  ...
  **/
  ...
  public RedemptionsGetResponseBodyVoucher publish(RedemptionsGetResponseBodyVoucherPublish publish) {
  ...
  **/
  ...
  public void setPublish(RedemptionsGetResponseBodyVoucherPublish publish) {
    this.publish = publish;
  }


  public RedemptionsGetResponseBodyVoucher redemption(RedemptionsGetResponseBodyVoucherRedemption redemption) {
  ...
  **/
  ...
  public void setRedemption(RedemptionsGetResponseBodyVoucherRedemption redemption) {
    this.redemption = redemption;
  }


  public RedemptionsGetResponseBodyVoucher holder(SimpleCustomer holder) {
  ...
  **/
   ...
   * @return the RedemptionsGetResponseBodyVoucher instance itself
   */
  public RedemptionsGetResponseBodyVoucher putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RedemptionsGetResponseBodyVoucher redemptionsGetResponseBodyVoucher = (RedemptionsGetResponseBodyVoucher) o;
    return Objects.equals(this.id, redemptionsGetResponseBodyVoucher.id) &&
        Objects.equals(this.code, redemptionsGetResponseBodyVoucher.code) &&
        Objects.equals(this.campaign, redemptionsGetResponseBodyVoucher.campaign) &&
        Objects.equals(this.campaignId, redemptionsGetResponseBodyVoucher.campaignId) &&
        Objects.equals(this.category, redemptionsGetResponseBodyVoucher.category) &&
        Objects.equals(this.categoryId, redemptionsGetResponseBodyVoucher.categoryId) &&
        Objects.equals(this.categories, redemptionsGetResponseBodyVoucher.categories) &&
        Objects.equals(this.type, redemptionsGetResponseBodyVoucher.type) &&
        Objects.equals(this.discount, redemptionsGetResponseBodyVoucher.discount) &&
        Objects.equals(this.gift, redemptionsGetResponseBodyVoucher.gift) &&
        Objects.equals(this.loyaltyCard, redemptionsGetResponseBodyVoucher.loyaltyCard) &&
        Objects.equals(this.startDate, redemptionsGetResponseBodyVoucher.startDate) &&
        Objects.equals(this.expirationDate, redemptionsGetResponseBodyVoucher.expirationDate) &&
        Objects.equals(this.validityTimeframe, redemptionsGetResponseBodyVoucher.validityTimeframe) &&
        Objects.equals(this.validityDayOfWeek, redemptionsGetResponseBodyVoucher.validityDayOfWeek) &&
        Objects.equals(this.validityHours, redemptionsGetResponseBodyVoucher.validityHours) &&
        Objects.equals(this.active, redemptionsGetResponseBodyVoucher.active) &&
        Objects.equals(this.additionalInfo, redemptionsGetResponseBodyVoucher.additionalInfo) &&
        Objects.equals(this.metadata, redemptionsGetResponseBodyVoucher.metadata) &&
        Objects.equals(this.assets, redemptionsGetResponseBodyVoucher.assets) &&
        Objects.equals(this.isReferralCode, redemptionsGetResponseBodyVoucher.isReferralCode) &&
        Objects.equals(this.createdAt, redemptionsGetResponseBodyVoucher.createdAt) &&
        Objects.equals(this.updatedAt, redemptionsGetResponseBodyVoucher.updatedAt) &&
        Objects.equals(this.holderId, redemptionsGetResponseBodyVoucher.holderId) &&
        Objects.equals(this.referrerId, redemptionsGetResponseBodyVoucher.referrerId) &&
        Objects.equals(this._object, redemptionsGetResponseBodyVoucher._object) &&
        Objects.equals(this.validationRulesAssignments, redemptionsGetResponseBodyVoucher.validationRulesAssignments) &&
        Objects.equals(this.publish, redemptionsGetResponseBodyVoucher.publish) &&
        Objects.equals(this.redemption, redemptionsGetResponseBodyVoucher.redemption) &&
        Objects.equals(this.holder, redemptionsGetResponseBodyVoucher.holder)&&
        Objects.equals(this.additionalProperties, redemptionsGetResponseBodyVoucher.additionalProperties);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionsGetResponseBodyVoucher.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionsGetResponseBodyVoucher' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionsGetResponseBodyVoucher> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionsGetResponseBodyVoucher.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionsGetResponseBodyVoucher>() {
           @Override
           public void write(JsonWriter out, RedemptionsGetResponseBodyVoucher value) throws IOException {
           ...
           @Override
           public RedemptionsGetResponseBodyVoucher read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RedemptionsGetResponseBodyVoucher instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RedemptionsGetResponseBodyVoucher given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionsGetResponseBodyVoucher
  * @throws IOException if the JSON string is invalid with respect to RedemptionsGetResponseBodyVoucher
  */
  public static RedemptionsGetResponseBodyVoucher fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionsGetResponseBodyVoucher.class);
  }

 /**
  * Convert an instance of RedemptionsGetResponseBodyVoucher to an JSON string
  *
  * @return JSON string
  */
