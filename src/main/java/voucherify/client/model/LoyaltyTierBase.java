...
public class LoyaltyTierBase {
  ...
  **/
   ...
   * @return the LoyaltyTierBase instance itself
   */
  public LoyaltyTierBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, loyaltyTierBase.name) &&
        ...
        Objects.equals(this.additionalProperties, loyaltyTierBase.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, earningRules, rewards, points, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoyaltyTierBase>() {
           ...
           public LoyaltyTierBase read(JsonReader in) throws IOException {
             ...
             LoyaltyTierBase instance = thisAdapter.fromJsonTree(jsonObj);
