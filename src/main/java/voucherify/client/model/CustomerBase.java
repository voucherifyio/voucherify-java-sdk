...
public class CustomerBase {
  ...
  **/
   ...
   * @return the CustomerBase instance itself
   */
  public CustomerBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, customerBase.name) &&
        ...
        Objects.equals(this.additionalProperties, customerBase.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerBase>() {
           ...
           public CustomerBase read(JsonReader in) throws IOException {
             ...
             CustomerBase instance = thisAdapter.fromJsonTree(jsonObj);
