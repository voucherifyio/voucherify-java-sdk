...
public class OrdersUpdateResponseBody {
  ...
  **/
   ...
   * @return the OrdersUpdateResponseBody instance itself
   */
  public OrdersUpdateResponseBody putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrdersUpdateResponseBody>() {
           ...
           public OrdersUpdateResponseBody read(JsonReader in) throws IOException {
             ...
             OrdersUpdateResponseBody instance = thisAdapter.fromJsonTree(jsonObj);
