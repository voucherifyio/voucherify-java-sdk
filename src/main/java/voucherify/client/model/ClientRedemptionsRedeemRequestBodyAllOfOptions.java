...
public class ClientRedemptionsRedeemRequestBodyAllOfOptions {
  ...
  **/
   ...
   * @return the ClientRedemptionsRedeemRequestBodyAllOfOptions instance itself
   */
  public ClientRedemptionsRedeemRequestBodyAllOfOptions putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ClientRedemptionsRedeemRequestBodyAllOfOptions>() {
           ...
           public ClientRedemptionsRedeemRequestBodyAllOfOptions read(JsonReader in) throws IOException {
             ...
             ClientRedemptionsRedeemRequestBodyAllOfOptions instance = thisAdapter.fromJsonTree(jsonObj);
