...
import voucherify.client.model.RedemptionsListResponseBodyRedemptionsItemVoucherGift;
import voucherify.client.model.RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard;
import voucherify.client.model.RedemptionsListResponseBodyRedemptionsItemVoucherPublish;
import voucherify.client.model.RedemptionsListResponseBodyRedemptionsItemVoucherRedemption;
...
public class RedemptionsListResponseBodyRedemptionsItemVoucher {
  ...
  private RedemptionsListResponseBodyRedemptionsItemVoucherGift gift;

  public static final String SERIALIZED_NAME_LOYALTY_CARD = "loyalty_card";
  @SerializedName(SERIALIZED_NAME_LOYALTY_CARD)
  private RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard loyaltyCard;
  ...
  **/
  @javax.annotation.Nullable
  public RedemptionsListResponseBodyRedemptionsItemVoucherGift getGift() {
    return gift;
  }


  public void setGift(RedemptionsListResponseBodyRedemptionsItemVoucherGift gift) {
    this.gift = gift;
  }
  ...
  **/
  @javax.annotation.Nullable
  public RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard getLoyaltyCard() {
    return loyaltyCard;
  }
  ...
  **/
  ...
  public RedemptionsListResponseBodyRedemptionsItemVoucher addValidityDayOfWeekItem(ValidityDayOfWeekEnum validityDayOfWeekItem) {
  ...
  **/
  @javax.annotation.Nullable
  public RedemptionsListResponseBodyRedemptionsItemVoucherPublish getPublish() {
    return publish;
  }


  public void setPublish(RedemptionsListResponseBodyRedemptionsItemVoucherPublish publish) {
    this.publish = publish;
  }
  ...
  **/
  @javax.annotation.Nullable
  public RedemptionsListResponseBodyRedemptionsItemVoucherRedemption getRedemption() {
    return redemption;
  }
  ...
  **/
   ...
   * @return the RedemptionsListResponseBodyRedemptionsItemVoucher instance itself
   */
  public RedemptionsListResponseBodyRedemptionsItemVoucher putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RedemptionsListResponseBodyRedemptionsItemVoucher redemptionsListResponseBodyRedemptionsItemVoucher = (RedemptionsListResponseBodyRedemptionsItemVoucher) o;
    return Objects.equals(this.id, redemptionsListResponseBodyRedemptionsItemVoucher.id) &&
        Objects.equals(this.code, redemptionsListResponseBodyRedemptionsItemVoucher.code) &&
        Objects.equals(this.campaign, redemptionsListResponseBodyRedemptionsItemVoucher.campaign) &&
        ...
        Objects.equals(this.loyaltyCard, redemptionsListResponseBodyRedemptionsItemVoucher.loyaltyCard) &&
        Objects.equals(this.startDate, redemptionsListResponseBodyRedemptionsItemVoucher.startDate) &&
        Objects.equals(this.expirationDate, redemptionsListResponseBodyRedemptionsItemVoucher.expirationDate) &&
        Objects.equals(this.validityTimeframe, redemptionsListResponseBodyRedemptionsItemVoucher.validityTimeframe) &&
        Objects.equals(this.validityDayOfWeek, redemptionsListResponseBodyRedemptionsItemVoucher.validityDayOfWeek) &&
        Objects.equals(this.validityHours, redemptionsListResponseBodyRedemptionsItemVoucher.validityHours) &&
        Objects.equals(this.active, redemptionsListResponseBodyRedemptionsItemVoucher.active) &&
        Objects.equals(this.additionalInfo, redemptionsListResponseBodyRedemptionsItemVoucher.additionalInfo) &&
        Objects.equals(this.metadata, redemptionsListResponseBodyRedemptionsItemVoucher.metadata) &&
        Objects.equals(this.assets, redemptionsListResponseBodyRedemptionsItemVoucher.assets) &&
        Objects.equals(this.isReferralCode, redemptionsListResponseBodyRedemptionsItemVoucher.isReferralCode) &&
        Objects.equals(this.createdAt, redemptionsListResponseBodyRedemptionsItemVoucher.createdAt) &&
        Objects.equals(this.updatedAt, redemptionsListResponseBodyRedemptionsItemVoucher.updatedAt) &&
  ...
  public String toString() {
    ...
    sb.append("class RedemptionsListResponseBodyRedemptionsItemVoucher {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedemptionsListResponseBodyRedemptionsItemVoucher.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedemptionsListResponseBodyRedemptionsItemVoucher' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedemptionsListResponseBodyRedemptionsItemVoucher> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedemptionsListResponseBodyRedemptionsItemVoucher.class));

       return (TypeAdapter<T>) new TypeAdapter<RedemptionsListResponseBodyRedemptionsItemVoucher>() {
           @Override
           public void write(JsonWriter out, RedemptionsListResponseBodyRedemptionsItemVoucher value) throws IOException {
           ...
           @Override
           public RedemptionsListResponseBodyRedemptionsItemVoucher read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RedemptionsListResponseBodyRedemptionsItemVoucher instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RedemptionsListResponseBodyRedemptionsItemVoucher given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedemptionsListResponseBodyRedemptionsItemVoucher
  * @throws IOException if the JSON string is invalid with respect to RedemptionsListResponseBodyRedemptionsItemVoucher
  */
  public static RedemptionsListResponseBodyRedemptionsItemVoucher fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedemptionsListResponseBodyRedemptionsItemVoucher.class);
  }

 /**
  * Convert an instance of RedemptionsListResponseBodyRedemptionsItemVoucher to an JSON string
  *
  * @return JSON string
  */
