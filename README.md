...
- 🐛 Caught a bug? [Add an issue](https://github.com/voucherifyio/voucherify-dotNET-sdk/issues "Visit issues in Voucherify .NET SDK")!
...
> [!TIP]
> 
> Check the test implementation in the folder `(./src/test)`.
