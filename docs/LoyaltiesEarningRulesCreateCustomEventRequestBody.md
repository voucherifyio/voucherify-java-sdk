...
This is an object representing an earning rule triggered by a custom event.
...
|**loyalty** | [**LoyaltiesEarningRulesCreateCustomEventRequestBodyLoyalty**](LoyaltiesEarningRulesCreateCustomEventRequestBodyLoyalty.md) |  |
