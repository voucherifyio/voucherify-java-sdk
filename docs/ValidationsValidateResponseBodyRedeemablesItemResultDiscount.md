...
|**amountOffFormula** | **String** | Formula used to dynamically calculate the discount. |
...
|**unitOffFormula** | **String** | Formula used to dynamically calculate the number of units. |
...
|**percentOffFormula** | **String** | Formula used to dynamically calculate the discount. |
...
|**fixedAmountFormula** | **String** | Formula used to dynamically calculate the discount. |
