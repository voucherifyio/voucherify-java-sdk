...
|**discountAmount** | **Integer** | xxxSum of all order-item-level discounts applied to the order. |
...
|**product** | [**OrderItemEssentialProduct**](OrderItemEssentialProduct.md) |  |
|**sku** | [**OrderItemEssentialSku**](OrderItemEssentialSku.md) |  |
