...
|**customer** | [**LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer**](LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer.md) |  |
|**referrer** | [**LoyaltiesMembersRedemptionRedeemResponseBodyOrderReferrer**](LoyaltiesMembersRedemptionRedeemResponseBodyOrderReferrer.md) |  |
|**redemptions** | [**Map&lt;String, OrderRedemptionsEntry&gt;**](OrderRedemptionsEntry.md) |  |
|**items** | [**List&lt;LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem&gt;**](LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.md) | Array of items applied to the order. It can include up to 500 items. |
