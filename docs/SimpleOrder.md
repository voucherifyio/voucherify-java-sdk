...
|**sourceId** | **String** | Unique source identifier of an existing order that will be linked to the redemption of this request. |
...
|**items** | [**List&lt;SimpleOrderItem&gt;**](SimpleOrderItem.md) | Array of items applied to the order. It can include up to 500 items. |
