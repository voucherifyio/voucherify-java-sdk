...
|**items** | [**List&lt;MemberActivityDataRedemptionOrderItemsItem&gt;**](MemberActivityDataRedemptionOrderItemsItem.md) | Array of items applied to the order. It can include up to 500 items. |
...
|**customer** | [**MemberActivityDataRedemptionOrderCustomer**](MemberActivityDataRedemptionOrderCustomer.md) |  |
|**referrer** | [**MemberActivityDataRedemptionOrderReferrer**](MemberActivityDataRedemptionOrderReferrer.md) |  |
