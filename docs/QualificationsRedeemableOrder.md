...
|**items** | [**List&lt;QualificationsRedeemableOrderItemsItem&gt;**](QualificationsRedeemableOrderItemsItem.md) | Array of items applied to the order. It can include up to 500 items. |
