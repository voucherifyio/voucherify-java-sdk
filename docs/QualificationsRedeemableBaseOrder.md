...
|**items** | [**List&lt;QualificationsRedeemableBaseOrderItemsItem&gt;**](QualificationsRedeemableBaseOrderItemsItem.md) | Array of items applied to the order. It can include up to 500 items. |
