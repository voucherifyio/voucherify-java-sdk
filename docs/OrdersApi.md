...
Creates an order object and triggers an order creation event. &lt;Note&gt; &lt;Badge color blue&gt;Upsert Mode&lt;/Badge&gt; If you pass an id or a source_id that already exists in the order database, Voucherify will return a related order object with updated fields. &lt;/Note&gt;
